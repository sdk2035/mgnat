...
package Opt is
   ...
   --  mcc: 02/13/06 make default Ada 2005
   ...
   --  mcc: add Compact Framework flag
   Compact_Framework : Boolean := False;
   --  Set to True if compiling for .NET Compact Framework
