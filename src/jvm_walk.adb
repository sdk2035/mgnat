   ...
   begin
      ...
      if Check then
         if R.Magic /= SUN_Magic_Number then
            Osint.Fail ("Bad class file: bad magic number");
         elsif R.Minor_Version /=  SUN_Minor_Version then
            Osint.Fail ("Bad class file: bad minor version");
         elsif R.Major_Version /=  SUN_Major_Version then
            Osint.Fail ("Bad class file: bad major version");
         end if;
      end if;
