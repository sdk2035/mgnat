...
package JVM is
   ...
   procedure Associate_Interface (Class : Class_Id; I_Interface : Class_Id);
   ...
   --  create a new enumeration type with for MSIL
   ...
   --  Raises an exception if no local with that name belongs to Method.
   ...
   --  load from an address on the stack into the appropriate type
   ...
   procedure Gen_New_Array (Array_Type : Type_Id);
   ...
   procedure Gen_Conversion (Target_Type : Type_Id);
   ...
   --  Raises an exception if the top two stack items are not of the
   ...
   procedure Gen_Compare_Branch_Less (Label : Label_Id);
   --  Generates a comparison and branch to Label (if TOS-1 < TOS).
   --  Raises an exception if the top two stack items are not of
   --  type Int_Type.

   procedure Gen_Compare_Branch_Less_Equal (Label : Label_Id);
   --  Generates a comparison and branch to Label (if TOS-1 <= TOS).
   --  Raises an exception if the top two stack items are not of
   --  type Int_Type.

   procedure Gen_Compare_Branch_Greater (Label : Label_Id);
   --  Generates a comparison and branch to Label (if TOS-1 > TOS).
   --  Raises an exception if the top two stack items are not of
   --  of type Int_Type.

   procedure Gen_Compare_Branch_Greater_Equal (Label : Label_Id);
   --  Generates a comparison and branch to Label (if TOS-1 >= TOS).
   --  Raises an exception if the top two stack items are not of
   --  of type Int_Type.
   ...
   function Top_Type return Type_Id;
   --  Returns the Type_Id for the type at the top of the operand
   --  stack. Raises an exception if the stack is empty.
   ...
   --  load a function pointer for the given method onto the stack

   procedure Gen_Block_Copy;
   --  Generate a block copy instruction

   procedure Gen_Sizeof (JVM_Type : Type_Id);
   --  Generate sizeof instruction
   ...
   --  were we inside_try_catch_finally
...
private
   ...
   JVM_String_Type           : constant Type_Id  := First_JVM_Id + 16;
   Native_Int_Type           : constant Type_Id  := First_JVM_Id + 17;
   Uint8_Addrof_Type   : constant Type_Id := First_JVM_Id + 18;
   Uint16_Addrof_Type  : constant Type_Id := First_JVM_Id + 19;
   Uint32_Addrof_Type  : constant Type_Id := First_JVM_Id + 20;
   Uint64_Addrof_Type  : constant Type_Id := First_JVM_Id + 21;
   Int8_Addrof_Type    : constant Type_Id := First_JVM_Id + 22;
   Int16_Addrof_Type   : constant Type_Id := First_JVM_Id + 23;
   Int32_Addrof_Type   : constant Type_Id := First_JVM_Id + 24;
   Int64_Addrof_Type   : constant Type_Id := First_JVM_Id + 25;
   Float32_Addrof_Type : constant Type_Id := First_JVM_Id + 26;
   Float64_Addrof_Type : constant Type_Id := First_JVM_Id + 27;
   Bool_Addrof_Type    : constant Type_Id := First_JVM_Id + 28;
   Char_Addrof_Type    : constant Type_Id := First_JVM_Id + 29;
   UInt_Type     : constant Type_Id := First_JVM_Id + 30;
   ULong_Type    : constant Type_Id := First_JVM_Id + 31;
   Generic_Type0   : constant Type_Id := First_JVM_Id + 32;
   Generic_Type1   : constant Type_Id := First_JVM_Id + 33;
   Generic_Type2   : constant Type_Id := First_JVM_Id + 34;
   Generic_Type3   : constant Type_Id := First_JVM_Id + 35;
   Generic_Type4   : constant Type_Id := First_JVM_Id + 36;
   Generic_Type5   : constant Type_Id := First_JVM_Id + 37;
   Generic_Type6   : constant Type_Id := First_JVM_Id + 38;
   Generic_Type7   : constant Type_Id := First_JVM_Id + 39;
   Generic_Type8   : constant Type_Id := First_JVM_Id + 40;
   Generic_Types   : constant Generic_Type_Array :=
      (0 => Generic_Type0,
       1 => Generic_Type1,
       2 => Generic_Type2,
