...
package JVM_File is
   ...
   --  True an exception is raised. The lower bound of the returned string
   ...
   --  jump table used by the Lookupswitch and Tableswitch operations.
      ...
      case Op is
         ...
         when Multianewarray =>
            Array_Class : CP_Index_Class := CP_Empty;
            --  CP Index of the CONSTANT_Class entry for the array type
