...
package body Make is
   ...
   begin
      ...
      if Hostparm.Java_VM then
         ...
         Gnatbind := new String'("mgnatbind");
         Gnatlink := new String'("mgnatlink");
...
--  mcc: don't want EXE added if I want DLL
--                                  (Canonical_Argv'Last -
...
--                                /= Executable_Suffix)
      ...
      --  If we have seen a regular switch process it
         ...
         --  mcc: add compact flag
         elsif Argv (2 .. Argv'Last) = "compact" then

            --  pass compact to all phases

            Opt.Compact_Framework := True;
            Add_Switch (Argv, Compiler, And_Save => And_Save);
            Add_Switch (Argv, Binder, And_Save => And_Save);
            Add_Switch (Argv, Linker, And_Save => And_Save);
