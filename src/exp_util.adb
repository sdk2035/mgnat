   ...
   begin
      ...
      if Name_Len > TSS_Name_Type'Last then
         ...
         if Chars (E)        = Name_uSize
           --  mcc: help! these DT entries
           --  were causing overloads of "=" to
           --  get the same name.  I think they don't matter
           --  so I am commenting out the code that fixes them
           --  to a constant
           ...
           --  mcc: or else Chars (E) = Name_Op_Eq
