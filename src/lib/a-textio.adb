...
package body Ada.Text_IO is
   ...
   --  elaboration of the run time. This is needed is the tasking case to
   --  avoid calling Task_Lock too early.

#if not COMPACT'Defined
   Err_Name : aliased String := "*stderr";
   In_Name  : aliased String := "*stdin";
   Out_Name : aliased String := "*stdout";
#end if;
begin
   null;
#if not COMPACT'Defined
