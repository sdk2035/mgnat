...
package body Ada.Strings.Wide_Wide_Unbounded is
   ...
   procedure Translate
     (Source  : in out Unbounded_Wide_Wide_String;
      Mapping : Wide_Wide_Maps.Wide_Wide_Character_Mapping)
   is
      --  mcc: 02/20/06 help with MGNAT bug
      Dummy : Wide_Wide_String := Source.Reference (1 .. Source.Last);
   begin
      Wide_Wide_Fixed.Translate (Dummy, Mapping);
      Source := To_Unbounded_Wide_Wide_String (Dummy);
   end Translate;
