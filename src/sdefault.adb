...
package body Sdefault is
   ...
   function Include_Dir_Default_Name return String_Ptr is
      Dir : String := Executable_Location & Relative_Include_Dir;
   begin
      --  Check that file java.ads is in the default include directory

      if not Is_Regular_File (Dir & "java.ads") then
         Osint.Fail ("Bad installation: ""java.ads"" not found in ", Dir);
      end if;
   ...
   function Object_Dir_Default_Name return String_Ptr is
      Dir : String := Executable_Location & Relative_Object_Dir;
   begin
      return new String'(Dir);
