...
package body Ada.Text_IO.Bounded_IO is
   ...
   begin
      --  mcc: 02/20/06 add package here to help MGNAT
      return Bounded.To_Bounded_String (Ada.Text_IO.Get_Line);
   end Get_Line;
   ...
   begin
      --  mcc: 02/20/06 add package here to help MGNAT
      return Bounded.To_Bounded_String (Ada.Text_IO.Get_Line (File));
   end Get_Line;
