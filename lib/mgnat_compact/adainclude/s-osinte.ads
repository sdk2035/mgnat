...
package System.OS_Interface is
   ...
   function Get_Thread (This : access Thread) return
      Interfaces.Java.Lang.Thread.Ref;
...
private
   pragma Convention (MSIL, Thread);
   pragma Msil_Constructor (new_Thread);
   pragma Import (MSIL, Get_Self_Id, "getSelfId");
   pragma Import (MSIL, Get_Thread, "Get_Thread");
end System.OS_Interface;

pragma Import (MSIL, System.OS_Interface, "mgnat.adalib.ada_wrapper");
