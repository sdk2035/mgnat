...
pragma Elaborate_Body (C_Streams);
   ...
   --  have_console indicates if stdin/out/err exist
   function have_console return int;
...
private
   ...
   pragma Import (C, set_binary_mode, "set_binary_mode");
   pragma Import (C, set_text_mode, "set_text_mode");
   ...
   pragma Import (C, c_constant_EOF, "c_constant_eof");
   pragma Import (C, c_constant_IOFBF, "c_constant_iofbf");
   pragma Import (C, c_constant_IOLBF, "c_constant_iolbf");
   pragma Import (C, c_constant_IONBF, "c_constant_ionbf");
   pragma Import (C, c_constant_SEEK_CUR, "c_constant_seek_cur");
   pragma Import (C, c_constant_SEEK_END, "c_constant_seek_end");
   pragma Import (C, c_constant_SEEK_SET, "c_constant_seek_set");
   pragma Import (C, c_constant_L_tmpnam, "c_constant_l_tmpnam");

   pragma Import (C, stderr, "c_constant_stderr");
   pragma Import (C, stdin,  "c_constant_stdin");
   pragma Import (C, stdout, "c_constant_stdout");
   pragma Import (C, have_console, "have_console");
