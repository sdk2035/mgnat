...
--                                                                          --
-- JGNAT -  The GNAT Ada 95 tool chain for the MSIL (TM) Virtual Machine is --
...
--  (for specialized Direct_IO functions), or in the Ada-specific MSIL
--  class Object_File.
...
package body Ada.Direct_IO is
   ...
   function End_Of_File (File : in File_Type) return Boolean is
      function Object_End_Of_File
        (Stream : Interfaces.C_Streams.FILEs)
           return Boolean;
      pragma Import
        (MSIL, Object_End_Of_File, "mgnat.adalib.Object_File.object_eof");
   ...
   is
      ...
      pragma Import
        (MSIL, Read_Element, "mgnat.adalib.Object_File.read_element");
   ...
   procedure Set_Index (File : in File_Type; To : in Positive_Count) is
      ...
      pragma Import
        (MSIL, Set_File_Index, "mgnat.adalib.Object_File.set_file_index");
   ...
   function Size (File : in File_Type) return Count is
      function File_Size (Stream : Interfaces.C_Streams.FILEs)
        return Count;
      pragma Import (MSIL, File_Size, "mgnat.adalib.Object_File.file_size");
   ...
   is
      procedure Write_Element
        (Stream : Interfaces.C_Streams.FILEs;
         Item : Interfaces.Java.Lang.Object.Ref);
      pragma Import
        (MSIL, Write_Element, "mgnat.adalib.Object_File.write_element");

      type Elt_Access is access Element_Type;

      function Elt_To_Addr is
        new Unchecked_Conversion (Elt_Access,
           Interfaces.Java.Lang.Object.Ref);
