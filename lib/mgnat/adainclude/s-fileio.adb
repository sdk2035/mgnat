...
package body System.File_IO is
   ...
   pragma Import (C, text_translation_required, "text_translation_required");
  ...
  is
   ...
   is
      procedure Tmp_Name (Buffer : String);
   ...
   begin
      ...
      Locked_Processing : begin
         ...
         --  Normal case of Open or Create
            ...
            --   really obscure MGNAT bug, don't feel like fixing
               declare
                  old : constant Temp_File_Record_Ptr := Temp_Files;
               begin
                  Temp_Files := new Temp_File_Record;
                  Temp_Files.Name := Namestr;
                  Temp_Files.Next := old;
               end;
