...
package body Ada.Directories is
   ...
   begin
      ...
      then
         ...
         Copy_File
           (Source_Name, Target_Name, Success, Overwrite, Time_Stamps);
   ...
   function File_Exists (Name : String) return Boolean is
      function C_File_Exists (A : Object) return Integer;
   ...
   function Modification_Time (Name : String) return Ada.Calendar.Time is
      ...
      procedure File_Time_Stamp (
         Name   : in  String;
         Result : out Ada.Calendar.Time);
      pragma Import (C, File_Time_Stamp, "__gnat_filetimestamp");
   begin
      --  First, the invalid cases
