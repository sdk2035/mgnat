...
with type MSSyst.Windows.Forms.AxHost.State.Ref is access;
...
package MSSyst.Windows.Forms.AxHost is
   ...
   function get_OcxState(
      This : access Typ) return MSSyst.Windows.Forms.AxHost.State.Ref;
   ...
   procedure set_OcxState(
      This : access Typ;
      value : MSSyst.Windows.Forms.AxHost.State.Ref);
