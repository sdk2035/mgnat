...
package MSSyst.Runtime.InteropServices.InvalidComObjectException is
   type Typ;
   ...
   function new_InvalidComObjectException(
...
private
   ...
   pragma MSIL_Constructor(new_InvalidComObjectException);
end MSSyst.Runtime.InteropServices.InvalidComObjectException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Runtime.InteropServices.InvalidComObjectException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Runtime.InteropServices.InvalidComObjectException");
