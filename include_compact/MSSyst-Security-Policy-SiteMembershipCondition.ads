...
package MSSyst.Security.Policy.SiteMembershipCondition is
   type Typ;
   ...
   function new_SiteMembershipCondition(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_SiteMembershipCondition);
...
end MSSyst.Security.Policy.SiteMembershipCondition;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Security.Policy.SiteMembershipCondition,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Security.Policy.SiteMembershipCondition");
