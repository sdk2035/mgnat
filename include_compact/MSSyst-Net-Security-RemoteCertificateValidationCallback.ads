...
with type MSSyst.Security.Cryptography.X509Certificates.X509Chain.Ref is access;
with MSSyst.Net.Security.SslPolicyErrors;
...
package MSSyst.Net.Security.RemoteCertificateValidationCallback is
   ...
   function BeginInvoke(
      ...
      chain : MSSyst.Security.Cryptography.X509Certificates.X509Chain.Ref;
