...
package MSSyst.MethodAccessException is
   type Typ;
   ...
   function new_MethodAccessException(
...
private
   ...
   pragma MSIL_Constructor(new_MethodAccessException);
end MSSyst.MethodAccessException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.MethodAccessException,
