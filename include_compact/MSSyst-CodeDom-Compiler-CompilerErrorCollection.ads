...
with type MSSyst.CodeDom.Compiler.CompilerError.Ref is access;
with type MSSyst.CodeDom.Compiler.CompilerError.Ref_array is access;
...
package MSSyst.CodeDom.Compiler.CompilerErrorCollection is
   ...
   function new_CompilerErrorCollection(
      This : Ref := null;
      value : MSSyst.CodeDom.Compiler.CompilerErrorCollection.Ref) return Ref;
   function new_CompilerErrorCollection(
      This : Ref := null;
      value : MSSyst.CodeDom.Compiler.CompilerError.Ref_array) return Ref;
   function Add(
      This : access Typ;
      value : MSSyst.CodeDom.Compiler.CompilerError.Ref) return Integer;
   procedure AddRange(
      This : access Typ;
      value : MSSyst.CodeDom.Compiler.CompilerError.Ref_array);
   procedure AddRange(
      This : access Typ;
      value : MSSyst.CodeDom.Compiler.CompilerErrorCollection.Ref);
   function Contains(
      This : access Typ;
      value : MSSyst.CodeDom.Compiler.CompilerError.Ref) return Standard.Boolean;
   procedure CopyTo(
      This : access Typ;
      array_k : MSSyst.CodeDom.Compiler.CompilerError.Ref_array;
      index : Integer);
   ...
   function get_Item(
      This : access Typ;
      index : Integer) return MSSyst.CodeDom.Compiler.CompilerError.Ref;
   function IndexOf(
      This : access Typ;
      value : MSSyst.CodeDom.Compiler.CompilerError.Ref) return Integer;
   procedure Insert(
      This : access Typ;
      index : Integer;
      value : MSSyst.CodeDom.Compiler.CompilerError.Ref);
   procedure Remove(
      This : access Typ;
      value : MSSyst.CodeDom.Compiler.CompilerError.Ref);
   procedure set_Item(
