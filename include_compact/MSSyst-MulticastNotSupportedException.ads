...
package MSSyst.MulticastNotSupportedException is
   type Typ;
   ...
   function new_MulticastNotSupportedException(
...
private
   ...
   pragma MSIL_Constructor(new_MulticastNotSupportedException);
end MSSyst.MulticastNotSupportedException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.MulticastNotSupportedException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.MulticastNotSupportedException");
