...
with MSIL_Types;
use MSIL_Types;
with type MSSyst.Runtime.InteropServices.ComTypes.IStream.Ref_addrof is access;
...
package MSSyst.Runtime.InteropServices.ComTypes.IStream is
   ...
   procedure Clone(
      This : access Typ;
      ppstm : MSSyst.Runtime.InteropServices.ComTypes.IStream.Ref_addrof) is abstract;
   procedure Commit(
      This : access Typ;
   ...
   procedure Stat(
      This : access Typ;
      pstatstg : MSSyst.Runtime.InteropServices.ComTypes.STATSTG.Valuetype_addrof;
