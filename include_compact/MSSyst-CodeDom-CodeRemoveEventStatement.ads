...
package MSSyst.CodeDom.CodeRemoveEventStatement is
   type Typ;
   ...
   function new_CodeRemoveEventStatement(
...
private
   ...
   pragma MSIL_Constructor(new_CodeRemoveEventStatement);
...
end MSSyst.CodeDom.CodeRemoveEventStatement;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.CodeDom.CodeRemoveEventStatement,
