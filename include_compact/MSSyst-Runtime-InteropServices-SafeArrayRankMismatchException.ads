...
package MSSyst.Runtime.InteropServices.SafeArrayRankMismatchException is
   type Typ;
   ...
   function new_SafeArrayRankMismatchException(
...
private
   ...
   pragma MSIL_Constructor(new_SafeArrayRankMismatchException);
end MSSyst.Runtime.InteropServices.SafeArrayRankMismatchException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Runtime.InteropServices.SafeArrayRankMismatchException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Runtime.InteropServices.SafeArrayRankMismatchException");
