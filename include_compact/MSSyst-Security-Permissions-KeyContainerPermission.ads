...
with type MSSyst.Security.Permissions.KeyContainerPermissionAccessEntryCollection.Ref is access;
...
package MSSyst.Security.Permissions.KeyContainerPermission is
   ...
   function new_KeyContainerPermission(
      ...
      accessList : MSSyst.Security.Permissions.KeyContainerPermissionAccessEntry.Ref_array) return Ref;
   function Copy(
   ...
   function get_AccessEntries(
      This : access Typ) return MSSyst.Security.Permissions.KeyContainerPermissionAccessEntryCollection.Ref;
   function get_Flags(
