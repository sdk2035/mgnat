...
package MSSyst.Windows.Forms.NativeMethods.TreeViewCompareCallback is
   type Typ;
   ...
   function new_TreeViewCompareCallback(
      This : Ref := null;
      object : MSSyst.Object.Ref;
      method : MSIL_Types.native_int) return Ref;
   function BeginInvoke(
      This : access Typ;
      lParam1 : MSIL_Types.native_int;
      lParam2 : MSIL_Types.native_int;
      lParamSort : MSIL_Types.native_int;
      callback : MSSyst.AsyncCallback.Ref;
      object : MSSyst.Object.Ref) return MSSyst.IAsyncResult.Ref;
   function EndInvoke(
      This : access Typ;
      result : MSSyst.IAsyncResult.Ref) return Integer;
   function Invoke(
      This : access Typ;
      lParam1 : MSIL_Types.native_int;
      lParam2 : MSIL_Types.native_int;
      lParamSort : MSIL_Types.native_int) return Integer;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_TreeViewCompareCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.NativeMethods.TreeViewCompareCallback;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.NativeMethods.TreeViewCompareCallback,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NativeMethods/TreeViewCompareCallback");
