...
with MSSyst.Security.Cryptography.X509Certificates.X509RevocationFlag;
with MSSyst.Security.Cryptography.X509Certificates.X509RevocationMode;
with type MSSyst.TimeSpan.Valuetype is tagged;
with MSSyst.Security.Cryptography.X509Certificates.X509VerificationFlags;
