...
package MSSyst.UnauthorizedAccessException is
   type Typ;
...
private
   ...
   pragma MSIL_Constructor(new_UnauthorizedAccessException);
end MSSyst.UnauthorizedAccessException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.UnauthorizedAccessException,
