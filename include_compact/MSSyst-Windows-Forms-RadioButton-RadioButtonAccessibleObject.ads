...
with MSIL_Types;
use MSIL_Types;
with MSSyst.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject;
...
with type MSSyst.Windows.Forms.RadioButton.Ref is access;
package MSSyst.Windows.Forms.RadioButton.RadioButtonAccessibleObject is
   type Typ;
   ...
   type Typ is new MSSyst.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject.Typ
         and MSSyst.Reflection.IReflect.Typ
   with record
      null;
   end record;
   function new_RadioButtonAccessibleObject(
      This : Ref := null;
      owner : MSSyst.Windows.Forms.RadioButton.Ref) return Ref;
...
private
   ...
   pragma MSIL_Constructor(new_RadioButtonAccessibleObject);
...
end MSSyst.Windows.Forms.RadioButton.RadioButtonAccessibleObject;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.RadioButton.RadioButtonAccessibleObject,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.RadioButton/RadioButtonAccessibleObject");
