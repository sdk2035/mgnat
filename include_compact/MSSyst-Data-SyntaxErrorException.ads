...
with MSSyst.Data.InvalidExpressionException;
package MSSyst.Data.SyntaxErrorException is
   type Typ;
   ...
   type Typ(
      ...
      ) is new MSSyst.Data.InvalidExpressionException.Typ(
         I_ISerializable => I_ISerializable
      ) with record
      null;
   end record;
   function new_SyntaxErrorException(
...
private
   ...
   pragma MSIL_Constructor(new_SyntaxErrorException);
end MSSyst.Data.SyntaxErrorException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Data.SyntaxErrorException,
   ".ver 1:0:5000:0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[System.Data]System.Data.SyntaxErrorException");
