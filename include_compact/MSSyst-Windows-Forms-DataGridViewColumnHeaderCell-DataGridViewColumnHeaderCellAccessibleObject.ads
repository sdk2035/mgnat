...
package MSSyst.Windows.Forms.DataGridViewColumnHeaderCell.DataGridViewColumnHeaderCellAccessibleObject is
   type Typ;
   ...
   function new_DataGridViewColumnHeaderCellAccessibleObject(
      This : Ref := null;
      owner : MSSyst.Windows.Forms.DataGridViewColumnHeaderCell.Ref) return Ref;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewColumnHeaderCellAccessibleObject);
...
end MSSyst.Windows.Forms.DataGridViewColumnHeaderCell.DataGridViewColumnHeaderCellAccessibleObject;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewColumnHeaderCell.DataGridViewColumnHeaderCellAccessibleObject,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewColumnHeaderCell/DataGridViewColumnHeaderCellAccessibleObject");
