...
package MSSyst.Collections.CaseInsensitiveHashCodeProvider is
   ...
   function get_Default return MSSyst.Collections.CaseInsensitiveHashCodeProvider.Ref;
   function get_DefaultInvariant return MSSyst.Collections.CaseInsensitiveHashCodeProvider.Ref;
