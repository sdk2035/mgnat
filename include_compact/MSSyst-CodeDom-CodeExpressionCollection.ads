...
package MSSyst.CodeDom.CodeExpressionCollection is
   ...
   function new_CodeExpressionCollection(
      This : Ref := null;
      value : MSSyst.CodeDom.CodeExpressionCollection.Ref) return Ref;
   function new_CodeExpressionCollection(
      This : Ref := null;
      value : MSSyst.CodeDom.CodeExpression.Ref_array) return Ref;
   function Add(
      This : access Typ;
      value : MSSyst.CodeDom.CodeExpression.Ref) return Integer;
   procedure AddRange(
      This : access Typ;
      value : MSSyst.CodeDom.CodeExpression.Ref_array);
   procedure AddRange(
      This : access Typ;
      value : MSSyst.CodeDom.CodeExpressionCollection.Ref);
   function Contains(
      This : access Typ;
      value : MSSyst.CodeDom.CodeExpression.Ref) return Standard.Boolean;
   procedure CopyTo(
      This : access Typ;
      array_k : MSSyst.CodeDom.CodeExpression.Ref_array;
      index : Integer);
   function get_Item(
      This : access Typ;
      index : Integer) return MSSyst.CodeDom.CodeExpression.Ref;
   function IndexOf(
      This : access Typ;
      value : MSSyst.CodeDom.CodeExpression.Ref) return Integer;
   procedure Insert(
