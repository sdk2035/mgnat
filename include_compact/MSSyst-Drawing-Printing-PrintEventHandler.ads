...
package MSSyst.Drawing.Printing.PrintEventHandler is
   type Typ;
   ...
   function new_PrintEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_PrintEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Drawing.Printing.PrintEventHandler;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Drawing.Printing.PrintEventHandler,
