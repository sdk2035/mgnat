...
package MSSyst.Reflection.TypeFilter is
   type Typ;
   ...
   function BeginInvoke(
      This : access Typ;
      m : MSSyst.Type_k.Ref;
      filterCriteria : MSSyst.Object.Ref;
   ...
   function Invoke(
      This : access Typ;
      m : MSSyst.Type_k.Ref;
      filterCriteria : MSSyst.Object.Ref) return Standard.Boolean;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_TypeFilter);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Reflection.TypeFilter;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Reflection.TypeFilter,
