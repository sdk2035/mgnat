...
package MSSyst.Windows.Forms.KeyEventHandler is
   type Typ;
   ...
   function BeginInvoke(
      ...
      e : MSSyst.Windows.Forms.KeyEventArgs.Ref;
...
private
   ...
   pragma MSIL_Constructor(new_KeyEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.KeyEventHandler;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.KeyEventHandler,
