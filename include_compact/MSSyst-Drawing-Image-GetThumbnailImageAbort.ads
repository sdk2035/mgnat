...
package MSSyst.Drawing.Image.GetThumbnailImageAbort is
   type Typ;
   ...
   function new_GetThumbnailImageAbort(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_GetThumbnailImageAbort);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Drawing.Image.GetThumbnailImageAbort;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Drawing.Image.GetThumbnailImageAbort,
   ".ver 2:0:0:0 .publickeytoken=( b0 3f 5f 7f 11 d5 0a 3a )",
   "[System.Drawing]System.Drawing.Image/GetThumbnailImageAbort");
