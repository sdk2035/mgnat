...
package MSSyst.Windows.Forms.LinkLabelLinkClickedEventArgs is
   ...
   function new_LinkLabelLinkClickedEventArgs(
      This : Ref := null;
      link : MSSyst.Windows.Forms.LinkLabel.Link.Ref) return Ref;
   function new_LinkLabelLinkClickedEventArgs(
      This : Ref := null;
      link : MSSyst.Windows.Forms.LinkLabel.Link.Ref;
   ...
   function get_Link(
      This : access Typ) return MSSyst.Windows.Forms.LinkLabel.Link.Ref;
private
