...
package MSSyst.ComponentModel.ImmutableObjectAttribute is
   ...
   Yes : MSSyst.ComponentModel.ImmutableObjectAttribute.Ref;
   pragma Import(MSIL,Yes,"Yes");
   No : MSSyst.ComponentModel.ImmutableObjectAttribute.Ref;
   pragma Import(MSIL,No,"No");
   Default : MSSyst.ComponentModel.ImmutableObjectAttribute.Ref;
