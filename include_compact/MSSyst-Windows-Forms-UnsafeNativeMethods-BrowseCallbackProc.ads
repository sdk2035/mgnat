...
package MSSyst.Windows.Forms.UnsafeNativeMethods.BrowseCallbackProc is
   type Typ;
   ...
   function new_BrowseCallbackProc(
      This : Ref := null;
   ...
   function Invoke(
      ...
      msg : Integer;
      lParam : MSIL_Types.native_int;
      lpData : MSIL_Types.native_int) return Integer;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_BrowseCallbackProc);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.UnsafeNativeMethods.BrowseCallbackProc;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.UnsafeNativeMethods.BrowseCallbackProc,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.UnsafeNativeMethods/BrowseCallbackProc");
