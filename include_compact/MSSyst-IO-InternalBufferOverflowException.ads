...
package MSSyst.IO.InternalBufferOverflowException is
   type Typ;
   ...
   function new_InternalBufferOverflowException(
...
private
   ...
   pragma MSIL_Constructor(new_InternalBufferOverflowException);
end MSSyst.IO.InternalBufferOverflowException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.IO.InternalBufferOverflowException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.IO.InternalBufferOverflowException");
