...
with type MSSyst.Windows.Forms.GridColumnStylesCollection.Ref is access;
with MSSyst.Windows.Forms.DataGridLineStyle;
...
package MSSyst.Windows.Forms.DataGridTableStyle is
   ...
   DefaultTableStyle : MSSyst.Windows.Forms.DataGridTableStyle.Ref;
   ...
   function new_DataGridTableStyle(
      This : Ref := null;
      listManager : MSSyst.Windows.Forms.CurrencyManager.Ref) return Ref;
   ...
   function get_DataGrid(
      This : access Typ) return MSSyst.Windows.Forms.DataGrid.Ref;
   function get_ForeColor(
      This : access Typ) return MSSyst.Drawing.Color.Valuetype;
   function get_GridColumnStyles(
      This : access Typ) return MSSyst.Windows.Forms.GridColumnStylesCollection.Ref;
   ...
   procedure set_DataGrid(
      This : access Typ;
      value : MSSyst.Windows.Forms.DataGrid.Ref);
