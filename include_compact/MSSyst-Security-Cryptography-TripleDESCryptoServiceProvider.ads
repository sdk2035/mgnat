...
with MSIL_Types;
use MSIL_Types;
with MSSyst.Security.Cryptography.TripleDES;
...
package MSSyst.Security.Cryptography.TripleDESCryptoServiceProvider is
   type Typ;
   ...
   type Typ is new MSSyst.Security.Cryptography.TripleDES.Typ   with record
      null;
   end record;
   function new_TripleDESCryptoServiceProvider(
...
private
   ...
   pragma MSIL_Constructor(new_TripleDESCryptoServiceProvider);
...
end MSSyst.Security.Cryptography.TripleDESCryptoServiceProvider;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Security.Cryptography.TripleDESCryptoServiceProvider,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Security.Cryptography.TripleDESCryptoServiceProvider");
