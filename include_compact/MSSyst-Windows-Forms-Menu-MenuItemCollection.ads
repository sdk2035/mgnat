...
package MSSyst.Windows.Forms.Menu.MenuItemCollection is
   ...
   function new_MenuItemCollection(
      This : Ref := null;
      owner : MSSyst.Windows.Forms.Menu.Ref) return Ref;
   function Add(
      This : access Typ;
      caption : MSSyst.String.Ref;
      items : MSSyst.Windows.Forms.MenuItem.Ref_array) return MSSyst.Windows.Forms.MenuItem.Ref;
   function Add(
      This : access Typ;
      caption : MSSyst.String.Ref;
      onClick : MSSyst.EventHandler.Ref) return MSSyst.Windows.Forms.MenuItem.Ref;
   function Add(
      This : access Typ;
      index : Integer;
      item : MSSyst.Windows.Forms.MenuItem.Ref) return Integer;
   function Add(
      This : access Typ;
      item : MSSyst.Windows.Forms.MenuItem.Ref) return Integer;
   function Add(
      This : access Typ;
      caption : MSSyst.String.Ref) return MSSyst.Windows.Forms.MenuItem.Ref;
   procedure AddRange(
      This : access Typ;
      items : MSSyst.Windows.Forms.MenuItem.Ref_array);
   procedure Clear(
      This : access Typ);
   function Contains(
      This : access Typ;
      value : MSSyst.Windows.Forms.MenuItem.Ref) return Standard.Boolean;
   ...
   function Find(
      ...
      searchAllChildren : Standard.Boolean) return MSSyst.Windows.Forms.MenuItem.Ref_array;
   function get_Count(
   ...
   function get_Item(
      This : access Typ;
      key : MSSyst.String.Ref) return MSSyst.Windows.Forms.MenuItem.Ref;
   function get_Item(
      This : access Typ;
      index : Integer) return MSSyst.Windows.Forms.MenuItem.Ref;
   function GetEnumerator(
      This : access Typ) return MSSyst.Collections.IEnumerator.Ref;
   function IndexOf(
      This : access Typ;
      value : MSSyst.Windows.Forms.MenuItem.Ref) return Integer;
   function IndexOfKey(
      This : access Typ;
      key : MSSyst.String.Ref) return Integer;
   procedure Remove(
      This : access Typ;
      item : MSSyst.Windows.Forms.MenuItem.Ref);
   procedure RemoveAt(
      This : access Typ;
      index : Integer);
