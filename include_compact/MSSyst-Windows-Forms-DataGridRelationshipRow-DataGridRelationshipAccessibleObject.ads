...
with type MSSyst.Windows.Forms.DataGridRelationshipRow.Ref is access;
package MSSyst.Windows.Forms.DataGridRelationshipRow.DataGridRelationshipAccessibleObject is
   type Typ;
   ...
   function new_DataGridRelationshipAccessibleObject(
      This : Ref := null;
      owner : MSSyst.Windows.Forms.DataGridRelationshipRow.Ref;
      relationship : Integer) return Ref;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridRelationshipAccessibleObject);
...
end MSSyst.Windows.Forms.DataGridRelationshipRow.DataGridRelationshipAccessibleObject;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridRelationshipRow.DataGridRelationshipAccessibleObject,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridRelationshipRow/DataGridRelationshipAccessibleObject");
