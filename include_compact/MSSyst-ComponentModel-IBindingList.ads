...
package MSSyst.ComponentModel.IBindingList is
   ...
   procedure add_ListChanged(
      This : access Typ;
      value : MSSyst.ComponentModel.ListChangedEventHandler.Ref) is abstract;
   procedure AddIndex(
      This : access Typ;
      property : MSSyst.ComponentModel.PropertyDescriptor.Ref) is abstract;
   function AddNew(
   ...
   function Find(
      This : access Typ;
      property : MSSyst.ComponentModel.PropertyDescriptor.Ref;
      key : MSSyst.Object.Ref) return Integer is abstract;
