...
package MSSyst.Security.XmlSyntaxException is
   type Typ;
   ...
   function new_XmlSyntaxException(
...
private
   ...
   pragma MSIL_Constructor(new_XmlSyntaxException);
end MSSyst.Security.XmlSyntaxException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Security.XmlSyntaxException,
