...
package MSSyst.ResolveEventHandler is
   ...
   function BeginInvoke(
      ...
      args : MSSyst.ResolveEventArgs.Ref;
      callback : MSSyst.AsyncCallback.Ref;
      object : MSSyst.Object.Ref) return MSSyst.IAsyncResult.Ref;
   function EndInvoke(
      This : access Typ;
      result : MSSyst.IAsyncResult.Ref) return MSSyst.Reflection.Assembly.Ref;
   function Invoke(
      This : access Typ;
      sender : MSSyst.Object.Ref;
      args : MSSyst.ResolveEventArgs.Ref) return MSSyst.Reflection.Assembly.Ref;
private
