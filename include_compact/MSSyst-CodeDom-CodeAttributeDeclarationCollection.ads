...
with type MSSyst.CodeDom.CodeAttributeDeclaration.Ref is access;
with type MSSyst.CodeDom.CodeAttributeDeclaration.Ref_array is access;
...
package MSSyst.CodeDom.CodeAttributeDeclarationCollection is
   ...
   function new_CodeAttributeDeclarationCollection(
      This : Ref := null;
      value : MSSyst.CodeDom.CodeAttributeDeclarationCollection.Ref) return Ref;
   function new_CodeAttributeDeclarationCollection(
      This : Ref := null;
      value : MSSyst.CodeDom.CodeAttributeDeclaration.Ref_array) return Ref;
   function Add(
      This : access Typ;
      value : MSSyst.CodeDom.CodeAttributeDeclaration.Ref) return Integer;
   procedure AddRange(
      This : access Typ;
      value : MSSyst.CodeDom.CodeAttributeDeclaration.Ref_array);
   procedure AddRange(
      This : access Typ;
      value : MSSyst.CodeDom.CodeAttributeDeclarationCollection.Ref);
   function Contains(
      This : access Typ;
      value : MSSyst.CodeDom.CodeAttributeDeclaration.Ref) return Standard.Boolean;
   procedure CopyTo(
      This : access Typ;
      array_k : MSSyst.CodeDom.CodeAttributeDeclaration.Ref_array;
      index : Integer);
   function get_Item(
      This : access Typ;
      index : Integer) return MSSyst.CodeDom.CodeAttributeDeclaration.Ref;
   function IndexOf(
      This : access Typ;
      value : MSSyst.CodeDom.CodeAttributeDeclaration.Ref) return Integer;
   procedure Insert(
      This : access Typ;
      index : Integer;
      value : MSSyst.CodeDom.CodeAttributeDeclaration.Ref);
   procedure Remove(
      This : access Typ;
      value : MSSyst.CodeDom.CodeAttributeDeclaration.Ref);
   procedure set_Item(
