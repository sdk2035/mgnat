...
package MSSyst.ContextMarshalException is
   type Typ;
   ...
   function new_ContextMarshalException(
...
private
   ...
   pragma MSIL_Constructor(new_ContextMarshalException);
end MSSyst.ContextMarshalException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.ContextMarshalException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.ContextMarshalException");
