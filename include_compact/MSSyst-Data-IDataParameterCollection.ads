...
package MSSyst.Data.IDataParameterCollection is
   type Typ;
   ...
   function Contains(
      This : access Typ;
      parameterName : MSSyst.String.Ref) return Standard.Boolean;
   function get_Item(
      This : access Typ;
      parameterName : MSSyst.String.Ref) return MSSyst.Object.Ref;
   function IndexOf(
      This : access Typ;
      parameterName : MSSyst.String.Ref) return Integer;
   procedure RemoveAt(
      This : access Typ;
...
end MSSyst.Data.IDataParameterCollection;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Data.IDataParameterCollection,
   ".ver 1:0:5000:0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[System.Data]System.Data.IDataParameterCollection");
