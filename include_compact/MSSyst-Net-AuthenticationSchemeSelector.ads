...
package MSSyst.Net.AuthenticationSchemeSelector is
   ...
   function BeginInvoke(
      This : access Typ;
      httpRequest : MSSyst.Net.HttpListenerRequest.Ref;
      callback : MSSyst.AsyncCallback.Ref;
      object : MSSyst.Object.Ref) return MSSyst.IAsyncResult.Ref;
   function EndInvoke(
      This : access Typ;
      result : MSSyst.IAsyncResult.Ref) return MSSyst.Net.AuthenticationSchemes.Valuetype;
   function Invoke(
      This : access Typ;
      httpRequest : MSSyst.Net.HttpListenerRequest.Ref) return MSSyst.Net.AuthenticationSchemes.Valuetype;
private
