...
package MSSyst.Runtime.InteropServices.InvalidOleVariantTypeException is
   type Typ;
   ...
   function new_InvalidOleVariantTypeException(
...
private
   ...
   pragma MSIL_Constructor(new_InvalidOleVariantTypeException);
end MSSyst.Runtime.InteropServices.InvalidOleVariantTypeException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Runtime.InteropServices.InvalidOleVariantTypeException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Runtime.InteropServices.InvalidOleVariantTypeException");
