...
package MSSyst.Runtime.Remoting.Messaging.MessageSurrogateFilter is
   type Typ;
   ...
   function new_MessageSurrogateFilter(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_MessageSurrogateFilter);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Runtime.Remoting.Messaging.MessageSurrogateFilter;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Runtime.Remoting.Messaging.MessageSurrogateFilter,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Runtime.Remoting.Messaging.MessageSurrogateFilter");
