...
with type MSSyst.Runtime.InteropServices.UCOMITypeInfo.Ref_array is access;
...
with MSSyst.Guid;
with MSSyst.Runtime.InteropServices.TYPEKIND;
package MSSyst.Runtime.InteropServices.UCOMITypeLib is
   type Typ;
   ...
   procedure FindName(
      ...
      lHashVal : Integer;
      ppTInfo : MSSyst.Runtime.InteropServices.UCOMITypeInfo.Ref_array;
   ...
   procedure GetTypeInfoOfGuid(
      ...
      ppTInfo : MSSyst.Runtime.InteropServices.UCOMITypeInfo.Ref_addrof) is abstract;
   procedure GetTypeInfoType(
      This : access Typ;
      index : Integer;
      pTKind : MSSyst.Runtime.InteropServices.TYPEKIND.Valuetype_addrof) is abstract;
   function IsName(
      This : access Typ;
      szNameBuf : MSSyst.String.Ref;
...
end MSSyst.Runtime.InteropServices.UCOMITypeLib;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Runtime.InteropServices.UCOMITypeLib,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Runtime.InteropServices.UCOMITypeLib");
