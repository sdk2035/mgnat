...
package MSSyst.Windows.Forms.DataGridRow.DataGridRowAccessibleObject is
   type Typ;
   ...
   function new_DataGridRowAccessibleObject(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridRowAccessibleObject);
...
end MSSyst.Windows.Forms.DataGridRow.DataGridRowAccessibleObject;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridRow.DataGridRowAccessibleObject,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridRow/DataGridRowAccessibleObject");
