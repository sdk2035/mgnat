...
package MSSyst.Windows.Forms.RadioButton is
   type Typ;
...
private
   ...
   pragma MSIL_Constructor(new_RadioButton);
...
end MSSyst.Windows.Forms.RadioButton;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.RadioButton,
