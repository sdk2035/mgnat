...
package MSSyst.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject is
   type Typ;
   ...
   function new_ButtonBaseAccessibleObject(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_ButtonBaseAccessibleObject);
   pragma Import(MSIL,DoDefaultAction,"DoDefaultAction");
   pragma Import(MSIL,get_State,"get_State");
end MSSyst.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.ButtonBase.ButtonBaseAccessibleObject,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ButtonBase/ButtonBaseAccessibleObject");
