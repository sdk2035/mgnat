...
package MSSyst.IO.IsolatedStorage.IsolatedStorageException is
   type Typ;
   ...
   function new_IsolatedStorageException(
...
private
   ...
   pragma MSIL_Constructor(new_IsolatedStorageException);
end MSSyst.IO.IsolatedStorage.IsolatedStorageException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.IO.IsolatedStorage.IsolatedStorageException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.IO.IsolatedStorage.IsolatedStorageException");
