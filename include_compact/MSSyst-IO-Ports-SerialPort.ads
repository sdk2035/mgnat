...
with type MSSyst.IO.Ports.SerialDataReceivedEventHandler.Ref is access;
with type MSSyst.EventHandler.Ref is access;
with type MSSyst.IO.Ports.SerialErrorReceivedEventHandler.Ref is access;
with type MSSyst.IO.Ports.SerialPinChangedEventHandler.Ref is access;
...
with MSSyst.IO.Ports.Handshake;
with type MSSyst.String.Ref is access;
with MSSyst.IO.Ports.Parity;
with type MSSyst.ComponentModel.ISite.Ref is access;
with MSSyst.IO.Ports.StopBits;
...
package MSSyst.IO.Ports.SerialPort is
   ...
   function new_SerialPort(
      This : Ref := null;
      portName : MSSyst.String.Ref) return Ref;
   function new_SerialPort(
      This : Ref := null;
      portName : MSSyst.String.Ref;
   ...
   procedure add_DataReceived(
      This : access Typ;
      value : MSSyst.IO.Ports.SerialDataReceivedEventHandler.Ref);
   procedure add_ErrorReceived(
      This : access Typ;
      value : MSSyst.IO.Ports.SerialErrorReceivedEventHandler.Ref);
   procedure add_PinChanged(
      This : access Typ;
      value : MSSyst.IO.Ports.SerialPinChangedEventHandler.Ref);
   procedure Close(
      This : access Typ);
   ...
   function get_WriteTimeout(
      This : access Typ) return Integer;
   function GetPortNames return MSSyst.String.Ref_array;
   procedure Open(
      This : access Typ);
   function Read(
      This : access Typ;
