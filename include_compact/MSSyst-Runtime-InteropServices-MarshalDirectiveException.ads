...
package MSSyst.Runtime.InteropServices.MarshalDirectiveException is
   type Typ;
   ...
   function new_MarshalDirectiveException(
...
private
   ...
   pragma MSIL_Constructor(new_MarshalDirectiveException);
end MSSyst.Runtime.InteropServices.MarshalDirectiveException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Runtime.InteropServices.MarshalDirectiveException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Runtime.InteropServices.MarshalDirectiveException");
