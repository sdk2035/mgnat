...
with type MSSyst.Windows.Forms.PropertyGridInternal.GridEntry.Ref is access;
package MSSyst.Windows.Forms.PropertyGridInternal.GridEntry.GridEntryAccessibleObject is
   type Typ;
   ...
   function new_GridEntryAccessibleObject(
      This : Ref := null;
      owner : MSSyst.Windows.Forms.PropertyGridInternal.GridEntry.Ref) return Ref;
...
private
   ...
   pragma MSIL_Constructor(new_GridEntryAccessibleObject);
...
end MSSyst.Windows.Forms.PropertyGridInternal.GridEntry.GridEntryAccessibleObject;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.PropertyGridInternal.GridEntry.GridEntryAccessibleObject,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.PropertyGridInternal.GridEntry/GridEntryAccessibleObject");
