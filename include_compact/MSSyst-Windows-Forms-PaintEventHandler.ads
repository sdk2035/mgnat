...
with type MSSyst.Windows.Forms.PaintEventArgs.Ref is access;
...
package MSSyst.Windows.Forms.PaintEventHandler is
   type Typ;
   ...
   function new_PaintEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : MSSyst.Windows.Forms.PaintEventArgs.Ref;
...
private
   ...
   pragma MSIL_Constructor(new_PaintEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.PaintEventHandler;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.PaintEventHandler,
