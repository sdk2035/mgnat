...
with type MSSyst.Windows.Forms.NavigateEventHandler.Ref is access;
...
with type MSSyst.Windows.Forms.DataGridCell.Valuetype is tagged;
...
with MSSyst.Windows.Forms.DataGridParentRowsLabelStyle;
...
with type MSSyst.Windows.Forms.GridTableStylesCollection.Ref is access;
...
with type MSSyst.Windows.Forms.DataGrid.HitTestInfo.Ref is access;
...
package MSSyst.Windows.Forms.DataGrid is
   ...
   procedure add_Navigate(
      This : access Typ;
      value : MSSyst.Windows.Forms.NavigateEventHandler.Ref);
   ...
   function get_Item(
      This : access Typ;
      cell : MSSyst.Windows.Forms.DataGridCell.Valuetype) return MSSyst.Object.Ref;
   function get_Item(
      This : access Typ;
      rowIndex : Integer;
   ...
   function get_TableStyles(
      This : access Typ) return MSSyst.Windows.Forms.GridTableStylesCollection.Ref;
   function get_Text(
      This : access Typ) return MSSyst.String.Ref;
   ...
   function HitTest(
      This : access Typ;
      position : MSSyst.Drawing.Point.Valuetype) return MSSyst.Windows.Forms.DataGrid.HitTestInfo.Ref;
   function HitTest(
      This : access Typ;
      x : Integer;
      y : Integer) return MSSyst.Windows.Forms.DataGrid.HitTestInfo.Ref;
   function IsExpanded(
      This : access Typ;
      rowNumber : Integer) return Standard.Boolean;
   function IsSelected(
