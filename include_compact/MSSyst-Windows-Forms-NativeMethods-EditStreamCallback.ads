...
package MSSyst.Windows.Forms.NativeMethods.EditStreamCallback is
   type Typ;
   ...
   function new_EditStreamCallback(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      cb : Integer;
      transferred : MSIL_Types.Int32_addrof;
   ...
   function Invoke(
      ...
      buf : MSIL_Types.native_int;
      cb : Integer;
      transferred : MSIL_Types.Int32_addrof) return Integer;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_EditStreamCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.NativeMethods.EditStreamCallback;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.NativeMethods.EditStreamCallback,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NativeMethods/EditStreamCallback");
