...
package MSSyst.Runtime.Serialization.SurrogateSelector is
   ...
   procedure AddSurrogate(
      ...
      surrogate : MSSyst.Runtime.Serialization.ISerializationSurrogate.Ref);
   ...
   function GetSurrogate(
      ...
      type_k : MSSyst.Type_k.Ref;
      context : MSSyst.Runtime.Serialization.StreamingContext.Valuetype;
      selector : MSSyst.Runtime.Serialization.ISurrogateSelector.Ref_addrof) return MSSyst.Runtime.Serialization.ISerializationSurrogate.Ref;
