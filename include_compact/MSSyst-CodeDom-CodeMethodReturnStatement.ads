...
package MSSyst.CodeDom.CodeMethodReturnStatement is
   type Typ;
   ...
   function new_CodeMethodReturnStatement(
...
private
   ...
   pragma MSIL_Constructor(new_CodeMethodReturnStatement);
   pragma Import(MSIL,get_Expression,"get_Expression");
   pragma Import(MSIL,set_Expression,"set_Expression");
end MSSyst.CodeDom.CodeMethodReturnStatement;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.CodeDom.CodeMethodReturnStatement,
