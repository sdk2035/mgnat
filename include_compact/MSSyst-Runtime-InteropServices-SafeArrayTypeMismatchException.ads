...
package MSSyst.Runtime.InteropServices.SafeArrayTypeMismatchException is
   type Typ;
   ...
   function new_SafeArrayTypeMismatchException(
...
private
   ...
   pragma MSIL_Constructor(new_SafeArrayTypeMismatchException);
end MSSyst.Runtime.InteropServices.SafeArrayTypeMismatchException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Runtime.InteropServices.SafeArrayTypeMismatchException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Runtime.InteropServices.SafeArrayTypeMismatchException");
