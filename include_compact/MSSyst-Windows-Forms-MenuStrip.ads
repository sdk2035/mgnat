...
with type MSSyst.Windows.Forms.ToolStripMenuItem.Ref is access;
...
package MSSyst.Windows.Forms.MenuStrip is
   ...
   function get_MdiWindowListItem(
      This : access Typ) return MSSyst.Windows.Forms.ToolStripMenuItem.Ref;
   ...
   procedure set_MdiWindowListItem(
      This : access Typ;
      value : MSSyst.Windows.Forms.ToolStripMenuItem.Ref);
