...
package MSSyst.Text.UTF8Encoding is
   type Typ;
   ...
   function new_UTF8Encoding(
      This : Ref := null) return Ref;
   function new_UTF8Encoding(
      This : Ref := null;
      encoderShouldEmitUTF8Identifier : Standard.Boolean) return Ref;
   function new_UTF8Encoding(
      This : Ref := null;
      encoderShouldEmitUTF8Identifier : Standard.Boolean;
...
private
   ...
   pragma MSIL_Constructor(new_UTF8Encoding);
...
end MSSyst.Text.UTF8Encoding;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Text.UTF8Encoding,
