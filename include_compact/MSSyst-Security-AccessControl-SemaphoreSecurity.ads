...
with type MSSyst.Security.AccessControl.SemaphoreAccessRule.Ref is access;
with type MSSyst.Security.AccessControl.SemaphoreAuditRule.Ref is access;
...
package MSSyst.Security.AccessControl.SemaphoreSecurity is
   ...
   procedure AddAccessRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.SemaphoreAccessRule.Ref);
   procedure AddAuditRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.SemaphoreAuditRule.Ref);
   ...
   function RemoveAccessRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.SemaphoreAccessRule.Ref) return Standard.Boolean;
   ...
   function RemoveAuditRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.SemaphoreAuditRule.Ref) return Standard.Boolean;
