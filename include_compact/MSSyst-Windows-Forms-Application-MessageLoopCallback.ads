...
package MSSyst.Windows.Forms.Application.MessageLoopCallback is
   type Typ;
   ...
   function new_MessageLoopCallback(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_MessageLoopCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.Application.MessageLoopCallback;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.Application.MessageLoopCallback,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.Application/MessageLoopCallback");
