...
package MSSyst.FieldAccessException is
   type Typ;
   ...
   function new_FieldAccessException(
...
private
   ...
   pragma MSIL_Constructor(new_FieldAccessException);
end MSSyst.FieldAccessException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.FieldAccessException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.FieldAccessException");
