...
with MSSyst.Globalization.DigitShapes;
...
package MSSyst.Globalization.NumberFormatInfo is
   ...
   function get_CurrencySymbol(
      This : access Typ) return MSSyst.String.Ref;
   function get_CurrentInfo return MSSyst.Globalization.NumberFormatInfo.Ref;
   function get_DigitSubstitution(
      This : access Typ) return MSSyst.Globalization.DigitShapes.Valuetype;
   function get_InvariantInfo return MSSyst.Globalization.NumberFormatInfo.Ref;
   ...
   function GetInstance(
      formatProvider : MSSyst.IFormatProvider.Ref) return MSSyst.Globalization.NumberFormatInfo.Ref;
   function ReadOnly(
      nfi : MSSyst.Globalization.NumberFormatInfo.Ref) return MSSyst.Globalization.NumberFormatInfo.Ref;
