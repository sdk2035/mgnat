...
package MSSyst.Security.Policy.Publisher is
   type Typ;
...
private
   ...
   pragma MSIL_Constructor(new_Publisher);
...
end MSSyst.Security.Policy.Publisher;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Security.Policy.Publisher,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Security.Policy.Publisher");
