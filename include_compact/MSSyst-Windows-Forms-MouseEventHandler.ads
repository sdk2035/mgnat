...
with type MSSyst.Windows.Forms.MouseEventArgs.Ref is access;
...
package MSSyst.Windows.Forms.MouseEventHandler is
   type Typ;
   ...
   function new_MouseEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : MSSyst.Windows.Forms.MouseEventArgs.Ref;
...
private
   ...
   pragma MSIL_Constructor(new_MouseEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.MouseEventHandler;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.MouseEventHandler,
