...
with type MSSyst.Net.Configuration.SmtpNetworkElement.Ref is access;
with type MSSyst.Configuration.SectionInformation.Ref is access;
with type MSSyst.Net.Configuration.SmtpSpecifiedPickupDirectoryElement.Ref is access;
...
package MSSyst.Net.Configuration.SmtpSection is
   ...
   function get_Network(
      This : access Typ) return MSSyst.Net.Configuration.SmtpNetworkElement.Ref;
   function get_SpecifiedPickupDirectory(
      This : access Typ) return MSSyst.Net.Configuration.SmtpSpecifiedPickupDirectoryElement.Ref;
