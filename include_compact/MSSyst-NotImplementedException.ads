...
package MSSyst.NotImplementedException is
   type Typ;
   ...
   function new_NotImplementedException(
...
private
   ...
   pragma MSIL_Constructor(new_NotImplementedException);
end MSSyst.NotImplementedException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.NotImplementedException,
