...
with type MSSyst.Net.Configuration.BypassElement.Ref is access;
...
package MSSyst.Net.Configuration.BypassElementCollection is
   ...
   procedure Add(
      This : access Typ;
      element : MSSyst.Net.Configuration.BypassElement.Ref);
   procedure Clear(
      This : access Typ);
   function get_Item(
      This : access Typ;
      name : MSSyst.String.Ref) return MSSyst.Net.Configuration.BypassElement.Ref;
   function get_Item(
      This : access Typ;
      index : Integer) return MSSyst.Net.Configuration.BypassElement.Ref;
   function IndexOf(
      This : access Typ;
      element : MSSyst.Net.Configuration.BypassElement.Ref) return Integer;
   procedure Remove(
      This : access Typ;
      element : MSSyst.Net.Configuration.BypassElement.Ref);
   procedure Remove(
   ...
   procedure set_Item(
      This : access Typ;
      index : Integer;
      value : MSSyst.Net.Configuration.BypassElement.Ref);
   procedure set_Item(
      This : access Typ;
      name : MSSyst.String.Ref;
      value : MSSyst.Net.Configuration.BypassElement.Ref);
