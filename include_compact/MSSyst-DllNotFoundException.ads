...
package MSSyst.DllNotFoundException is
   type Typ;
   ...
   function new_DllNotFoundException(
...
private
   ...
   pragma MSIL_Constructor(new_DllNotFoundException);
end MSSyst.DllNotFoundException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.DllNotFoundException,
