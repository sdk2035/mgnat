...
package MSSyst.Security.Permissions.GacIdentityPermission is
   type Typ;
   ...
   function new_GacIdentityPermission(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_GacIdentityPermission);
...
end MSSyst.Security.Permissions.GacIdentityPermission;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Security.Permissions.GacIdentityPermission,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Security.Permissions.GacIdentityPermission");
