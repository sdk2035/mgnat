...
package MSSyst.Windows.Forms.ComboBox.ObjectCollection is
   type Typ;
   ...
   function new_ObjectCollection(
      This : Ref := null;
      owner : MSSyst.Windows.Forms.ComboBox.Ref) return Ref;
   function Add(
      This : access Typ;
...
end MSSyst.Windows.Forms.ComboBox.ObjectCollection;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.ComboBox.ObjectCollection,
