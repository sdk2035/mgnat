...
with MSIL_Types;
use MSIL_Types;
with MSSyst.NotSupportedException;
...
package MSSyst.PlatformNotSupportedException is
   type Typ;
   ...
   type Typ is new MSSyst.NotSupportedException.Typ
         and MSSyst.Runtime.Serialization.ISerializable.Typ
         and MSSyst.Runtime.InteropServices.uException.Typ
   with record
      null;
   end record;
   function new_PlatformNotSupportedException(
...
private
   ...
   pragma MSIL_Constructor(new_PlatformNotSupportedException);
end MSSyst.PlatformNotSupportedException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.PlatformNotSupportedException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.PlatformNotSupportedException");
