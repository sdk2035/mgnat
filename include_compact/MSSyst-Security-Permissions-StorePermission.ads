...
package MSSyst.Security.Permissions.StorePermission is
   type Typ;
   ...
   function new_StorePermission(
      This : Ref := null;
      state : MSSyst.Security.Permissions.PermissionState.Valuetype) return Ref;
   function new_StorePermission(
      This : Ref := null;
      flag : MSSyst.Security.Permissions.StorePermissionFlags.Valuetype) return Ref;
   function Copy(
...
private
   ...
   pragma MSIL_Constructor(new_StorePermission);
...
end MSSyst.Security.Permissions.StorePermission;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Security.Permissions.StorePermission,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Permissions.StorePermission");
