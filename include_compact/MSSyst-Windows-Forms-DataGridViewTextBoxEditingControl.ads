...
package MSSyst.Windows.Forms.DataGridViewTextBoxEditingControl is
   type Typ;
   ...
   function new_DataGridViewTextBoxEditingControl(
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewTextBoxEditingControl);
...
end MSSyst.Windows.Forms.DataGridViewTextBoxEditingControl;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewTextBoxEditingControl,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewTextBoxEditingControl");
