...
package MSSyst.Windows.Forms.NativeMethods.FONTDESC is
   type Typ;
   ...
   function new_FONTDESC(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_FONTDESC);
end MSSyst.Windows.Forms.NativeMethods.FONTDESC;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.NativeMethods.FONTDESC,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NativeMethods/FONTDESC");
