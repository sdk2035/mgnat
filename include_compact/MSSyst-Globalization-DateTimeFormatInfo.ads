...
package MSSyst.Globalization.DateTimeFormatInfo is
   ...
   function get_CurrentInfo return MSSyst.Globalization.DateTimeFormatInfo.Ref;
   ...
   function get_FullDateTimePattern(
      This : access Typ) return MSSyst.String.Ref;
   function get_InvariantInfo return MSSyst.Globalization.DateTimeFormatInfo.Ref;
   ...
   function GetAbbreviatedDayName(
      This : access Typ;
      dayofweek : MSSyst.DayOfWeek.Valuetype) return MSSyst.String.Ref;
   function GetAbbreviatedEraName(
      This : access Typ;
      era : Integer) return MSSyst.String.Ref;
   function GetAbbreviatedMonthName(
      This : access Typ;
      month : Integer) return MSSyst.String.Ref;
   ...
   function GetEra(
      This : access Typ;
      eraName : MSSyst.String.Ref) return Integer;
   function GetEraName(
      This : access Typ;
      era : Integer) return MSSyst.String.Ref;
   function GetFormat(
   ...
   function GetInstance(
      provider : MSSyst.IFormatProvider.Ref) return MSSyst.Globalization.DateTimeFormatInfo.Ref;
   ...
   function GetShortestDayName(
      ...
      dayOfWeek : MSSyst.DayOfWeek.Valuetype) return MSSyst.String.Ref;
   function ReadOnly(
      dtfi : MSSyst.Globalization.DateTimeFormatInfo.Ref) return MSSyst.Globalization.DateTimeFormatInfo.Ref;
   ...
   procedure set_Calendar(
      This : access Typ;
      value : MSSyst.Globalization.Calendar.Ref);
   ...
   procedure SetAllDateTimePatterns(
      This : access Typ;
      patterns : MSSyst.String.Ref_array;
