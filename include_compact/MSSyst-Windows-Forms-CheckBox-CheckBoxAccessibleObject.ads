...
package MSSyst.Windows.Forms.CheckBox.CheckBoxAccessibleObject is
   type Typ;
   ...
   function new_CheckBoxAccessibleObject(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_CheckBoxAccessibleObject);
...
end MSSyst.Windows.Forms.CheckBox.CheckBoxAccessibleObject;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.CheckBox.CheckBoxAccessibleObject,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.CheckBox/CheckBoxAccessibleObject");
