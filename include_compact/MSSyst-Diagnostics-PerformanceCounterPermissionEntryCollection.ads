...
with type MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref is access;
...
package MSSyst.Diagnostics.PerformanceCounterPermissionEntryCollection is
   ...
   function Add(
      This : access Typ;
      value : MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref) return Integer;
   procedure AddRange(
      This : access Typ;
      value : MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref_array);
   procedure AddRange(
      This : access Typ;
      value : MSSyst.Diagnostics.PerformanceCounterPermissionEntryCollection.Ref);
   function Contains(
      This : access Typ;
      value : MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref) return Standard.Boolean;
   procedure CopyTo(
      This : access Typ;
      array_k : MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref_array;
      index : Integer);
   function get_Item(
      This : access Typ;
      index : Integer) return MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref;
   function IndexOf(
      This : access Typ;
      value : MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref) return Integer;
   procedure Insert(
      This : access Typ;
      index : Integer;
      value : MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref);
   procedure Remove(
      This : access Typ;
      value : MSSyst.Diagnostics.PerformanceCounterPermissionEntry.Ref);
   procedure set_Item(
