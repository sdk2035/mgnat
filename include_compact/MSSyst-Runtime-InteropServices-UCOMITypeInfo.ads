...
with MSIL_Types;
use MSIL_Types;
with MSSyst.Runtime.InteropServices.INVOKEKIND;
with type MSSyst.Object.Ref is access;
with MSSyst.Guid;
with type MSSyst.Object.Ref_addrof is access;
with type MSSyst.Runtime.InteropServices.UCOMITypeLib.Ref_addrof is access;
...
package MSSyst.Runtime.InteropServices.UCOMITypeInfo is
   ...
   procedure GetContainingTypeLib(
      This : access Typ;
      ppTLB : MSSyst.Runtime.InteropServices.UCOMITypeLib.Ref_addrof;
      pIndex : MSIL_Types.Int32_addrof) is abstract;
   procedure GetDllEntry(
      This : access Typ;
      memid : Integer;
      invKind : MSSyst.Runtime.InteropServices.INVOKEKIND.Valuetype;
      pBstrDllName : MSSyst.String.Ref_addrof;
   ...
   procedure GetRefTypeInfo(
      This : access Typ;
      hRef : Integer;
      ppTI : MSSyst.Runtime.InteropServices.UCOMITypeInfo.Ref_addrof) is abstract;
   ...
   procedure Invoke(
      ...
      pDispParams : MSSyst.Runtime.InteropServices.DISPPARAMS.Valuetype_addrof;
      pVarResult : MSSyst.Object.Ref_addrof;
      pExcepInfo : MSSyst.Runtime.InteropServices.EXCEPINFO.Valuetype_addrof;
