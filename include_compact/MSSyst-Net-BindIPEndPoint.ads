...
package MSSyst.Net.BindIPEndPoint is
   ...
   function BeginInvoke(
      This : access Typ;
      servicePoint : MSSyst.Net.ServicePoint.Ref;
      remoteEndPoint : MSSyst.Net.IPEndPoint.Ref;
      retryCount : Integer;
      callback : MSSyst.AsyncCallback.Ref;
      object : MSSyst.Object.Ref) return MSSyst.IAsyncResult.Ref;
   function EndInvoke(
      This : access Typ;
      result : MSSyst.IAsyncResult.Ref) return MSSyst.Net.IPEndPoint.Ref;
   function Invoke(
      This : access Typ;
      servicePoint : MSSyst.Net.ServicePoint.Ref;
      remoteEndPoint : MSSyst.Net.IPEndPoint.Ref;
      retryCount : Integer) return MSSyst.Net.IPEndPoint.Ref;
private
