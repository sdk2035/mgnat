...
package MSSyst.Windows.Forms.DataGridRow.DataGridCellAccessibleObject is
   type Typ;
   ...
   function new_DataGridCellAccessibleObject(
      This : Ref := null;
      owner : MSSyst.Windows.Forms.DataGridRow.Ref;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridCellAccessibleObject);
...
end MSSyst.Windows.Forms.DataGridRow.DataGridCellAccessibleObject;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridRow.DataGridCellAccessibleObject,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridRow/DataGridCellAccessibleObject");
