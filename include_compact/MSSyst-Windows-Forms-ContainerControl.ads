...
package MSSyst.Windows.Forms.ContainerControl is
   type Typ;
   ...
   function get_AutoScaleDimensions(
      This : access Typ) return MSSyst.Drawing.SizeF.Valuetype;
   function get_AutoScaleMode(
      This : access Typ) return MSSyst.Windows.Forms.AutoScaleMode.Valuetype;
   ...
   function get_CurrentAutoScaleDimensions(
      This : access Typ) return MSSyst.Drawing.SizeF.Valuetype;
   function get_ParentForm(
   ...
   procedure set_AutoScaleDimensions(
      This : access Typ;
      value : MSSyst.Drawing.SizeF.Valuetype);
   procedure set_AutoScaleMode(
      This : access Typ;
      value : MSSyst.Windows.Forms.AutoScaleMode.Valuetype);
   ...
   function Validate(
      This : access Typ;
      checkAutoValidate : Standard.Boolean) return Standard.Boolean;
   function Validate(
...
private
   ...
   pragma MSIL_Constructor(new_ContainerControl);
   pragma Import(MSIL,add_AutoValidateChanged,"add_AutoValidateChanged");
   pragma Import(MSIL,get_ActiveControl,"get_ActiveControl");
   pragma Import(MSIL,get_AutoScaleDimensions,"get_AutoScaleDimensions");
   pragma Import(MSIL,get_AutoScaleMode,"get_AutoScaleMode");
   pragma Import(MSIL,get_AutoValidate,"get_AutoValidate");
   pragma Import(MSIL,get_BindingContext,"get_BindingContext");
   pragma Import(MSIL,get_CurrentAutoScaleDimensions,"get_CurrentAutoScaleDimensions");
   pragma Import(MSIL,get_ParentForm,"get_ParentForm");
   pragma Import(MSIL,PerformAutoScale,"PerformAutoScale");
   ...
   pragma Import(MSIL,set_AutoScaleDimensions,"set_AutoScaleDimensions");
   pragma Import(MSIL,set_AutoScaleMode,"set_AutoScaleMode");
...
end MSSyst.Windows.Forms.ContainerControl;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.ContainerControl,
