...
package MSSyst.Text.RegularExpressions.MatchEvaluator is
   ...
   function BeginInvoke(
      This : access Typ;
      match : MSSyst.Text.RegularExpressions.Match.Ref;
      callback : MSSyst.AsyncCallback.Ref;
      object : MSSyst.Object.Ref) return MSSyst.IAsyncResult.Ref;
   function EndInvoke(
      This : access Typ;
      result : MSSyst.IAsyncResult.Ref) return MSSyst.String.Ref;
   function Invoke(
      This : access Typ;
      match : MSSyst.Text.RegularExpressions.Match.Ref) return MSSyst.String.Ref;
private
