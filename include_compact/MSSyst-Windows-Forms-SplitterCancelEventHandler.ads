...
package MSSyst.Windows.Forms.SplitterCancelEventHandler is
   type Typ;
   ...
   function new_SplitterCancelEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_SplitterCancelEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.SplitterCancelEventHandler;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Windows.Forms.SplitterCancelEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.SplitterCancelEventHandler");
