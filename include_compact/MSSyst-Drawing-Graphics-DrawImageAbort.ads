...
package MSSyst.Drawing.Graphics.DrawImageAbort is
   type Typ;
   ...
   function Invoke(
      This : access Typ;
      callbackdata : MSIL_Types.native_int) return Standard.Boolean;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_DrawImageAbort);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Drawing.Graphics.DrawImageAbort;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Drawing.Graphics.DrawImageAbort,
   ".ver 2:0:0:0 .publickeytoken=( b0 3f 5f 7f 11 d5 0a 3a )",
   "[System.Drawing]System.Drawing.Graphics/DrawImageAbort");
