...
package MSSyst.ComponentModel.DataObjectAttribute is
   ...
   DataObject : MSSyst.ComponentModel.DataObjectAttribute.Ref;
   pragma Import(MSIL,DataObject,"DataObject");
   NonDataObject : MSSyst.ComponentModel.DataObjectAttribute.Ref;
   pragma Import(MSIL,NonDataObject,"NonDataObject");
   Default : MSSyst.ComponentModel.DataObjectAttribute.Ref;
