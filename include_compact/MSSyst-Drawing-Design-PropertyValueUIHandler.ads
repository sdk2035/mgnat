...
package MSSyst.Drawing.Design.PropertyValueUIHandler is
   type Typ;
   ...
   function new_PropertyValueUIHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      propDesc : MSSyst.ComponentModel.PropertyDescriptor.Ref;
      valueUIItemList : MSSyst.Collections.ArrayList.Ref;
...
private
   ...
   pragma MSIL_Constructor(new_PropertyValueUIHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Drawing.Design.PropertyValueUIHandler;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Drawing.Design.PropertyValueUIHandler,
   ".ver 2:0:0:0 .publickeytoken=( b0 3f 5f 7f 11 d5 0a 3a )",
   "[System.Drawing]System.Drawing.Design.PropertyValueUIHandler");
