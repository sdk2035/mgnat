...
with MSSyst.Security.Permissions.EnvironmentPermissionAccess;
...
package MSSyst.Security.Permissions.EnvironmentPermission is
   ...
   function GetPathList(
      This : access Typ;
      flag : MSSyst.Security.Permissions.EnvironmentPermissionAccess.Valuetype) return MSSyst.String.Ref;
   function Intersect(
      This : access Typ;
