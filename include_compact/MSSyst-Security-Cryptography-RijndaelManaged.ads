...
with MSIL_Types;
use MSIL_Types;
with MSSyst.Security.Cryptography.Rijndael;
...
package MSSyst.Security.Cryptography.RijndaelManaged is
   type Typ;
   ...
   type Typ is new MSSyst.Security.Cryptography.Rijndael.Typ   with record
      null;
   end record;
   function new_RijndaelManaged(
...
private
   ...
   pragma MSIL_Constructor(new_RijndaelManaged);
...
end MSSyst.Security.Cryptography.RijndaelManaged;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Security.Cryptography.RijndaelManaged,
