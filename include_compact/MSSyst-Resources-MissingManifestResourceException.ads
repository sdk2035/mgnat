...
package MSSyst.Resources.MissingManifestResourceException is
   type Typ;
   ...
   function new_MissingManifestResourceException(
...
private
   ...
   pragma MSIL_Constructor(new_MissingManifestResourceException);
end MSSyst.Resources.MissingManifestResourceException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Resources.MissingManifestResourceException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Resources.MissingManifestResourceException");
