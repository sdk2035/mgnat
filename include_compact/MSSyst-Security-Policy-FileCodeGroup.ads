...
package MSSyst.Security.Policy.FileCodeGroup is
   type Typ;
   ...
   function new_FileCodeGroup(
      This : Ref := null;
      membershipCondition : MSSyst.Security.Policy.IMembershipCondition.Ref;
      access_k : MSSyst.Security.Permissions.FileIOPermissionAccess.Valuetype) return Ref;
   function Copy(
...
private
   ...
   pragma MSIL_Constructor(new_FileCodeGroup);
...
end MSSyst.Security.Policy.FileCodeGroup;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Security.Policy.FileCodeGroup,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.Security.Policy.FileCodeGroup");
