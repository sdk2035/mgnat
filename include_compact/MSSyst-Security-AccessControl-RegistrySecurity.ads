...
with type MSSyst.Security.AccessControl.RegistryAccessRule.Ref is access;
with type MSSyst.Security.AccessControl.RegistryAuditRule.Ref is access;
...
package MSSyst.Security.AccessControl.RegistrySecurity is
   ...
   procedure AddAccessRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.RegistryAccessRule.Ref);
   procedure AddAuditRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.RegistryAuditRule.Ref);
   ...
   function RemoveAccessRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.RegistryAccessRule.Ref) return Standard.Boolean;
   ...
   function RemoveAuditRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.RegistryAuditRule.Ref) return Standard.Boolean;
