...
with type MSSyst.Data.FillErrorEventArgs.Ref is access;
...
package MSSyst.Data.FillErrorEventHandler is
   type Typ;
   ...
   function new_FillErrorEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : MSSyst.Data.FillErrorEventArgs.Ref;
...
private
   ...
   pragma MSIL_Constructor(new_FillErrorEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Data.FillErrorEventHandler;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Data.FillErrorEventHandler,
   ".ver 1:0:5000:0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[System.Data]System.Data.FillErrorEventHandler");
