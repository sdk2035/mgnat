...
with type MSSyst.ResolveEventArgs.Ref is access;
...
package MSSyst.Reflection.ModuleResolveEventHandler is
   ...
   function BeginInvoke(
      ...
      e : MSSyst.ResolveEventArgs.Ref;
      callback : MSSyst.AsyncCallback.Ref;
      object : MSSyst.Object.Ref) return MSSyst.IAsyncResult.Ref;
   function EndInvoke(
      This : access Typ;
      result : MSSyst.IAsyncResult.Ref) return MSSyst.Reflection.Module.Ref;
   function Invoke(
      This : access Typ;
      sender : MSSyst.Object.Ref;
      e : MSSyst.ResolveEventArgs.Ref) return MSSyst.Reflection.Module.Ref;
private
