...
package MSSyst.MemberAccessException is
   type Typ;
   ...
   function new_MemberAccessException(
...
private
   ...
   pragma MSIL_Constructor(new_MemberAccessException);
end MSSyst.MemberAccessException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.MemberAccessException,
