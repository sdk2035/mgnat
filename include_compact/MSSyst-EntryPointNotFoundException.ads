...
package MSSyst.EntryPointNotFoundException is
   type Typ;
   ...
   type Typ is new MSSyst.TypeLoadException.Typ
         and MSSyst.Runtime.Serialization.ISerializable.Typ
         and MSSyst.Runtime.InteropServices.uException.Typ
   with record
      null;
   end record;
   function new_EntryPointNotFoundException(
...
private
   ...
   pragma MSIL_Constructor(new_EntryPointNotFoundException);
end MSSyst.EntryPointNotFoundException;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.EntryPointNotFoundException,
   ".ver 2.0.0.0 .publickeytoken=( 96 9d b8 05 3d 33 22 ac )",
   "[mscorlib]System.EntryPointNotFoundException");
