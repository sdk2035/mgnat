...
with type MSSyst.Net.ICertificatePolicy.Ref is access;
with MSSyst.Net.SecurityProtocolType;
...
package MSSyst.Net.ServicePointManager is
   ...
   function FindServicePoint(
      address : MSSyst.Uri.Ref) return MSSyst.Net.ServicePoint.Ref;
   function FindServicePoint(
      uriString : MSSyst.String.Ref;
      proxy : MSSyst.Net.IWebProxy.Ref) return MSSyst.Net.ServicePoint.Ref;
   function FindServicePoint(
      address : MSSyst.Uri.Ref;
      proxy : MSSyst.Net.IWebProxy.Ref) return MSSyst.Net.ServicePoint.Ref;
   function get_CertificatePolicy return MSSyst.Net.ICertificatePolicy.Ref;
   ...
   function get_ServerCertificateValidationCallback return MSSyst.Net.Security.RemoteCertificateValidationCallback.Ref;
   function get_UseNagleAlgorithm return Standard.Boolean;
   procedure set_CertificatePolicy(
      value : MSSyst.Net.ICertificatePolicy.Ref);
   ...
   procedure set_ServerCertificateValidationCallback(
      value : MSSyst.Net.Security.RemoteCertificateValidationCallback.Ref);
