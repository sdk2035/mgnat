...
with MSSyst.ComponentModel.Design.HelpKeywordType;
with MSSyst.ComponentModel.Design.HelpContextType;
package MSSyst.ComponentModel.Design.IHelpService is
   ...
   function CreateLocalContext(
      This : access Typ;
      contextType : MSSyst.ComponentModel.Design.HelpContextType.Valuetype) return MSSyst.ComponentModel.Design.IHelpService.Ref is abstract;
   ...
   procedure RemoveLocalContext(
      This : access Typ;
      localContext : MSSyst.ComponentModel.Design.IHelpService.Ref) is abstract;
   procedure ShowHelpFromKeyword(
      This : access Typ;
      helpKeyword : MSSyst.String.Ref) is abstract;
   procedure ShowHelpFromUrl(
      This : access Typ;
      helpUrl : MSSyst.String.Ref) is abstract;
private
