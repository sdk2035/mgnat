...
with type MSSyst.Security.AccessControl.CryptoKeyAccessRule.Ref is access;
with type MSSyst.Security.AccessControl.CryptoKeyAuditRule.Ref is access;
...
with type MSSyst.Security.AccessControl.CommonSecurityDescriptor.Ref is access;
package MSSyst.Security.AccessControl.CryptoKeySecurity is
   ...
   function new_CryptoKeySecurity(
      This : Ref := null;
      securityDescriptor : MSSyst.Security.AccessControl.CommonSecurityDescriptor.Ref) return Ref;
   ...
   procedure AddAccessRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.CryptoKeyAccessRule.Ref);
   procedure AddAuditRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.CryptoKeyAuditRule.Ref);
   ...
   function RemoveAccessRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.CryptoKeyAccessRule.Ref) return Standard.Boolean;
   ...
   function RemoveAuditRule(
      This : access Typ;
      rule : MSSyst.Security.AccessControl.CryptoKeyAuditRule.Ref) return Standard.Boolean;
