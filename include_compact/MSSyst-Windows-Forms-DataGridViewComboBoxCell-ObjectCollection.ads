...
with type MSSyst.Windows.Forms.DataGridViewComboBoxCell.Ref is access;
package MSSyst.Windows.Forms.DataGridViewComboBoxCell.ObjectCollection is
   ...
   function new_ObjectCollection(
      This : Ref := null;
      owner : MSSyst.Windows.Forms.DataGridViewComboBoxCell.Ref) return Ref;
   function Add(
      This : access Typ;
   ...
   procedure AddRange(
      This : access Typ;
      value : MSSyst.Windows.Forms.DataGridViewComboBoxCell.ObjectCollection.Ref);
   procedure Clear(
      This : access Typ);
   function Contains(
      This : access Typ;
