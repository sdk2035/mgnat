...
package MSSyst.Drawing.Printing.PrintPageEventHandler is
   type Typ;
   ...
   function new_PrintPageEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_PrintPageEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Drawing.Printing.PrintPageEventHandler;
pragma Extensions_Allowed(Off);
pragma Import(MSIL,MSSyst.Drawing.Printing.PrintPageEventHandler,
