...
limited with MSSyst.ComponentModel.CollectionChangeEventArgs;
...
package MSSyst.ComponentModel.CollectionChangeEventHandler is
   ...
   function new_CollectionChangeEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.CollectionChangeEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_CollectionChangeEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.CollectionChangeEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.CollectionChangeEventHandler,
