...
package MSSyst.Configuration.SettingsManageability is
   type ValueType is (
      Roaming);
...
end MSSyst.Configuration.SettingsManageability;
pragma Import(MSIL,MSSyst.Configuration.SettingsManageability,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Configuration.SettingsManageability");
