...
package MSSyst.NotSupportedException is
   ...
   function new_NotSupportedException(
...
private
   ...
   pragma MSIL_Constructor(new_NotSupportedException);
end MSSyst.NotSupportedException;
pragma Import(MSIL,MSSyst.NotSupportedException,
