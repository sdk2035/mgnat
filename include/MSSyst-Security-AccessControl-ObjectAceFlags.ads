...
package MSSyst.Security.AccessControl.ObjectAceFlags is
   type ValueType is (
      None,
...
end MSSyst.Security.AccessControl.ObjectAceFlags;
pragma Import(MSIL,MSSyst.Security.AccessControl.ObjectAceFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.ObjectAceFlags");
