...
limited with MSSyst.IO.Ports.SerialDataReceivedEventArgs;
...
package MSSyst.IO.Ports.SerialDataReceivedEventHandler is
   ...
   function new_SerialDataReceivedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.IO.Ports.SerialDataReceivedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SerialDataReceivedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.IO.Ports.SerialDataReceivedEventHandler;
pragma Import(MSIL,MSSyst.IO.Ports.SerialDataReceivedEventHandler,
