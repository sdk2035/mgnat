...
package MSSyst.Runtime.InteropServices.LayoutKind is
   type ValueType is (
      Sequential,
      Explicit,
      Auto);
...
end MSSyst.Runtime.InteropServices.LayoutKind;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.LayoutKind,
