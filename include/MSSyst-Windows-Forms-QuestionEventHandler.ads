...
limited with MSSyst.Windows.Forms.QuestionEventArgs;
package MSSyst.Windows.Forms.QuestionEventHandler is
   ...
   function new_QuestionEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.QuestionEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_QuestionEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.QuestionEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.QuestionEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.QuestionEventHandler");
