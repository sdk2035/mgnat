...
package MSSyst.DuplicateWaitObjectException is
   ...
   function new_DuplicateWaitObjectException(
   ...
   function new_DuplicateWaitObjectException(
      This : Ref := null;
      parameterName : access MSSyst.String.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DuplicateWaitObjectException);
end MSSyst.DuplicateWaitObjectException;
pragma Import(MSIL,MSSyst.DuplicateWaitObjectException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.DuplicateWaitObjectException");
