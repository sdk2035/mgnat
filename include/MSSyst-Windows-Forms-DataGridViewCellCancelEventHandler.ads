...
limited with MSSyst.Windows.Forms.DataGridViewCellCancelEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellCancelEventHandler is
   ...
   function new_DataGridViewCellCancelEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellCancelEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellCancelEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellCancelEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellCancelEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellCancelEventHandler");
