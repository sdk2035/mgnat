...
limited with MSSyst.Windows.Forms.DataGridViewAutoSizeColumnsModeEventArgs;
package MSSyst.Windows.Forms.DataGridViewAutoSizeColumnsModeEventHandler is
   ...
   function new_DataGridViewAutoSizeColumnsModeEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewAutoSizeColumnsModeEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewAutoSizeColumnsModeEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewAutoSizeColumnsModeEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewAutoSizeColumnsModeEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewAutoSizeColumnsModeEventHandler");
