...
limited with MSSyst.Windows.Forms.ListControlConvertEventArgs;
package MSSyst.Windows.Forms.ListControlConvertEventHandler is
   ...
   function new_ListControlConvertEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ListControlConvertEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ListControlConvertEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ListControlConvertEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ListControlConvertEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ListControlConvertEventHandler");
