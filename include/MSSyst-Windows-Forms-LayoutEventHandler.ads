...
package MSSyst.Windows.Forms.LayoutEventHandler is
   ...
   function new_LayoutEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.LayoutEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_LayoutEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.LayoutEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.LayoutEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.LayoutEventHandler");
