...
package MSSyst.Globalization.HebrewCalendar is
   ...
   HebrewEra : Integer;
   pragma Import(MSIL,HebrewEra,"HebrewEra");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_HebrewCalendar(
...
private
   ...
   pragma MSIL_Constructor(new_HebrewCalendar);
...
end MSSyst.Globalization.HebrewCalendar;
pragma Import(MSIL,MSSyst.Globalization.HebrewCalendar,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.HebrewCalendar");
