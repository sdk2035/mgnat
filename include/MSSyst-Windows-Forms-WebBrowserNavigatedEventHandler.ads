...
limited with MSSyst.Windows.Forms.WebBrowserNavigatedEventArgs;
package MSSyst.Windows.Forms.WebBrowserNavigatedEventHandler is
   ...
   function new_WebBrowserNavigatedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.WebBrowserNavigatedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_WebBrowserNavigatedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.WebBrowserNavigatedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.WebBrowserNavigatedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.WebBrowserNavigatedEventHandler");
