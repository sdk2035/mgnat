...
limited with MSSyst.Windows.Forms.LabelEditEventArgs;
package MSSyst.Windows.Forms.LabelEditEventHandler is
   ...
   function new_LabelEditEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.LabelEditEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_LabelEditEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.LabelEditEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.LabelEditEventHandler,
