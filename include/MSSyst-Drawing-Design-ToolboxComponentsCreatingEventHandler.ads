...
limited with MSSyst.Drawing.Design.ToolboxComponentsCreatingEventArgs;
...
package MSSyst.Drawing.Design.ToolboxComponentsCreatingEventHandler is
   ...
   function new_ToolboxComponentsCreatingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Drawing.Design.ToolboxComponentsCreatingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ToolboxComponentsCreatingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Drawing.Design.ToolboxComponentsCreatingEventHandler;
pragma Import(MSIL,MSSyst.Drawing.Design.ToolboxComponentsCreatingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b0 3f 5f 7f 11 d5 0a 3a )",
   "[System.Drawing]System.Drawing.Design.ToolboxComponentsCreatingEventHandler");
