...
limited with MSSyst.Windows.Forms.PopupEventArgs;
package MSSyst.Windows.Forms.PopupEventHandler is
   ...
   function new_PopupEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.PopupEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_PopupEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.PopupEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.PopupEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.PopupEventHandler");
