...
limited with MSSyst.Windows.Forms.ToolBarButtonClickEventArgs;
package MSSyst.Windows.Forms.ToolBarButtonClickEventHandler is
   ...
   function new_ToolBarButtonClickEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ToolBarButtonClickEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ToolBarButtonClickEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolBarButtonClickEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolBarButtonClickEventHandler,
