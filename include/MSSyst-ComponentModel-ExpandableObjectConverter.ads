...
package MSSyst.ComponentModel.ExpandableObjectConverter is
   ...
   function new_ExpandableObjectConverter(
...
private
   ...
   pragma MSIL_Constructor(new_ExpandableObjectConverter);
   pragma Import(MSIL,GetProperties,"GetProperties");
   pragma Import(MSIL,GetPropertiesSupported,"GetPropertiesSupported");
end MSSyst.ComponentModel.ExpandableObjectConverter;
pragma Import(MSIL,MSSyst.ComponentModel.ExpandableObjectConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.ExpandableObjectConverter");
