...
limited with MSSyst.ComponentModel.Design.ComponentEventArgs;
...
package MSSyst.ComponentModel.Design.ComponentEventHandler is
   ...
   function new_ComponentEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.Design.ComponentEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ComponentEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.Design.ComponentEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.Design.ComponentEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.Design.ComponentEventHandler");
