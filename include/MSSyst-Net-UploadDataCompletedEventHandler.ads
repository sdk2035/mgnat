...
limited with MSSyst.Net.UploadDataCompletedEventArgs;
...
package MSSyst.Net.UploadDataCompletedEventHandler is
   ...
   function new_UploadDataCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.UploadDataCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UploadDataCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.UploadDataCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.UploadDataCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.UploadDataCompletedEventHandler");
