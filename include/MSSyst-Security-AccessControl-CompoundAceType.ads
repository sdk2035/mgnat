...
package MSSyst.Security.AccessControl.CompoundAceType is
   type ValueType is (
      Impersonation);
...
end MSSyst.Security.AccessControl.CompoundAceType;
pragma Import(MSIL,MSSyst.Security.AccessControl.CompoundAceType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.CompoundAceType");
