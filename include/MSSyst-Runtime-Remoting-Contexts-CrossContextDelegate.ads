...
package MSSyst.Runtime.Remoting.Contexts.CrossContextDelegate is
   ...
   function new_CrossContextDelegate(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_CrossContextDelegate);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Runtime.Remoting.Contexts.CrossContextDelegate;
pragma Import(MSIL,MSSyst.Runtime.Remoting.Contexts.CrossContextDelegate,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Remoting.Contexts.CrossContextDelegate");
