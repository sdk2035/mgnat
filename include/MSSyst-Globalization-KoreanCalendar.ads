...
package MSSyst.Globalization.KoreanCalendar is
   ...
   KoreanEra : Integer;
   pragma Import(MSIL,KoreanEra,"KoreanEra");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_KoreanCalendar(
...
private
   ...
   pragma MSIL_Constructor(new_KoreanCalendar);
...
end MSSyst.Globalization.KoreanCalendar;
pragma Import(MSIL,MSSyst.Globalization.KoreanCalendar,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.KoreanCalendar");
