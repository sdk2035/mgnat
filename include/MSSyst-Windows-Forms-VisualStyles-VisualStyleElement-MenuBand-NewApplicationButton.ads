...
with MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.MenuBand;
package MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.MenuBand.NewApplicationButton is
   ...
   function get_Checked return access MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.Typ'Class;
   ...
   function get_HotChecked return access MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.Typ'Class;
...
private
   ...
   pragma Import(MSIL,get_HotChecked,"get_HotChecked");
   pragma Import(MSIL,get_Normal,"get_Normal");
   pragma Import(MSIL,get_Pressed,"get_Pressed");
end MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.MenuBand.NewApplicationButton;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.MenuBand.NewApplicationButton,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.VisualStyleElement/MenuBand/NewApplicationButton");
