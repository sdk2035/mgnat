...
package MSSyst.ComponentModel.UInt64Converter is
   ...
   function new_UInt64Converter(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_UInt64Converter);
end MSSyst.ComponentModel.UInt64Converter;
pragma Import(MSIL,MSSyst.ComponentModel.UInt64Converter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.UInt64Converter");
