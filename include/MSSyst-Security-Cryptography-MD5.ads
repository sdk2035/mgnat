...
package MSSyst.Security.Cryptography.MD5 is
   ...
   function Create return access MSSyst.Security.Cryptography.MD5.Typ'Class;
   function Create(
      algName : access MSSyst.String.Typ'Class) return access MSSyst.Security.Cryptography.MD5.Typ'Class;
private
   pragma Convention(MSIL,Typ);
   pragma Import(MSIL,Create,"Create");
end MSSyst.Security.Cryptography.MD5;
pragma Import(MSIL,MSSyst.Security.Cryptography.MD5,
