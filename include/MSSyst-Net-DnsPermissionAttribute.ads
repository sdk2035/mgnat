...
package MSSyst.Net.DnsPermissionAttribute is
   ...
   function new_DnsPermissionAttribute(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_DnsPermissionAttribute);
   pragma Import(MSIL,CreatePermission,"CreatePermission");
end MSSyst.Net.DnsPermissionAttribute;
pragma Import(MSIL,MSSyst.Net.DnsPermissionAttribute,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.DnsPermissionAttribute");
