...
limited with MSSyst.Windows.Forms.DataGridViewRowErrorTextNeededEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowErrorTextNeededEventHandler is
   ...
   function new_DataGridViewRowErrorTextNeededEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowErrorTextNeededEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowErrorTextNeededEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowErrorTextNeededEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowErrorTextNeededEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowErrorTextNeededEventHandler");
