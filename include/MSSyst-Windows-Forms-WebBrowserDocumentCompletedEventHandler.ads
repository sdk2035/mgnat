...
limited with MSSyst.Windows.Forms.WebBrowserDocumentCompletedEventArgs;
package MSSyst.Windows.Forms.WebBrowserDocumentCompletedEventHandler is
   ...
   function new_WebBrowserDocumentCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.WebBrowserDocumentCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_WebBrowserDocumentCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.WebBrowserDocumentCompletedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.WebBrowserDocumentCompletedEventHandler,
