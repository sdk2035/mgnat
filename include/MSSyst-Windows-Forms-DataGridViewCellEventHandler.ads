...
limited with MSSyst.Windows.Forms.DataGridViewCellEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellEventHandler is
   ...
   function new_DataGridViewCellEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellEventHandler,
