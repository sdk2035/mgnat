...
package MSSyst.Windows.Forms.MenuGlyph is
   type ValueType is (
      Min,
      Checkmark,
      Max);
   ...
   Arrow : constant Valuetype := Min;
   Bullet : constant Valuetype := Max;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.Windows.Forms.MenuGlyph;
pragma Import(MSIL,MSSyst.Windows.Forms.MenuGlyph,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.MenuGlyph");
