...
package MSSyst.Security.Cryptography.SHA1CryptoServiceProvider is
   ...
   function new_SHA1CryptoServiceProvider(
      This : Ref := null) return Ref;
   procedure Initialize(
      This : access Typ);
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_SHA1CryptoServiceProvider);
   pragma Import(MSIL,Initialize,"Initialize");
end MSSyst.Security.Cryptography.SHA1CryptoServiceProvider;
pragma Import(MSIL,MSSyst.Security.Cryptography.SHA1CryptoServiceProvider,
