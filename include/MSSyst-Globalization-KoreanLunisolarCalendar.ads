...
package MSSyst.Globalization.KoreanLunisolarCalendar is
   type Typ is new MSSyst.Globalization.EastAsianLunisolarCalendar.Typ
         and MSSyst.ICloneable.Typ
   with record
      null;
   end record;
   GregorianEra : Integer;
   pragma Import(MSIL,GregorianEra,"GregorianEra");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_KoreanLunisolarCalendar(
...
private
   ...
   pragma MSIL_Constructor(new_KoreanLunisolarCalendar);
...
end MSSyst.Globalization.KoreanLunisolarCalendar;
pragma Import(MSIL,MSSyst.Globalization.KoreanLunisolarCalendar,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.KoreanLunisolarCalendar");
