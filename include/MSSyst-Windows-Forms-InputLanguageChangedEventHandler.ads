...
limited with MSSyst.Windows.Forms.InputLanguageChangedEventArgs;
package MSSyst.Windows.Forms.InputLanguageChangedEventHandler is
   ...
   function new_InputLanguageChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.InputLanguageChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_InputLanguageChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.InputLanguageChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.InputLanguageChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.InputLanguageChangedEventHandler");
