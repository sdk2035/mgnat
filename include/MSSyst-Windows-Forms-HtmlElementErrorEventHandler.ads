...
limited with MSSyst.Windows.Forms.HtmlElementErrorEventArgs;
package MSSyst.Windows.Forms.HtmlElementErrorEventHandler is
   ...
   function new_HtmlElementErrorEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.HtmlElementErrorEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_HtmlElementErrorEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.HtmlElementErrorEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.HtmlElementErrorEventHandler,
