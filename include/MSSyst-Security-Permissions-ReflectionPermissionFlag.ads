...
package MSSyst.Security.Permissions.ReflectionPermissionFlag is
   type ValueType is (
      NoFlags,
      TypeInformation,
      MemberAccess,
...
end MSSyst.Security.Permissions.ReflectionPermissionFlag;
pragma Import(MSIL,MSSyst.Security.Permissions.ReflectionPermissionFlag,
