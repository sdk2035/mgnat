...
limited with MSSyst.Windows.Forms.DataGridViewRowDividerDoubleClickEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowDividerDoubleClickEventHandler is
   ...
   function new_DataGridViewRowDividerDoubleClickEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowDividerDoubleClickEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowDividerDoubleClickEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowDividerDoubleClickEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowDividerDoubleClickEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowDividerDoubleClickEventHandler");
