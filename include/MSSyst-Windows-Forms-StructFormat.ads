...
package MSSyst.Windows.Forms.StructFormat is
   type ValueType is (
      Ansi,
      Unicode,
      Auto);
...
end MSSyst.Windows.Forms.StructFormat;
pragma Import(MSIL,MSSyst.Windows.Forms.StructFormat,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.StructFormat");
