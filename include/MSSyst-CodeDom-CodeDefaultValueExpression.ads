...
package MSSyst.CodeDom.CodeDefaultValueExpression is
   ...
   function new_CodeDefaultValueExpression(
...
private
   ...
   pragma MSIL_Constructor(new_CodeDefaultValueExpression);
   pragma Import(MSIL,get_Type,"get_Type");
   pragma Import(MSIL,set_Type,"set_Type");
end MSSyst.CodeDom.CodeDefaultValueExpression;
pragma Import(MSIL,MSSyst.CodeDom.CodeDefaultValueExpression,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.CodeDom.CodeDefaultValueExpression");
