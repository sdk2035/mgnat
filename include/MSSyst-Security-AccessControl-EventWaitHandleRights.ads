...
package MSSyst.Security.AccessControl.EventWaitHandleRights is
   type ValueType is (
      Modify,
      Delete,
      ReadPermissions,
...
end MSSyst.Security.AccessControl.EventWaitHandleRights;
pragma Import(MSIL,MSSyst.Security.AccessControl.EventWaitHandleRights,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.EventWaitHandleRights");
