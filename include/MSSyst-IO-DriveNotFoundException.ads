...
package MSSyst.IO.DriveNotFoundException is
   ...
   function new_DriveNotFoundException(
...
private
   ...
   pragma MSIL_Constructor(new_DriveNotFoundException);
end MSSyst.IO.DriveNotFoundException;
pragma Import(MSIL,MSSyst.IO.DriveNotFoundException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.IO.DriveNotFoundException");
