...
package MSSyst.Globalization.DigitShapes is
   type ValueType is (
      Context,
      None,
      NativeNational);
...
end MSSyst.Globalization.DigitShapes;
pragma Import(MSIL,MSSyst.Globalization.DigitShapes,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.DigitShapes");
