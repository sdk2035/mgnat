...
package MSSyst.Security.Principal.WindowsAccountType is
   type ValueType is (
      Normal,
      Guest,
      System,
...
end MSSyst.Security.Principal.WindowsAccountType;
pragma Import(MSIL,MSSyst.Security.Principal.WindowsAccountType,
