...
package MSSyst.ComponentModel.DesignerSerializationVisibility is
   type ValueType is (
      Hidden,
      Visible,
      Content);
...
end MSSyst.ComponentModel.DesignerSerializationVisibility;
pragma Import(MSIL,MSSyst.ComponentModel.DesignerSerializationVisibility,
