...
package MSSyst.Net.BindIPEndPoint is
   ...
   function new_BindIPEndPoint(
      This : Ref := null;
      object : access MSSyst.Object.Typ'Class;
      method : MSIL_Types.native_int) return Ref;
   function BeginInvoke(
      This : access Typ;
      servicePoint : access MSSyst.Net.ServicePoint.Typ'Class;
      remoteEndPoint : access MSSyst.Net.IPEndPoint.Typ'Class;
      retryCount : Integer;
   ...
   function EndInvoke(
      This : access Typ;
      result : access MSSyst.IAsyncResult.Typ'Class) return access MSSyst.Net.IPEndPoint.Typ'Class;
   function Invoke(
      This : access Typ;
      servicePoint : access MSSyst.Net.ServicePoint.Typ'Class;
      remoteEndPoint : access MSSyst.Net.IPEndPoint.Typ'Class;
      retryCount : Integer) return access MSSyst.Net.IPEndPoint.Typ'Class;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_BindIPEndPoint);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.BindIPEndPoint;
pragma Import(MSIL,MSSyst.Net.BindIPEndPoint,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.BindIPEndPoint");
