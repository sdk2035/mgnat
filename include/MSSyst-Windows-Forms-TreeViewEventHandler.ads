...
limited with MSSyst.Windows.Forms.TreeViewEventArgs;
package MSSyst.Windows.Forms.TreeViewEventHandler is
   ...
   function new_TreeViewEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.TreeViewEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_TreeViewEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.TreeViewEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.TreeViewEventHandler,
