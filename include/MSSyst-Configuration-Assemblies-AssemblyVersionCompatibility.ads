...
package MSSyst.Configuration.Assemblies.AssemblyVersionCompatibility is
   type ValueType is (
      SameMachine,
      SameProcess,
      SameDomain);
...
end MSSyst.Configuration.Assemblies.AssemblyVersionCompatibility;
pragma Import(MSIL,MSSyst.Configuration.Assemblies.AssemblyVersionCompatibility,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Configuration.Assemblies.AssemblyVersionCompatibility");
