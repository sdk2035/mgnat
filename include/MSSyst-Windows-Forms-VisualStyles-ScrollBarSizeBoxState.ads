...
package MSSyst.Windows.Forms.VisualStyles.ScrollBarSizeBoxState is
   type ValueType is (
      RightAlign,
      LeftAlign);
...
end MSSyst.Windows.Forms.VisualStyles.ScrollBarSizeBoxState;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.ScrollBarSizeBoxState,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.ScrollBarSizeBoxState");
