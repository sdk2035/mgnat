...
package MSSyst.Windows.Forms.ScrollButton is
   type ValueType is (
      Up,
      Down,
      Left,
   ...
   Min : constant Valuetype := Up;
   Right : constant Valuetype := Max;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.Windows.Forms.ScrollButton;
pragma Import(MSIL,MSSyst.Windows.Forms.ScrollButton,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ScrollButton");
