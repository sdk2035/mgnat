...
package MSSyst.Security.Permissions.SiteIdentityPermissionAttribute is
   ...
   function new_SiteIdentityPermissionAttribute(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_SiteIdentityPermissionAttribute);
...
end MSSyst.Security.Permissions.SiteIdentityPermissionAttribute;
pragma Import(MSIL,MSSyst.Security.Permissions.SiteIdentityPermissionAttribute,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.SiteIdentityPermissionAttribute");
