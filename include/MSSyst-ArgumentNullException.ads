...
package MSSyst.ArgumentNullException is
   ...
   function new_ArgumentNullException(
...
private
   ...
   pragma MSIL_Constructor(new_ArgumentNullException);
end MSSyst.ArgumentNullException;
pragma Import(MSIL,MSSyst.ArgumentNullException,
