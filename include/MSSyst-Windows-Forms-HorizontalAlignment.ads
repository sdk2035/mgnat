...
package MSSyst.Windows.Forms.HorizontalAlignment is
   type ValueType is (
      Left,
      Right,
      Center);
...
end MSSyst.Windows.Forms.HorizontalAlignment;
pragma Import(MSIL,MSSyst.Windows.Forms.HorizontalAlignment,
