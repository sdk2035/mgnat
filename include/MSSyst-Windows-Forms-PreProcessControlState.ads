...
package MSSyst.Windows.Forms.PreProcessControlState is
   type ValueType is (
      MessageProcessed,
      MessageNeeded,
      MessageNotNeeded);
...
end MSSyst.Windows.Forms.PreProcessControlState;
pragma Import(MSIL,MSSyst.Windows.Forms.PreProcessControlState,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.PreProcessControlState");
