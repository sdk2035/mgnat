...
package MSSyst.IO.IsolatedStorage.IsolatedStorageScope is
   type ValueType is (
      None,
      User,
      Domain,
...
end MSSyst.IO.IsolatedStorage.IsolatedStorageScope;
pragma Import(MSIL,MSSyst.IO.IsolatedStorage.IsolatedStorageScope,
