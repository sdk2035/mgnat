...
package MSSyst.Globalization.HijriCalendar is
   ...
   HijriEra : Integer;
   pragma Import(MSIL,HijriEra,"HijriEra");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_HijriCalendar(
...
private
   ...
   pragma MSIL_Constructor(new_HijriCalendar);
   ...
   pragma Import(MSIL,get_HijriAdjustment,"get_HijriAdjustment");
   ...
   pragma Import(MSIL,set_HijriAdjustment,"set_HijriAdjustment");
...
end MSSyst.Globalization.HijriCalendar;
pragma Import(MSIL,MSSyst.Globalization.HijriCalendar,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.HijriCalendar");
