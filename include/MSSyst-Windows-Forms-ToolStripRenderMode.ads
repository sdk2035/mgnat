...
package MSSyst.Windows.Forms.ToolStripRenderMode is
   type ValueType is (
      Custom,
      System,
      Professional,
...
end MSSyst.Windows.Forms.ToolStripRenderMode;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripRenderMode,
