...
limited with MSSyst.Security.AccessControl.RegistryAccessRule;
limited with MSSyst.Security.AccessControl.RegistryAuditRule;
limited with MSSyst.Security.Principal.IdentityReference;
limited with MSSyst.String;
limited with MSSyst.Type_k;
package MSSyst.Security.AccessControl.RegistrySecurity is
   ...
   procedure AddAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.RegistryAccessRule.Typ'Class);
   procedure AddAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.RegistryAuditRule.Typ'Class);
   ...
   function RemoveAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.RegistryAccessRule.Typ'Class) return Standard.Boolean;
   ...
   function RemoveAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.RegistryAuditRule.Typ'Class) return Standard.Boolean;
...
private
   ...
   pragma MSIL_Constructor(new_RegistrySecurity);
...
end MSSyst.Security.AccessControl.RegistrySecurity;
pragma Import(MSIL,MSSyst.Security.AccessControl.RegistrySecurity,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.RegistrySecurity");
