...
package MSSyst.IO.WatcherChangeTypes is
   type ValueType is (
      Created,
      Deleted,
      Changed,
...
end MSSyst.IO.WatcherChangeTypes;
pragma Import(MSIL,MSSyst.IO.WatcherChangeTypes,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.IO.WatcherChangeTypes");
