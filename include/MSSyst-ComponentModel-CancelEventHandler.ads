...
package MSSyst.ComponentModel.CancelEventHandler is
   ...
   function new_CancelEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_CancelEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.CancelEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.CancelEventHandler,
