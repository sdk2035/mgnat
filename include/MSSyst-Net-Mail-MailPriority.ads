...
package MSSyst.Net.Mail.MailPriority is
   type ValueType is (
      Normal,
      Low,
      High);
...
end MSSyst.Net.Mail.MailPriority;
pragma Import(MSIL,MSSyst.Net.Mail.MailPriority,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.Mail.MailPriority");
