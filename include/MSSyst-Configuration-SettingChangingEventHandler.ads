...
limited with MSSyst.Configuration.SettingChangingEventArgs;
...
package MSSyst.Configuration.SettingChangingEventHandler is
   ...
   function new_SettingChangingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Configuration.SettingChangingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SettingChangingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Configuration.SettingChangingEventHandler;
pragma Import(MSIL,MSSyst.Configuration.SettingChangingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Configuration.SettingChangingEventHandler");
