...
package MSSyst.Windows.Forms.ToolStripGripRenderEventHandler is
   ...
   function new_ToolStripGripRenderEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_ToolStripGripRenderEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolStripGripRenderEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripGripRenderEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripGripRenderEventHandler");
