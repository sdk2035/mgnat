...
package MSSyst.Windows.Forms.Appearance is
   type ValueType is (
      Normal,
      Button);
...
end MSSyst.Windows.Forms.Appearance;
pragma Import(MSIL,MSSyst.Windows.Forms.Appearance,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.Appearance");
