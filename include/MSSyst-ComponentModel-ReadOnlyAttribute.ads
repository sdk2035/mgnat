...
package MSSyst.ComponentModel.ReadOnlyAttribute is
   type Typ is new MSSyst.Attribute.Typ
         and MSSyst.Runtime.InteropServices.uAttribute.Typ
   with record
      null;
   end record;
   Yes : access MSSyst.ComponentModel.ReadOnlyAttribute.Typ'Class;
   pragma Import(MSIL,Yes,"Yes");
   No : access MSSyst.ComponentModel.ReadOnlyAttribute.Typ'Class;
   pragma Import(MSIL,No,"No");
   Default : access MSSyst.ComponentModel.ReadOnlyAttribute.Typ'Class;
   ...
   function new_ReadOnlyAttribute(
      This : Ref := null;
      isReadOnly : Standard.Boolean) return Ref;
   function Equals(
      This : access Typ;
...
private
   ...
   pragma MSIL_Constructor(new_ReadOnlyAttribute);
   pragma Import(MSIL,Equals,"Equals");
   pragma Import(MSIL,get_IsReadOnly,"get_IsReadOnly");
   pragma Import(MSIL,GetHashCode,"GetHashCode");
   pragma Import(MSIL,IsDefaultAttribute,"IsDefaultAttribute");
end MSSyst.ComponentModel.ReadOnlyAttribute;
pragma Import(MSIL,MSSyst.ComponentModel.ReadOnlyAttribute,
