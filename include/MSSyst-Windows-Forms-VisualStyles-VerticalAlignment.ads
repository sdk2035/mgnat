...
package MSSyst.Windows.Forms.VisualStyles.VerticalAlignment is
   type ValueType is (
      Top,
      Center,
      Bottom);
...
end MSSyst.Windows.Forms.VisualStyles.VerticalAlignment;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.VerticalAlignment,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.VerticalAlignment");
