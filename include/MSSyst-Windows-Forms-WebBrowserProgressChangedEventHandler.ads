...
limited with MSSyst.Windows.Forms.WebBrowserProgressChangedEventArgs;
package MSSyst.Windows.Forms.WebBrowserProgressChangedEventHandler is
   ...
   function new_WebBrowserProgressChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.WebBrowserProgressChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_WebBrowserProgressChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.WebBrowserProgressChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.WebBrowserProgressChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.WebBrowserProgressChangedEventHandler");
