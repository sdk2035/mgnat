...
package MSSyst.Windows.Forms.DataSourceUpdateMode is
   type ValueType is (
      OnValidation,
      OnPropertyChanged,
      Never);
...
end MSSyst.Windows.Forms.DataSourceUpdateMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataSourceUpdateMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataSourceUpdateMode");
