...
package MSSyst.Windows.Forms.ToolBarButtonStyle is
   type ValueType is (
      PushButton,
      ToggleButton,
      Separator,
...
end MSSyst.Windows.Forms.ToolBarButtonStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolBarButtonStyle,
