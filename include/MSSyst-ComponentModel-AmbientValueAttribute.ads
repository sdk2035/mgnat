...
package MSSyst.ComponentModel.AmbientValueAttribute is
   ...
   function new_AmbientValueAttribute(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_AmbientValueAttribute);
   pragma Import(MSIL,Equals,"Equals");
   pragma Import(MSIL,get_Value,"get_Value");
   pragma Import(MSIL,GetHashCode,"GetHashCode");
end MSSyst.ComponentModel.AmbientValueAttribute;
pragma Import(MSIL,MSSyst.ComponentModel.AmbientValueAttribute,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.AmbientValueAttribute");
