...
with MSSyst.Windows.Forms.ToolTip;
with MSSyst.Windows.Forms.ToolTip.TipInfo;
package MSSyst.Windows.Forms.ToolTip.TipInfo.Type_k is
   type ValueType is (
      None,
      Auto,
      Absolute,
...
end MSSyst.Windows.Forms.ToolTip.TipInfo.Type_k;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolTip.TipInfo.Type_k,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolTip/TipInfo/Type");
