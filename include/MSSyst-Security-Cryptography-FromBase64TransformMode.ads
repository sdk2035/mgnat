...
package MSSyst.Security.Cryptography.FromBase64TransformMode is
   type ValueType is (
      IgnoreWhiteSpaces,
...
end MSSyst.Security.Cryptography.FromBase64TransformMode;
pragma Import(MSIL,MSSyst.Security.Cryptography.FromBase64TransformMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Cryptography.FromBase64TransformMode");
