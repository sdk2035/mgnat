...
package MSSyst.Collections.Generic_k.Dictionary.Enumerator is
...
end MSSyst.Collections.Generic_k.Dictionary.Enumerator;
pragma Import(MSIL,MSSyst.Collections.Generic_k.Dictionary.Enumerator,
