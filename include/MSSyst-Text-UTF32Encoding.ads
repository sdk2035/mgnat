...
package MSSyst.Text.UTF32Encoding is
   ...
   function new_UTF32Encoding(
      ...
      throwOnInvalidCharacters : Standard.Boolean) return Ref;
   function Equals(
      This : access Typ;
...
private
   ...
   pragma MSIL_Constructor(new_UTF32Encoding);
...
end MSSyst.Text.UTF32Encoding;
pragma Import(MSIL,MSSyst.Text.UTF32Encoding,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Text.UTF32Encoding");
