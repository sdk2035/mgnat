...
limited with MSSyst.Windows.Forms.DateBoldEventArgs;
package MSSyst.Windows.Forms.DateBoldEventHandler is
   ...
   function new_DateBoldEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DateBoldEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DateBoldEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DateBoldEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DateBoldEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DateBoldEventHandler");
