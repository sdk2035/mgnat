...
package MSSyst.CannotUnloadAppDomainException is
   ...
   function new_CannotUnloadAppDomainException(
...
private
   ...
   pragma MSIL_Constructor(new_CannotUnloadAppDomainException);
end MSSyst.CannotUnloadAppDomainException;
pragma Import(MSIL,MSSyst.CannotUnloadAppDomainException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.CannotUnloadAppDomainException");
