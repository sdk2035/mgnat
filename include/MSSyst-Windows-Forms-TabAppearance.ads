...
package MSSyst.Windows.Forms.TabAppearance is
   type ValueType is (
      Normal,
      Buttons,
      FlatButtons);
...
end MSSyst.Windows.Forms.TabAppearance;
pragma Import(MSIL,MSSyst.Windows.Forms.TabAppearance,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TabAppearance");
