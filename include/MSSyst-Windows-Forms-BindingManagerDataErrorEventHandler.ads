...
limited with MSSyst.Windows.Forms.BindingManagerDataErrorEventArgs;
package MSSyst.Windows.Forms.BindingManagerDataErrorEventHandler is
   ...
   function new_BindingManagerDataErrorEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.BindingManagerDataErrorEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_BindingManagerDataErrorEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.BindingManagerDataErrorEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.BindingManagerDataErrorEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.BindingManagerDataErrorEventHandler");
