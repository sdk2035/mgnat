...
limited with MSSyst.Windows.Forms.GiveFeedbackEventArgs;
package MSSyst.Windows.Forms.GiveFeedbackEventHandler is
   ...
   function new_GiveFeedbackEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.GiveFeedbackEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_GiveFeedbackEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.GiveFeedbackEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.GiveFeedbackEventHandler,
