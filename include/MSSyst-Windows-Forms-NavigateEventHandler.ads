...
limited with MSSyst.Windows.Forms.NavigateEventArgs;
package MSSyst.Windows.Forms.NavigateEventHandler is
   ...
   function new_NavigateEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      ne : access MSSyst.Windows.Forms.NavigateEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_NavigateEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.NavigateEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.NavigateEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NavigateEventHandler");
