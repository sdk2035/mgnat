...
package MSSyst.Windows.Forms.VisualStyles.BorderType is
   type ValueType is (
      Rectangle,
      RoundedRectangle,
      Ellipse);
...
end MSSyst.Windows.Forms.VisualStyles.BorderType;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.BorderType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.BorderType");
