...
package MSSyst.Security.Permissions.PermissionState is
   type ValueType is (
      None,
      Unrestricted);
...
end MSSyst.Security.Permissions.PermissionState;
pragma Import(MSIL,MSSyst.Security.Permissions.PermissionState,
