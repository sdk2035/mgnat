...
package MSSyst.Windows.Forms.VisualStyles.ImageSelectType is
   type ValueType is (
      None,
      Size,
      Dpi);
...
end MSSyst.Windows.Forms.VisualStyles.ImageSelectType;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.ImageSelectType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.ImageSelectType");
