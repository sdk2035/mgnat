...
with MSIL_Types;
use MSIL_Types;
limited with MSSyst.AssemblyLoadEventArgs;
...
package MSSyst.AssemblyLoadEventHandler is
   ...
   function new_AssemblyLoadEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      args : access MSSyst.AssemblyLoadEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_AssemblyLoadEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.AssemblyLoadEventHandler;
pragma Import(MSIL,MSSyst.AssemblyLoadEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.AssemblyLoadEventHandler");
