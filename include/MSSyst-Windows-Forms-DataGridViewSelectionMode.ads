...
package MSSyst.Windows.Forms.DataGridViewSelectionMode is
   type ValueType is (
      CellSelect,
      FullRowSelect,
      FullColumnSelect,
...
end MSSyst.Windows.Forms.DataGridViewSelectionMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewSelectionMode,
