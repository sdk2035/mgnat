...
package MSSyst.Windows.Forms.TreeViewDrawMode is
   type ValueType is (
      Normal,
      OwnerDrawText,
      OwnerDrawAll);
...
end MSSyst.Windows.Forms.TreeViewDrawMode;
pragma Import(MSIL,MSSyst.Windows.Forms.TreeViewDrawMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TreeViewDrawMode");
