...
limited with MSSyst.Windows.Forms.DataGridViewCellToolTipTextNeededEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellToolTipTextNeededEventHandler is
   ...
   function new_DataGridViewCellToolTipTextNeededEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellToolTipTextNeededEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellToolTipTextNeededEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellToolTipTextNeededEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellToolTipTextNeededEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellToolTipTextNeededEventHandler");
