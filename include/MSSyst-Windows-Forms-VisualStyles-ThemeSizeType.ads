...
package MSSyst.Windows.Forms.VisualStyles.ThemeSizeType is
   type ValueType is (
      Minimum,
      True,
      Draw);
...
end MSSyst.Windows.Forms.VisualStyles.ThemeSizeType;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.ThemeSizeType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.ThemeSizeType");
