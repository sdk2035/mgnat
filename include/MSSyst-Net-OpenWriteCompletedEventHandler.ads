...
limited with MSSyst.Net.OpenWriteCompletedEventArgs;
...
package MSSyst.Net.OpenWriteCompletedEventHandler is
   ...
   function new_OpenWriteCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.OpenWriteCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_OpenWriteCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.OpenWriteCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.OpenWriteCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.OpenWriteCompletedEventHandler");
