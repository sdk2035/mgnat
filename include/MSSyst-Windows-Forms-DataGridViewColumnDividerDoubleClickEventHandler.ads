...
limited with MSSyst.Windows.Forms.DataGridViewColumnDividerDoubleClickEventArgs;
package MSSyst.Windows.Forms.DataGridViewColumnDividerDoubleClickEventHandler is
   ...
   function new_DataGridViewColumnDividerDoubleClickEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewColumnDividerDoubleClickEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewColumnDividerDoubleClickEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewColumnDividerDoubleClickEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewColumnDividerDoubleClickEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewColumnDividerDoubleClickEventHandler");
