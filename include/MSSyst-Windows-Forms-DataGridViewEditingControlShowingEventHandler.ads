...
limited with MSSyst.Windows.Forms.DataGridViewEditingControlShowingEventArgs;
package MSSyst.Windows.Forms.DataGridViewEditingControlShowingEventHandler is
   ...
   function new_DataGridViewEditingControlShowingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewEditingControlShowingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewEditingControlShowingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewEditingControlShowingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewEditingControlShowingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewEditingControlShowingEventHandler");
