...
package MSSyst.Windows.Forms.ImageIndexConverter is
   type Typ is new MSSyst.ComponentModel.Int32Converter.Typ   with record
      null;
   end record;
   ...
   function new_ImageIndexConverter(
...
private
   ...
   pragma MSIL_Constructor(new_ImageIndexConverter);
...
end MSSyst.Windows.Forms.ImageIndexConverter;
pragma Import(MSIL,MSSyst.Windows.Forms.ImageIndexConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ImageIndexConverter");
