...
package MSSyst.NullReferenceException is
   ...
   function new_NullReferenceException(
...
private
   ...
   pragma MSIL_Constructor(new_NullReferenceException);
end MSSyst.NullReferenceException;
pragma Import(MSIL,MSSyst.NullReferenceException,
