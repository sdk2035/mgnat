...
package MSSyst.Threading.ContextCallback is
...
private
   ...
   pragma MSIL_Constructor(new_ContextCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.ContextCallback;
pragma Import(MSIL,MSSyst.Threading.ContextCallback,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Threading.ContextCallback");
