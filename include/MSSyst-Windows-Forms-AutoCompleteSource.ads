...
package MSSyst.Windows.Forms.AutoCompleteSource is
   type ValueType is (
      FileSystem,
      HistoryList,
      RecentlyUsedList,
...
end MSSyst.Windows.Forms.AutoCompleteSource;
pragma Import(MSIL,MSSyst.Windows.Forms.AutoCompleteSource,
