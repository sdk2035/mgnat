...
package MSSyst.Deployment.Internal.Isolation.ApplicationContext.ApplicationState is
   type ValueType is (
      Undefined,
      Starting,
      Running);
...
end MSSyst.Deployment.Internal.Isolation.ApplicationContext.ApplicationState;
pragma Import(MSIL,MSSyst.Deployment.Internal.Isolation.ApplicationContext.ApplicationState,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Deployment.Internal.Isolation.ApplicationContext/ApplicationState");
