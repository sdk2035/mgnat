...
package MSSyst.Windows.Forms.AxHost.AboutBoxDelegate is
...
private
   ...
   pragma MSIL_Constructor(new_AboutBoxDelegate);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.AxHost.AboutBoxDelegate;
pragma Import(MSIL,MSSyst.Windows.Forms.AxHost.AboutBoxDelegate,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.AxHost/AboutBoxDelegate");
