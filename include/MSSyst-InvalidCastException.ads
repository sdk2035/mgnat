...
package MSSyst.InvalidCastException is
   ...
   function new_InvalidCastException(
...
private
   ...
   pragma MSIL_Constructor(new_InvalidCastException);
end MSSyst.InvalidCastException;
pragma Import(MSIL,MSSyst.InvalidCastException,
