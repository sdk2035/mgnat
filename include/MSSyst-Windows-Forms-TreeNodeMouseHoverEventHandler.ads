...
limited with MSSyst.Windows.Forms.TreeNodeMouseHoverEventArgs;
package MSSyst.Windows.Forms.TreeNodeMouseHoverEventHandler is
   ...
   function new_TreeNodeMouseHoverEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.TreeNodeMouseHoverEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_TreeNodeMouseHoverEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.TreeNodeMouseHoverEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.TreeNodeMouseHoverEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TreeNodeMouseHoverEventHandler");
