...
limited with MSSyst.Windows.Forms.DataGridViewRowStateChangedEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowStateChangedEventHandler is
   ...
   function new_DataGridViewRowStateChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowStateChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowStateChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowStateChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowStateChangedEventHandler,
