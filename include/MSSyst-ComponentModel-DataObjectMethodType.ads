...
package MSSyst.ComponentModel.DataObjectMethodType is
   type ValueType is (
      Fill,
      Select_k,
      Update,
...
end MSSyst.ComponentModel.DataObjectMethodType;
pragma Import(MSIL,MSSyst.ComponentModel.DataObjectMethodType,
