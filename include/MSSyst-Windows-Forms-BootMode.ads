...
package MSSyst.Windows.Forms.BootMode is
   type ValueType is (
      Normal,
      FailSafe,
      FailSafeWithNetwork);
...
end MSSyst.Windows.Forms.BootMode;
pragma Import(MSIL,MSSyst.Windows.Forms.BootMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.BootMode");
