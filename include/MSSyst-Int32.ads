...
package MSSyst.Int32 is
   ...
   function Equals(
      This : Valuetype;
      obj : Integer) return Standard.Boolean;
   ...
   function Parse(
      ...
      style : MSSyst.Globalization.NumberStyles.Valuetype) return Integer;
   function Parse(
      s : access MSSyst.String.Typ'Class;
   ...
   function TryParse(
      ...
      result : MSIL_Types.Int32_addrof) return Standard.Boolean;
   function TryParse(
      s : access MSSyst.String.Typ'Class;
      result : MSIL_Types.Int32_addrof) return Standard.Boolean;
private
...
pragma Import(MSIL,MSSyst.Int32,
