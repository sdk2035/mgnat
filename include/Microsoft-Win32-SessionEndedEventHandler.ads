...
with MSIL_Types;
use MSIL_Types;
limited with Microsoft.Win32.SessionEndedEventArgs;
...
package Microsoft.Win32.SessionEndedEventHandler is
   ...
   function new_SessionEndedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access Microsoft.Win32.SessionEndedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SessionEndedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end Microsoft.Win32.SessionEndedEventHandler;
pragma Import(MSIL,Microsoft.Win32.SessionEndedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]Microsoft.Win32.SessionEndedEventHandler");
