...
limited with MSSyst.Windows.Forms.ToolStripDropDownClosingEventArgs;
package MSSyst.Windows.Forms.ToolStripDropDownClosingEventHandler is
   ...
   function new_ToolStripDropDownClosingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ToolStripDropDownClosingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ToolStripDropDownClosingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolStripDropDownClosingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripDropDownClosingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripDropDownClosingEventHandler");
