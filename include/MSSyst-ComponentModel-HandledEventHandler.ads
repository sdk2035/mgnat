...
limited with MSSyst.ComponentModel.HandledEventArgs;
...
package MSSyst.ComponentModel.HandledEventHandler is
   ...
   function new_HandledEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.HandledEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_HandledEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.HandledEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.HandledEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.HandledEventHandler");
