...
package MSSyst.LoaderOptimization is
   type ValueType is (
      NotSpecified,
      SingleDomain,
      MultiDomain,
   ...
   MultiDomainHost : constant Valuetype := DomainMask;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.LoaderOptimization;
pragma Import(MSIL,MSSyst.LoaderOptimization,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.LoaderOptimization");
