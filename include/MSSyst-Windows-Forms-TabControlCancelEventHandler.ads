...
limited with MSSyst.Windows.Forms.TabControlCancelEventArgs;
package MSSyst.Windows.Forms.TabControlCancelEventHandler is
   ...
   function new_TabControlCancelEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.TabControlCancelEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_TabControlCancelEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.TabControlCancelEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.TabControlCancelEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TabControlCancelEventHandler");
