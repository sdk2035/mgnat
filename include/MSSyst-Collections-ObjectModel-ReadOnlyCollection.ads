...
generic
   type T is private;
package MSSyst.Collections.ObjectModel.ReadOnlyCollection is
   ...
   function IndexOf(
      This : access Typ;
      value : T) return Integer;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_ReadOnlyCollection);
...
end MSSyst.Collections.ObjectModel.ReadOnlyCollection;
pragma Import(MSIL,MSSyst.Collections.ObjectModel.ReadOnlyCollection,
