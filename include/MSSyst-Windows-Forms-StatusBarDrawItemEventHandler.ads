...
limited with MSSyst.Windows.Forms.StatusBarDrawItemEventArgs;
package MSSyst.Windows.Forms.StatusBarDrawItemEventHandler is
   ...
   function new_StatusBarDrawItemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      sbdevent : access MSSyst.Windows.Forms.StatusBarDrawItemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_StatusBarDrawItemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.StatusBarDrawItemEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.StatusBarDrawItemEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.StatusBarDrawItemEventHandler");
