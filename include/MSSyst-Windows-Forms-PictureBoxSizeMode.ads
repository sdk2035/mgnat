...
package MSSyst.Windows.Forms.PictureBoxSizeMode is
   type ValueType is (
      Normal,
      StretchImage,
      AutoSize,
...
end MSSyst.Windows.Forms.PictureBoxSizeMode;
pragma Import(MSIL,MSSyst.Windows.Forms.PictureBoxSizeMode,
