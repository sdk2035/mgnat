...
limited with MSSyst.IO.Ports.SerialPinChangedEventArgs;
...
package MSSyst.IO.Ports.SerialPinChangedEventHandler is
   ...
   function new_SerialPinChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.IO.Ports.SerialPinChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SerialPinChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.IO.Ports.SerialPinChangedEventHandler;
pragma Import(MSIL,MSSyst.IO.Ports.SerialPinChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.IO.Ports.SerialPinChangedEventHandler");
