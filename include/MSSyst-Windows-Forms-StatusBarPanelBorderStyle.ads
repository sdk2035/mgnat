...
package MSSyst.Windows.Forms.StatusBarPanelBorderStyle is
   type ValueType is (
      None,
      Raised,
      Sunken);
...
end MSSyst.Windows.Forms.StatusBarPanelBorderStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.StatusBarPanelBorderStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.StatusBarPanelBorderStyle");
