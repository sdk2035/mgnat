...
package MSSyst.Windows.Forms.BindingCompleteContext is
   type ValueType is (
      ControlUpdate,
      DataSourceUpdate);
...
end MSSyst.Windows.Forms.BindingCompleteContext;
pragma Import(MSIL,MSSyst.Windows.Forms.BindingCompleteContext,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.BindingCompleteContext");
