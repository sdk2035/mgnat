...
package MSSyst.RankException is
...
private
   ...
   pragma MSIL_Constructor(new_RankException);
end MSSyst.RankException;
pragma Import(MSIL,MSSyst.RankException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.RankException");
