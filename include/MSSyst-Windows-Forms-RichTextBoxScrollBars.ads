...
package MSSyst.Windows.Forms.RichTextBoxScrollBars is
   type ValueType is (
      None,
      Horizontal,
      Vertical,
...
end MSSyst.Windows.Forms.RichTextBoxScrollBars;
pragma Import(MSIL,MSSyst.Windows.Forms.RichTextBoxScrollBars,
