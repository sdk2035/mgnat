...
package MSSyst.Windows.Forms.ToolStripItemImageRenderEventHandler is
   ...
   function new_ToolStripItemImageRenderEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_ToolStripItemImageRenderEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolStripItemImageRenderEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripItemImageRenderEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripItemImageRenderEventHandler");
