...
package MSSyst.Security.Permissions.SecurityAction is
   type ValueType is (
      Demand,
      Assert,
      Deny,
...
end MSSyst.Security.Permissions.SecurityAction;
pragma Import(MSIL,MSSyst.Security.Permissions.SecurityAction,
