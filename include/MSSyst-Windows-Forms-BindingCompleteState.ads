...
package MSSyst.Windows.Forms.BindingCompleteState is
   type ValueType is (
      Success,
      DataError,
      Exception_k);
...
end MSSyst.Windows.Forms.BindingCompleteState;
pragma Import(MSIL,MSSyst.Windows.Forms.BindingCompleteState,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.BindingCompleteState");
