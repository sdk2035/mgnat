...
package MSSyst.ComponentModel.ListSortDirection is
   type ValueType is (
      Ascending,
      Descending);
...
end MSSyst.ComponentModel.ListSortDirection;
pragma Import(MSIL,MSSyst.ComponentModel.ListSortDirection,
