...
limited with MSSyst.Windows.Forms.ListViewItemSelectionChangedEventArgs;
package MSSyst.Windows.Forms.ListViewItemSelectionChangedEventHandler is
   ...
   function new_ListViewItemSelectionChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ListViewItemSelectionChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ListViewItemSelectionChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ListViewItemSelectionChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ListViewItemSelectionChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ListViewItemSelectionChangedEventHandler");
