...
limited with MSSyst.Windows.Forms.DrawListViewSubItemEventArgs;
package MSSyst.Windows.Forms.DrawListViewSubItemEventHandler is
   ...
   function new_DrawListViewSubItemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DrawListViewSubItemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DrawListViewSubItemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DrawListViewSubItemEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DrawListViewSubItemEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DrawListViewSubItemEventHandler");
