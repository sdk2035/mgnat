...
package MSSyst.Security.AccessControl.AccessControlActions is
   type ValueType is (
      None,
      View,
      Change);
...
end MSSyst.Security.AccessControl.AccessControlActions;
pragma Import(MSIL,MSSyst.Security.AccessControl.AccessControlActions,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.AccessControlActions");
