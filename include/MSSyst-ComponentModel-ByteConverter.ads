...
package MSSyst.ComponentModel.ByteConverter is
   ...
   function new_ByteConverter(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_ByteConverter);
end MSSyst.ComponentModel.ByteConverter;
pragma Import(MSIL,MSSyst.ComponentModel.ByteConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.ByteConverter");
