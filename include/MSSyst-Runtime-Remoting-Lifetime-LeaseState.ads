...
package MSSyst.Runtime.Remoting.Lifetime.LeaseState is
   type ValueType is (
      Null_k,
      Initial,
      Active,
...
end MSSyst.Runtime.Remoting.Lifetime.LeaseState;
pragma Import(MSIL,MSSyst.Runtime.Remoting.Lifetime.LeaseState,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Remoting.Lifetime.LeaseState");
