...
package MSSyst.CrossAppDomainDelegate is
   ...
   function new_CrossAppDomainDelegate(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_CrossAppDomainDelegate);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.CrossAppDomainDelegate;
pragma Import(MSIL,MSSyst.CrossAppDomainDelegate,
