...
limited with MSSyst.Windows.Forms.DataGridViewColumnStateChangedEventArgs;
package MSSyst.Windows.Forms.DataGridViewColumnStateChangedEventHandler is
   ...
   function new_DataGridViewColumnStateChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewColumnStateChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewColumnStateChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewColumnStateChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewColumnStateChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewColumnStateChangedEventHandler");
