...
package MSSyst.Windows.Forms.ToolStripGripDisplayStyle is
   type ValueType is (
      Horizontal,
      Vertical);
...
end MSSyst.Windows.Forms.ToolStripGripDisplayStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripGripDisplayStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripGripDisplayStyle");
