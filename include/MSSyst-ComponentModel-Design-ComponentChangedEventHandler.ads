...
limited with MSSyst.ComponentModel.Design.ComponentChangedEventArgs;
...
package MSSyst.ComponentModel.Design.ComponentChangedEventHandler is
   ...
   function new_ComponentChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.Design.ComponentChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ComponentChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.Design.ComponentChangedEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.Design.ComponentChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.Design.ComponentChangedEventHandler");
