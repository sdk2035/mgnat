...
limited with MSSyst.Windows.Forms.ColumnWidthChangingEventArgs;
package MSSyst.Windows.Forms.ColumnWidthChangingEventHandler is
   ...
   function new_ColumnWidthChangingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ColumnWidthChangingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ColumnWidthChangingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ColumnWidthChangingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ColumnWidthChangingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ColumnWidthChangingEventHandler");
