...
limited with MSSyst.Windows.Forms.DataGridViewCellParsingEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellParsingEventHandler is
   ...
   function new_DataGridViewCellParsingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellParsingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellParsingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellParsingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellParsingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellParsingEventHandler");
