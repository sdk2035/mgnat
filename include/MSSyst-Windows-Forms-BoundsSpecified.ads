...
package MSSyst.Windows.Forms.BoundsSpecified is
   type ValueType is (
      None,
      X,
      Y,
...
end MSSyst.Windows.Forms.BoundsSpecified;
pragma Import(MSIL,MSSyst.Windows.Forms.BoundsSpecified,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.BoundsSpecified");
