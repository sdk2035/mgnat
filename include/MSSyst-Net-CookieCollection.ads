...
package MSSyst.Net.CookieCollection is
   ...
   procedure CopyTo(
      This : access Typ;
      array_k : access MSSyst.Net.Cookie.Ref_arr;
      index : Integer);
   function get_Count(
   ...
   function get_Item(
      This : access Typ;
      name : access MSSyst.String.Typ'Class) return access MSSyst.Net.Cookie.Typ'Class;
   function get_Item(
      This : access Typ;
      index : Integer) return access MSSyst.Net.Cookie.Typ'Class;
