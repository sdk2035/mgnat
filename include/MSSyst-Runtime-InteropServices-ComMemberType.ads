...
package MSSyst.Runtime.InteropServices.ComMemberType is
   type ValueType is (
      Method,
      PropGet,
      PropSet);
...
end MSSyst.Runtime.InteropServices.ComMemberType;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.ComMemberType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.InteropServices.ComMemberType");
