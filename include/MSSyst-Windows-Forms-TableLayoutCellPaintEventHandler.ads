...
limited with MSSyst.Windows.Forms.TableLayoutCellPaintEventArgs;
package MSSyst.Windows.Forms.TableLayoutCellPaintEventHandler is
   ...
   function new_TableLayoutCellPaintEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.TableLayoutCellPaintEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_TableLayoutCellPaintEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.TableLayoutCellPaintEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.TableLayoutCellPaintEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TableLayoutCellPaintEventHandler");
