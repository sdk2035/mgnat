...
package MSSyst.Net.Security.AuthenticationLevel is
   type ValueType is (
      None,
      MutualAuthRequested,
      MutualAuthRequired);
...
end MSSyst.Net.Security.AuthenticationLevel;
pragma Import(MSIL,MSSyst.Net.Security.AuthenticationLevel,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.Security.AuthenticationLevel");
