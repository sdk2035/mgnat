...
with MSSyst.Windows.Forms.ImageKeyConverter;
package MSSyst.Windows.Forms.TreeViewImageKeyConverter is
   type Typ is new MSSyst.Windows.Forms.ImageKeyConverter.Typ   with record
      null;
   end record;
   ...
   function new_TreeViewImageKeyConverter(
...
private
   ...
   pragma MSIL_Constructor(new_TreeViewImageKeyConverter);
   pragma Import(MSIL,ConvertTo,"ConvertTo");
end MSSyst.Windows.Forms.TreeViewImageKeyConverter;
pragma Import(MSIL,MSSyst.Windows.Forms.TreeViewImageKeyConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TreeViewImageKeyConverter");
