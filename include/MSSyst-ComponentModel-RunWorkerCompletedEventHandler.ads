...
limited with MSSyst.ComponentModel.RunWorkerCompletedEventArgs;
...
package MSSyst.ComponentModel.RunWorkerCompletedEventHandler is
   ...
   function new_RunWorkerCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.RunWorkerCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_RunWorkerCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.RunWorkerCompletedEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.RunWorkerCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.RunWorkerCompletedEventHandler");
