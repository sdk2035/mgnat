...
package MSSyst.ArgumentOutOfRangeException is
   ...
   function new_ArgumentOutOfRangeException(
      This : Ref := null) return Ref;
   function new_ArgumentOutOfRangeException(
      This : Ref := null;
      paramName : access MSSyst.String.Typ'Class) return Ref;
   function new_ArgumentOutOfRangeException(
      This : Ref := null;
      paramName : access MSSyst.String.Typ'Class;
   ...
   function new_ArgumentOutOfRangeException(
      This : Ref := null;
      paramName : access MSSyst.String.Typ'Class;
      actualValue : access MSSyst.Object.Typ'Class;
      message : access MSSyst.String.Typ'Class) return Ref;
...
private
   ...
   pragma MSIL_Constructor(new_ArgumentOutOfRangeException);
   pragma Import(MSIL,get_ActualValue,"get_ActualValue");
   pragma Import(MSIL,get_Message,"get_Message");
   pragma Import(MSIL,GetObjectData,"GetObjectData");
end MSSyst.ArgumentOutOfRangeException;
pragma Import(MSIL,MSSyst.ArgumentOutOfRangeException,
