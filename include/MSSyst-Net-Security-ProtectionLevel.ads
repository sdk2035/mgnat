...
package MSSyst.Net.Security.ProtectionLevel is
   type ValueType is (
      None,
      Sign,
      EncryptAndSign);
...
end MSSyst.Net.Security.ProtectionLevel;
pragma Import(MSIL,MSSyst.Net.Security.ProtectionLevel,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.Security.ProtectionLevel");
