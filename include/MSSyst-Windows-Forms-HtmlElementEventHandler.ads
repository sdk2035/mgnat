...
limited with MSSyst.Windows.Forms.HtmlElementEventArgs;
package MSSyst.Windows.Forms.HtmlElementEventHandler is
   ...
   function new_HtmlElementEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.HtmlElementEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_HtmlElementEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.HtmlElementEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.HtmlElementEventHandler,
