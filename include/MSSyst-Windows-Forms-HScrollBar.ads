...
with MSSyst.Windows.Forms.ScrollBar;
limited with MSSyst.Windows.Forms.ScrollEventHandler;
limited with MSSyst.Windows.Forms.UICuesEventHandler;
package MSSyst.Windows.Forms.HScrollBar is
   type Typ is new MSSyst.Windows.Forms.ScrollBar.Typ
   ...
   function new_HScrollBar(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_HScrollBar);
end MSSyst.Windows.Forms.HScrollBar;
pragma Import(MSIL,MSSyst.Windows.Forms.HScrollBar,
