...
limited with MSSyst.Windows.Forms.TreeViewCancelEventArgs;
package MSSyst.Windows.Forms.TreeViewCancelEventHandler is
   ...
   function new_TreeViewCancelEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.TreeViewCancelEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_TreeViewCancelEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.TreeViewCancelEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.TreeViewCancelEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TreeViewCancelEventHandler");
