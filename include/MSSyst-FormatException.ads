...
package MSSyst.FormatException is
...
private
   ...
   pragma MSIL_Constructor(new_FormatException);
end MSSyst.FormatException;
pragma Import(MSIL,MSSyst.FormatException,
