...
package MSSyst.Windows.Forms.TableLayoutPanelGrowStyle is
   type ValueType is (
      FixedSize,
      AddRows,
      AddColumns);
...
end MSSyst.Windows.Forms.TableLayoutPanelGrowStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.TableLayoutPanelGrowStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TableLayoutPanelGrowStyle");
