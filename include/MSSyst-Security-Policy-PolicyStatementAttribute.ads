...
package MSSyst.Security.Policy.PolicyStatementAttribute is
   type ValueType is (
      Nothing,
      Exclusive,
      LevelFinal,
...
end MSSyst.Security.Policy.PolicyStatementAttribute;
pragma Import(MSIL,MSSyst.Security.Policy.PolicyStatementAttribute,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Policy.PolicyStatementAttribute");
