...
limited with MSSyst.Windows.Forms.BindingCompleteEventArgs;
package MSSyst.Windows.Forms.BindingCompleteEventHandler is
   ...
   function new_BindingCompleteEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.BindingCompleteEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_BindingCompleteEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.BindingCompleteEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.BindingCompleteEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.BindingCompleteEventHandler");
