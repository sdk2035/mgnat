...
package MSSyst.IO.PathTooLongException is
   ...
   function new_PathTooLongException(
...
private
   ...
   pragma MSIL_Constructor(new_PathTooLongException);
end MSSyst.IO.PathTooLongException;
pragma Import(MSIL,MSSyst.IO.PathTooLongException,
