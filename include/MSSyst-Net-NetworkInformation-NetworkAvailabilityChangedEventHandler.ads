...
limited with MSSyst.Net.NetworkInformation.NetworkAvailabilityEventArgs;
...
package MSSyst.Net.NetworkInformation.NetworkAvailabilityChangedEventHandler is
   ...
   function new_NetworkAvailabilityChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.NetworkInformation.NetworkAvailabilityEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_NetworkAvailabilityChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.NetworkInformation.NetworkAvailabilityChangedEventHandler;
pragma Import(MSIL,MSSyst.Net.NetworkInformation.NetworkAvailabilityChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.NetworkInformation.NetworkAvailabilityChangedEventHandler");
