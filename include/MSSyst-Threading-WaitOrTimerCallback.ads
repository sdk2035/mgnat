...
package MSSyst.Threading.WaitOrTimerCallback is
   ...
   function new_WaitOrTimerCallback(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_WaitOrTimerCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.WaitOrTimerCallback;
pragma Import(MSIL,MSSyst.Threading.WaitOrTimerCallback,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Threading.WaitOrTimerCallback");
