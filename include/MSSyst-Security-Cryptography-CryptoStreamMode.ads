...
package MSSyst.Security.Cryptography.CryptoStreamMode is
   type ValueType is (
      Read,
      Write);
...
end MSSyst.Security.Cryptography.CryptoStreamMode;
pragma Import(MSIL,MSSyst.Security.Cryptography.CryptoStreamMode,
