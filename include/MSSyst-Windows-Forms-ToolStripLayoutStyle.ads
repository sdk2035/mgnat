...
package MSSyst.Windows.Forms.ToolStripLayoutStyle is
   type ValueType is (
      StackWithOverflow,
...
end MSSyst.Windows.Forms.ToolStripLayoutStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripLayoutStyle,
