...
limited with MSSyst.Windows.Forms.DataGridViewRowPrePaintEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowPrePaintEventHandler is
   ...
   function new_DataGridViewRowPrePaintEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowPrePaintEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowPrePaintEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowPrePaintEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowPrePaintEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowPrePaintEventHandler");
