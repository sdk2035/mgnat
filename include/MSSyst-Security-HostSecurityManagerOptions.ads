...
package MSSyst.Security.HostSecurityManagerOptions is
   type ValueType is (
      None,
...
end MSSyst.Security.HostSecurityManagerOptions;
pragma Import(MSIL,MSSyst.Security.HostSecurityManagerOptions,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.HostSecurityManagerOptions");
