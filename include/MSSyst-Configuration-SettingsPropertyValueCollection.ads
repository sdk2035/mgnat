...
package MSSyst.Configuration.SettingsPropertyValueCollection is
   ...
   function new_SettingsPropertyValueCollection(
      This : Ref := null) return Ref;
   procedure Add(
      This : access Typ;
      property : access MSSyst.Configuration.SettingsPropertyValue.Typ'Class);
   procedure Clear(
      This : access Typ);
   function Clone(
   ...
   function get_Item(
      This : access Typ;
      name : access MSSyst.String.Typ'Class) return access MSSyst.Configuration.SettingsPropertyValue.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SettingsPropertyValueCollection);
...
end MSSyst.Configuration.SettingsPropertyValueCollection;
pragma Import(MSIL,MSSyst.Configuration.SettingsPropertyValueCollection,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Configuration.SettingsPropertyValueCollection");
