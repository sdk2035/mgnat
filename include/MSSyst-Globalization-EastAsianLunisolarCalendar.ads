...
package MSSyst.Globalization.EastAsianLunisolarCalendar is
   type Typ is abstract new MSSyst.Globalization.Calendar.Typ
   ...
   function GetCelestialStem(
      This : access Typ;
      sexagenaryYear : Integer) return Integer;
...
private
   ...
   pragma Import(MSIL,GetCelestialStem,"GetCelestialStem");
   ...
   pragma Import(MSIL,GetSexagenaryYear,"GetSexagenaryYear");
   pragma Import(MSIL,GetTerrestrialBranch,"GetTerrestrialBranch");
...
end MSSyst.Globalization.EastAsianLunisolarCalendar;
pragma Import(MSIL,MSSyst.Globalization.EastAsianLunisolarCalendar,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.EastAsianLunisolarCalendar");
