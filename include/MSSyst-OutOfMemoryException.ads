...
package MSSyst.OutOfMemoryException is
   ...
   function new_OutOfMemoryException(
...
private
   ...
   pragma MSIL_Constructor(new_OutOfMemoryException);
end MSSyst.OutOfMemoryException;
pragma Import(MSIL,MSSyst.OutOfMemoryException,
