...
limited with MSSyst.Windows.Forms.DataGridViewCellStyleContentChangedEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellStyleContentChangedEventHandler is
   ...
   function new_DataGridViewCellStyleContentChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellStyleContentChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellStyleContentChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellStyleContentChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellStyleContentChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellStyleContentChangedEventHandler");
