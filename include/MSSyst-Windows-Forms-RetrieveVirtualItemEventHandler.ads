...
limited with MSSyst.Windows.Forms.RetrieveVirtualItemEventArgs;
package MSSyst.Windows.Forms.RetrieveVirtualItemEventHandler is
   ...
   function new_RetrieveVirtualItemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.RetrieveVirtualItemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_RetrieveVirtualItemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.RetrieveVirtualItemEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.RetrieveVirtualItemEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.RetrieveVirtualItemEventHandler");
