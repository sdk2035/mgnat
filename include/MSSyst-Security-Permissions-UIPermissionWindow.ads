...
package MSSyst.Security.Permissions.UIPermissionWindow is
   type ValueType is (
      NoWindows,
      SafeSubWindows,
      SafeTopLevelWindows,
...
end MSSyst.Security.Permissions.UIPermissionWindow;
pragma Import(MSIL,MSSyst.Security.Permissions.UIPermissionWindow,
