...
limited with MSSyst.Windows.Forms.DrawItemEventArgs;
package MSSyst.Windows.Forms.DrawItemEventHandler is
   ...
   function new_DrawItemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DrawItemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DrawItemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DrawItemEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DrawItemEventHandler,
