...
package MSSyst.Windows.Forms.DataGridViewClipboardCopyMode is
   type ValueType is (
      Disable,
...
end MSSyst.Windows.Forms.DataGridViewClipboardCopyMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewClipboardCopyMode,
