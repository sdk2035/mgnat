...
limited with MSSyst.Windows.Forms.ColumnClickEventArgs;
package MSSyst.Windows.Forms.ColumnClickEventHandler is
   ...
   function new_ColumnClickEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ColumnClickEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ColumnClickEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ColumnClickEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ColumnClickEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ColumnClickEventHandler");
