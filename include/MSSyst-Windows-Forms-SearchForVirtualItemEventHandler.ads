...
limited with MSSyst.Windows.Forms.SearchForVirtualItemEventArgs;
package MSSyst.Windows.Forms.SearchForVirtualItemEventHandler is
   ...
   function new_SearchForVirtualItemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.SearchForVirtualItemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SearchForVirtualItemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.SearchForVirtualItemEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.SearchForVirtualItemEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.SearchForVirtualItemEventHandler");
