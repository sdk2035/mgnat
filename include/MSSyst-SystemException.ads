...
package MSSyst.SystemException is
...
private
   ...
   pragma MSIL_Constructor(new_SystemException);
end MSSyst.SystemException;
pragma Import(MSIL,MSSyst.SystemException,
