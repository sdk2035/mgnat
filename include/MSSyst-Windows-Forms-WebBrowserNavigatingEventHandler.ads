...
limited with MSSyst.Windows.Forms.WebBrowserNavigatingEventArgs;
package MSSyst.Windows.Forms.WebBrowserNavigatingEventHandler is
   ...
   function new_WebBrowserNavigatingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.WebBrowserNavigatingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_WebBrowserNavigatingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.WebBrowserNavigatingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.WebBrowserNavigatingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.WebBrowserNavigatingEventHandler");
