...
package MSSyst.Diagnostics.DebuggerBrowsableState is
   type ValueType is (
      Never,
      Collapsed,
      RootHidden);
...
end MSSyst.Diagnostics.DebuggerBrowsableState;
pragma Import(MSIL,MSSyst.Diagnostics.DebuggerBrowsableState,
