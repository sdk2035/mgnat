...
package MSSyst.Windows.Forms.ScrollOrientation is
   type ValueType is (
      HorizontalScroll,
      VerticalScroll);
...
end MSSyst.Windows.Forms.ScrollOrientation;
pragma Import(MSIL,MSSyst.Windows.Forms.ScrollOrientation,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ScrollOrientation");
