...
limited with MSSyst.Windows.Forms.DataGridViewDataErrorEventArgs;
package MSSyst.Windows.Forms.DataGridViewDataErrorEventHandler is
   ...
   function new_DataGridViewDataErrorEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewDataErrorEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewDataErrorEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewDataErrorEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewDataErrorEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewDataErrorEventHandler");
