...
package MSSyst.Windows.Forms.ToolStripContentPanelRenderEventHandler is
   ...
   function new_ToolStripContentPanelRenderEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_ToolStripContentPanelRenderEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolStripContentPanelRenderEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripContentPanelRenderEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripContentPanelRenderEventHandler");
