...
package MSSyst.Diagnostics.PerformanceCounterPermissionAccess is
   type ValueType is (
      None,
      Browse,
      Write,
   ...
   pragma Import (MSIL, "+", "+");
   Read : constant Valuetype := Browse;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.Diagnostics.PerformanceCounterPermissionAccess;
pragma Import(MSIL,MSSyst.Diagnostics.PerformanceCounterPermissionAccess,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Diagnostics.PerformanceCounterPermissionAccess");
