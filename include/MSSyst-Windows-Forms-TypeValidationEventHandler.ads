...
limited with MSSyst.Windows.Forms.TypeValidationEventArgs;
package MSSyst.Windows.Forms.TypeValidationEventHandler is
   ...
   function new_TypeValidationEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.TypeValidationEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_TypeValidationEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.TypeValidationEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.TypeValidationEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TypeValidationEventHandler");
