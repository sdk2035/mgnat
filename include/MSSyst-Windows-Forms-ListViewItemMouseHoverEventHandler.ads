...
limited with MSSyst.Windows.Forms.ListViewItemMouseHoverEventArgs;
package MSSyst.Windows.Forms.ListViewItemMouseHoverEventHandler is
   ...
   function new_ListViewItemMouseHoverEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ListViewItemMouseHoverEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ListViewItemMouseHoverEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ListViewItemMouseHoverEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ListViewItemMouseHoverEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ListViewItemMouseHoverEventHandler");
