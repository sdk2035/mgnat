...
with MSIL_Types;
use MSIL_Types;
limited with Microsoft.Win32.UserPreferenceChangedEventArgs;
...
package Microsoft.Win32.UserPreferenceChangedEventHandler is
   ...
   function new_UserPreferenceChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access Microsoft.Win32.UserPreferenceChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UserPreferenceChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end Microsoft.Win32.UserPreferenceChangedEventHandler;
pragma Import(MSIL,Microsoft.Win32.UserPreferenceChangedEventHandler,
