...
package MSSyst.DivideByZeroException is
   ...
   function new_DivideByZeroException(
...
private
   ...
   pragma MSIL_Constructor(new_DivideByZeroException);
end MSSyst.DivideByZeroException;
pragma Import(MSIL,MSSyst.DivideByZeroException,
