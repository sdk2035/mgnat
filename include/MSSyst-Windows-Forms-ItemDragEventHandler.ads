...
limited with MSSyst.Windows.Forms.ItemDragEventArgs;
package MSSyst.Windows.Forms.ItemDragEventHandler is
   ...
   function new_ItemDragEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ItemDragEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ItemDragEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ItemDragEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ItemDragEventHandler,
