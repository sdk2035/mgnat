...
package MSSyst.Windows.Forms.TableLayoutPanelCellBorderStyle is
   type ValueType is (
      None,
      Single,
      Inset,
...
end MSSyst.Windows.Forms.TableLayoutPanelCellBorderStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.TableLayoutPanelCellBorderStyle,
