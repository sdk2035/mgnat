...
limited with MSSyst.Windows.Forms.ItemCheckedEventArgs;
package MSSyst.Windows.Forms.ItemCheckedEventHandler is
   ...
   function new_ItemCheckedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ItemCheckedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ItemCheckedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ItemCheckedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ItemCheckedEventHandler,
