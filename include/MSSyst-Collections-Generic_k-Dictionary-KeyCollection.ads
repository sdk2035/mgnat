...
package MSSyst.Collections.Generic_k.Dictionary.KeyCollection is
...
end MSSyst.Collections.Generic_k.Dictionary.KeyCollection;
pragma Import(MSIL,MSSyst.Collections.Generic_k.Dictionary.KeyCollection,
