...
package MSSyst.OperationCanceledException is
   ...
   function new_OperationCanceledException(
...
private
   ...
   pragma MSIL_Constructor(new_OperationCanceledException);
end MSSyst.OperationCanceledException;
pragma Import(MSIL,MSSyst.OperationCanceledException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.OperationCanceledException");
