...
package MSSyst.UInt32 is
   ...
   function Equals(
      This : Valuetype;
      obj : MSIL_Types.Unsigned_Integer) return Standard.Boolean;
   function Equals(
      This : Valuetype;
   ...
   function Parse(
      s : access MSSyst.String.Typ'Class) return MSIL_Types.Unsigned_Integer;
   function Parse(
      s : access MSSyst.String.Typ'Class;
      style : MSSyst.Globalization.NumberStyles.Valuetype) return MSIL_Types.Unsigned_Integer;
   function Parse(
      s : access MSSyst.String.Typ'Class;
   ...
   function TryParse(
      s : access MSSyst.String.Typ'Class;
      result : MSIL_Types.Unsigned_Integer_addrof) return Standard.Boolean;
   function TryParse(
      s : access MSSyst.String.Typ'Class;
      style : MSSyst.Globalization.NumberStyles.Valuetype;
...
pragma Import(MSIL,MSSyst.UInt32,
