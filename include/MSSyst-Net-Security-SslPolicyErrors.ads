...
package MSSyst.Net.Security.SslPolicyErrors is
   type ValueType is (
      None,
...
end MSSyst.Net.Security.SslPolicyErrors;
pragma Import(MSIL,MSSyst.Net.Security.SslPolicyErrors,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.Security.SslPolicyErrors");
