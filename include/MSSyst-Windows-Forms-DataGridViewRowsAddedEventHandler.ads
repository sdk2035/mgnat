...
limited with MSSyst.Windows.Forms.DataGridViewRowsAddedEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowsAddedEventHandler is
   ...
   function new_DataGridViewRowsAddedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowsAddedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowsAddedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowsAddedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowsAddedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowsAddedEventHandler");
