...
package MSSyst.Security.Cryptography.X509Certificates.X509KeyUsageFlags is
   type ValueType is (
      None,
      EncipherOnly,
      CrlSign,
...
end MSSyst.Security.Cryptography.X509Certificates.X509KeyUsageFlags;
pragma Import(MSIL,MSSyst.Security.Cryptography.X509Certificates.X509KeyUsageFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Cryptography.X509Certificates.X509KeyUsageFlags");
