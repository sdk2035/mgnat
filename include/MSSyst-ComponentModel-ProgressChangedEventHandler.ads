...
limited with MSSyst.ComponentModel.ProgressChangedEventArgs;
...
package MSSyst.ComponentModel.ProgressChangedEventHandler is
   ...
   function new_ProgressChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.ProgressChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ProgressChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.ProgressChangedEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.ProgressChangedEventHandler,
