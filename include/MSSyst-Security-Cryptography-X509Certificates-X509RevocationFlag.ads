...
package MSSyst.Security.Cryptography.X509Certificates.X509RevocationFlag is
   type ValueType is (
      EndCertificateOnly,
      EntireChain,
      ExcludeRoot);
...
end MSSyst.Security.Cryptography.X509Certificates.X509RevocationFlag;
pragma Import(MSIL,MSSyst.Security.Cryptography.X509Certificates.X509RevocationFlag,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Cryptography.X509Certificates.X509RevocationFlag");
