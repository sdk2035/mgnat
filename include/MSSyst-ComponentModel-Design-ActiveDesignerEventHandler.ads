...
limited with MSSyst.ComponentModel.Design.ActiveDesignerEventArgs;
...
package MSSyst.ComponentModel.Design.ActiveDesignerEventHandler is
   ...
   function new_ActiveDesignerEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.Design.ActiveDesignerEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ActiveDesignerEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.Design.ActiveDesignerEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.Design.ActiveDesignerEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.Design.ActiveDesignerEventHandler");
