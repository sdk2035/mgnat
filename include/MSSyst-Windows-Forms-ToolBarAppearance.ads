...
package MSSyst.Windows.Forms.ToolBarAppearance is
   type ValueType is (
      Normal,
      Flat);
...
end MSSyst.Windows.Forms.ToolBarAppearance;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolBarAppearance,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolBarAppearance");
