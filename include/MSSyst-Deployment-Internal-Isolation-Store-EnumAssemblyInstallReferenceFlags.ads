...
with MSIL_Types;
use MSIL_Types;
with MSSyst.Deployment.Internal.Isolation.Store;
limited with MSSyst.IFormatProvider;
limited with MSSyst.String;
limited with MSSyst.TypeCode;
limited with MSSyst.Type_k;
package MSSyst.Deployment.Internal.Isolation.Store.EnumAssemblyInstallReferenceFlags is
   type ValueType is (
      Nothing);
...
end MSSyst.Deployment.Internal.Isolation.Store.EnumAssemblyInstallReferenceFlags;
pragma Import(MSIL,MSSyst.Deployment.Internal.Isolation.Store.EnumAssemblyInstallReferenceFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Deployment.Internal.Isolation.Store/EnumAssemblyInstallReferenceFlags");
