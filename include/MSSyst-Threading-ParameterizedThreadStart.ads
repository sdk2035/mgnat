...
package MSSyst.Threading.ParameterizedThreadStart is
   ...
   function new_ParameterizedThreadStart(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_ParameterizedThreadStart);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.ParameterizedThreadStart;
pragma Import(MSIL,MSSyst.Threading.ParameterizedThreadStart,
