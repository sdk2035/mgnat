...
package MSSyst.StackOverflowException is
   ...
   function new_StackOverflowException(
...
private
   ...
   pragma MSIL_Constructor(new_StackOverflowException);
end MSSyst.StackOverflowException;
pragma Import(MSIL,MSSyst.StackOverflowException,
