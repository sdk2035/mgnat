...
package MSSyst.Runtime.ConstrainedExecution.Consistency is
   type ValueType is (
      MayCorruptProcess,
      MayCorruptAppDomain,
      MayCorruptInstance,
...
end MSSyst.Runtime.ConstrainedExecution.Consistency;
pragma Import(MSIL,MSSyst.Runtime.ConstrainedExecution.Consistency,
