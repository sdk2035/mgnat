...
package MSSyst.ArithmeticException is
   ...
   function new_ArithmeticException(
...
private
   ...
   pragma MSIL_Constructor(new_ArithmeticException);
end MSSyst.ArithmeticException;
pragma Import(MSIL,MSSyst.ArithmeticException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.ArithmeticException");
