...
package MSSyst.Net.Configuration.Ipv6Element is
...
private
   ...
   pragma MSIL_Constructor(new_Ipv6Element);
   pragma Import(MSIL,get_Enabled,"get_Enabled");
   pragma Import(MSIL,set_Enabled,"set_Enabled");
end MSSyst.Net.Configuration.Ipv6Element;
pragma Import(MSIL,MSSyst.Net.Configuration.Ipv6Element,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.Configuration.Ipv6Element");
