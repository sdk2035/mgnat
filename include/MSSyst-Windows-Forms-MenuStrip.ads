...
limited with MSSyst.Windows.Forms.ToolStripMenuItem;
...
package MSSyst.Windows.Forms.MenuStrip is
   ...
   function get_MdiWindowListItem(
      This : access Typ) return access MSSyst.Windows.Forms.ToolStripMenuItem.Typ'Class;
   ...
   procedure set_MdiWindowListItem(
      This : access Typ;
      value : access MSSyst.Windows.Forms.ToolStripMenuItem.Typ'Class);
...
private
   ...
   pragma MSIL_Constructor(new_MenuStrip);
   pragma Import(MSIL,add_MenuActivate,"add_MenuActivate");
   pragma Import(MSIL,add_MenuDeactivate,"add_MenuDeactivate");
   pragma Import(MSIL,get_CanOverflow,"get_CanOverflow");
   pragma Import(MSIL,get_GripStyle,"get_GripStyle");
   pragma Import(MSIL,get_MdiWindowListItem,"get_MdiWindowListItem");
   pragma Import(MSIL,get_ShowItemToolTips,"get_ShowItemToolTips");
   pragma Import(MSIL,get_Stretch,"get_Stretch");
   pragma Import(MSIL,remove_MenuActivate,"remove_MenuActivate");
   pragma Import(MSIL,remove_MenuDeactivate,"remove_MenuDeactivate");
   pragma Import(MSIL,set_CanOverflow,"set_CanOverflow");
   pragma Import(MSIL,set_GripStyle,"set_GripStyle");
   pragma Import(MSIL,set_MdiWindowListItem,"set_MdiWindowListItem");
   pragma Import(MSIL,set_ShowItemToolTips,"set_ShowItemToolTips");
   pragma Import(MSIL,set_Stretch,"set_Stretch");
end MSSyst.Windows.Forms.MenuStrip;
pragma Import(MSIL,MSSyst.Windows.Forms.MenuStrip,
