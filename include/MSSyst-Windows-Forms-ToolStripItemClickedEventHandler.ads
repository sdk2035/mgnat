...
limited with MSSyst.Windows.Forms.ToolStripItemClickedEventArgs;
package MSSyst.Windows.Forms.ToolStripItemClickedEventHandler is
   ...
   function new_ToolStripItemClickedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ToolStripItemClickedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ToolStripItemClickedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolStripItemClickedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripItemClickedEventHandler,
