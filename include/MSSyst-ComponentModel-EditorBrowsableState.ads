...
package MSSyst.ComponentModel.EditorBrowsableState is
   type ValueType is (
      Always,
      Never,
      Advanced);
...
end MSSyst.ComponentModel.EditorBrowsableState;
pragma Import(MSIL,MSSyst.ComponentModel.EditorBrowsableState,
