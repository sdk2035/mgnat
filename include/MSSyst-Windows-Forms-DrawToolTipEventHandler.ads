...
limited with MSSyst.Windows.Forms.DrawToolTipEventArgs;
package MSSyst.Windows.Forms.DrawToolTipEventHandler is
   ...
   function new_DrawToolTipEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DrawToolTipEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DrawToolTipEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DrawToolTipEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DrawToolTipEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DrawToolTipEventHandler");
