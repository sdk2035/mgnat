...
package MSSyst.Security.AccessControl.FileSystemSecurity is
   ...
   procedure AddAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.FileSystemAccessRule.Typ'Class);
   procedure AddAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.FileSystemAuditRule.Typ'Class);
   ...
   function RemoveAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.FileSystemAccessRule.Typ'Class) return Standard.Boolean;
   ...
   function RemoveAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.FileSystemAuditRule.Typ'Class) return Standard.Boolean;
