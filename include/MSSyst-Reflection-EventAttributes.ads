...
package MSSyst.Reflection.EventAttributes is
   type ValueType is (
      None,
      SpecialName,
      RTSpecialName);
   ...
   pragma Import (MSIL, "+", "+");
   ReservedMask : constant Valuetype := RTSpecialName;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.Reflection.EventAttributes;
pragma Import(MSIL,MSSyst.Reflection.EventAttributes,
