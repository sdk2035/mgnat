...
limited with MSSyst.Windows.Forms.UICuesEventArgs;
package MSSyst.Windows.Forms.UICuesEventHandler is
   ...
   function new_UICuesEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.UICuesEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UICuesEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.UICuesEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.UICuesEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.UICuesEventHandler");
