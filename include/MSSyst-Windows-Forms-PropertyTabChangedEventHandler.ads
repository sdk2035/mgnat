...
limited with MSSyst.Windows.Forms.PropertyTabChangedEventArgs;
package MSSyst.Windows.Forms.PropertyTabChangedEventHandler is
   ...
   function new_PropertyTabChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.PropertyTabChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_PropertyTabChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.PropertyTabChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.PropertyTabChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.PropertyTabChangedEventHandler");
