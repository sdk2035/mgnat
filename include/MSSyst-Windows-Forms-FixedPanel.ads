...
package MSSyst.Windows.Forms.FixedPanel is
   type ValueType is (
      None,
      Panel1,
      Panel2);
...
end MSSyst.Windows.Forms.FixedPanel;
pragma Import(MSIL,MSSyst.Windows.Forms.FixedPanel,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.FixedPanel");
