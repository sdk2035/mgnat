...
limited with MSSyst.Windows.Forms.ListViewVirtualItemsSelectionRangeChangedEventArgs;
package MSSyst.Windows.Forms.ListViewVirtualItemsSelectionRangeChangedEventHandler is
   ...
   function new_ListViewVirtualItemsSelectionRangeChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ListViewVirtualItemsSelectionRangeChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ListViewVirtualItemsSelectionRangeChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ListViewVirtualItemsSelectionRangeChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ListViewVirtualItemsSelectionRangeChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ListViewVirtualItemsSelectionRangeChangedEventHandler");
