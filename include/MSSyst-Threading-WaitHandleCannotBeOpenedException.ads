...
with MSIL_Types;
use MSIL_Types;
with MSSyst.ApplicationException;
...
package MSSyst.Threading.WaitHandleCannotBeOpenedException is
   type Typ is new MSSyst.ApplicationException.Typ
   ...
   function new_WaitHandleCannotBeOpenedException(
...
private
   ...
   pragma MSIL_Constructor(new_WaitHandleCannotBeOpenedException);
end MSSyst.Threading.WaitHandleCannotBeOpenedException;
pragma Import(MSIL,MSSyst.Threading.WaitHandleCannotBeOpenedException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Threading.WaitHandleCannotBeOpenedException");
