...
limited with MSSyst.Windows.Forms.ItemChangedEventArgs;
package MSSyst.Windows.Forms.ItemChangedEventHandler is
   ...
   function new_ItemChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ItemChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ItemChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ItemChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ItemChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ItemChangedEventHandler");
