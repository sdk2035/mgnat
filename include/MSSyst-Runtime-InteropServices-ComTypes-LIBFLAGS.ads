...
package MSSyst.Runtime.InteropServices.ComTypes.LIBFLAGS is
   type ValueType is (
      LIBFLAG_FRESTRICTED,
      LIBFLAG_FCONTROL,
      LIBFLAG_FHIDDEN,
   ...
   for ValueType use (
      LIBFLAG_FRESTRICTED =>  0,
      LIBFLAG_FCONTROL =>  131074,
      LIBFLAG_FHIDDEN =>  262148,
      LIBFLAG_FHASDISKIMAGE =>  524296);
...
end MSSyst.Runtime.InteropServices.ComTypes.LIBFLAGS;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.ComTypes.LIBFLAGS,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.InteropServices.ComTypes.LIBFLAGS");
