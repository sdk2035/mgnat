...
limited with MSSyst.Windows.Forms.DataGridViewCellStateChangedEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellStateChangedEventHandler is
   ...
   function new_DataGridViewCellStateChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellStateChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellStateChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellStateChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellStateChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellStateChangedEventHandler");
