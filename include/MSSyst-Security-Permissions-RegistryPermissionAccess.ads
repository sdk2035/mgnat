...
package MSSyst.Security.Permissions.RegistryPermissionAccess is
   type ValueType is (
      NoAccess,
      Read,
      Write,
...
end MSSyst.Security.Permissions.RegistryPermissionAccess;
pragma Import(MSIL,MSSyst.Security.Permissions.RegistryPermissionAccess,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.RegistryPermissionAccess");
