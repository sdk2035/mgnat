...
package MSSyst.Net.HttpContinueDelegate is
   ...
   function new_HttpContinueDelegate(
      This : Ref := null;
   ...
   function BeginInvoke(
      This : access Typ;
      StatusCode : Integer;
      httpHeaders : access MSSyst.Net.WebHeaderCollection.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_HttpContinueDelegate);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.HttpContinueDelegate;
pragma Import(MSIL,MSSyst.Net.HttpContinueDelegate,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.HttpContinueDelegate");
