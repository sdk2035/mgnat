...
package MSSyst.Configuration.Assemblies.AssemblyHashAlgorithm is
   type ValueType is (
      None,
      MD5,
      SHA1);
...
end MSSyst.Configuration.Assemblies.AssemblyHashAlgorithm;
pragma Import(MSIL,MSSyst.Configuration.Assemblies.AssemblyHashAlgorithm,
