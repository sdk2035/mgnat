...
limited with MSSyst.Text.RegularExpressions.Group;
...
package MSSyst.Text.RegularExpressions.GroupCollection is
   ...
   function get_Item(
      This : access Typ;
      groupname : access MSSyst.String.Typ'Class) return access MSSyst.Text.RegularExpressions.Group.Typ'Class;
   function get_Item(
      This : access Typ;
      groupnum : Integer) return access MSSyst.Text.RegularExpressions.Group.Typ'Class;
