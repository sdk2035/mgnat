...
package MSSyst.Runtime.Serialization.Formatters.FormatterTypeStyle is
   type ValueType is (
      TypesWhenNeeded,
      TypesAlways,
      XsdString);
...
end MSSyst.Runtime.Serialization.Formatters.FormatterTypeStyle;
pragma Import(MSIL,MSSyst.Runtime.Serialization.Formatters.FormatterTypeStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Serialization.Formatters.FormatterTypeStyle");
