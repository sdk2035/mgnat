...
package MSSyst.Security.Permissions.GacIdentityPermissionAttribute is
   ...
   function new_GacIdentityPermissionAttribute(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_GacIdentityPermissionAttribute);
   pragma Import(MSIL,CreatePermission,"CreatePermission");
end MSSyst.Security.Permissions.GacIdentityPermissionAttribute;
pragma Import(MSIL,MSSyst.Security.Permissions.GacIdentityPermissionAttribute,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.GacIdentityPermissionAttribute");
