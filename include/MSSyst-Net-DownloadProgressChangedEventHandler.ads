...
limited with MSSyst.Net.DownloadProgressChangedEventArgs;
...
package MSSyst.Net.DownloadProgressChangedEventHandler is
   ...
   function new_DownloadProgressChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.DownloadProgressChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DownloadProgressChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.DownloadProgressChangedEventHandler;
pragma Import(MSIL,MSSyst.Net.DownloadProgressChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.DownloadProgressChangedEventHandler");
