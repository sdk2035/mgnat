...
package MSSyst.Security.PolicyLevelType is
   type ValueType is (
      User,
      Machine,
      Enterprise,
...
end MSSyst.Security.PolicyLevelType;
pragma Import(MSIL,MSSyst.Security.PolicyLevelType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.PolicyLevelType");
