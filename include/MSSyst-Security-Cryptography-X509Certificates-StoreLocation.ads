...
package MSSyst.Security.Cryptography.X509Certificates.StoreLocation is
   type ValueType is (
      CurrentUser,
      LocalMachine);
...
end MSSyst.Security.Cryptography.X509Certificates.StoreLocation;
pragma Import(MSIL,MSSyst.Security.Cryptography.X509Certificates.StoreLocation,
