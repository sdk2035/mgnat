...
package MSSyst.Windows.Forms.ToolStripItemPlacement is
   type ValueType is (
      Main,
      Overflow,
      None);
...
end MSSyst.Windows.Forms.ToolStripItemPlacement;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripItemPlacement,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripItemPlacement");
