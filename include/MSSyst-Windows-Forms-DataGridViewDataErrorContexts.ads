...
package MSSyst.Windows.Forms.DataGridViewDataErrorContexts is
   type ValueType is (
      Formatting,
      Display,
      PreferredSize,
...
end MSSyst.Windows.Forms.DataGridViewDataErrorContexts;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewDataErrorContexts,
