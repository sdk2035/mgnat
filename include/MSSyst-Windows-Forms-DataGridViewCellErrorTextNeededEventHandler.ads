...
limited with MSSyst.Windows.Forms.DataGridViewCellErrorTextNeededEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellErrorTextNeededEventHandler is
   ...
   function new_DataGridViewCellErrorTextNeededEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellErrorTextNeededEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellErrorTextNeededEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellErrorTextNeededEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellErrorTextNeededEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellErrorTextNeededEventHandler");
