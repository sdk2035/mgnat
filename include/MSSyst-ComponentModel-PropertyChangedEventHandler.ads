...
limited with MSSyst.ComponentModel.PropertyChangedEventArgs;
...
package MSSyst.ComponentModel.PropertyChangedEventHandler is
   ...
   function new_PropertyChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.PropertyChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_PropertyChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.PropertyChangedEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.PropertyChangedEventHandler,
