...
limited with MSSyst.Windows.Forms.DataGridViewCellMouseEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellMouseEventHandler is
   ...
   function new_DataGridViewCellMouseEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellMouseEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellMouseEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellMouseEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellMouseEventHandler,
