...
package MSSyst.Windows.Forms.Internal.IntNativeMethods.RECT is
   ...
   function FromXYWH(
      ...
      y : Integer;
      width : Integer;
      height : Integer) return MSSyst.Windows.Forms.Internal.IntNativeMethods.RECT.Valuetype;
   function get_Size(
...
end MSSyst.Windows.Forms.Internal.IntNativeMethods.RECT;
pragma Import(MSIL,MSSyst.Windows.Forms.Internal.IntNativeMethods.RECT,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.Internal.IntNativeMethods/RECT");
