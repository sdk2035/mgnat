...
limited with MSSyst.Net.Configuration.AuthenticationModuleElement;
...
package MSSyst.Net.Configuration.AuthenticationModuleElementCollection is
   ...
   procedure Add(
      This : access Typ;
      element : access MSSyst.Net.Configuration.AuthenticationModuleElement.Typ'Class);
   procedure Clear(
      This : access Typ);
   function get_Item(
      This : access Typ;
      name : access MSSyst.String.Typ'Class) return access MSSyst.Net.Configuration.AuthenticationModuleElement.Typ'Class;
   function get_Item(
      This : access Typ;
      index : Integer) return access MSSyst.Net.Configuration.AuthenticationModuleElement.Typ'Class;
   function IndexOf(
      This : access Typ;
      element : access MSSyst.Net.Configuration.AuthenticationModuleElement.Typ'Class) return Integer;
   procedure Remove(
      This : access Typ;
      element : access MSSyst.Net.Configuration.AuthenticationModuleElement.Typ'Class);
   procedure Remove(
   ...
   procedure set_Item(
      This : access Typ;
      index : Integer;
      value : access MSSyst.Net.Configuration.AuthenticationModuleElement.Typ'Class);
   procedure set_Item(
      This : access Typ;
      name : access MSSyst.String.Typ'Class;
      value : access MSSyst.Net.Configuration.AuthenticationModuleElement.Typ'Class);
