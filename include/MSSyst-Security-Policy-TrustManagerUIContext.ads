...
package MSSyst.Security.Policy.TrustManagerUIContext is
   type ValueType is (
      Install,
      Upgrade,
      Run);
...
end MSSyst.Security.Policy.TrustManagerUIContext;
pragma Import(MSIL,MSSyst.Security.Policy.TrustManagerUIContext,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Policy.TrustManagerUIContext");
