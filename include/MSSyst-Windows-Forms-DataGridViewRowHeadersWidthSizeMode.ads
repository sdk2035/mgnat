...
package MSSyst.Windows.Forms.DataGridViewRowHeadersWidthSizeMode is
   type ValueType is (
      EnableResizing,
      DisableResizing,
...
end MSSyst.Windows.Forms.DataGridViewRowHeadersWidthSizeMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowHeadersWidthSizeMode,
