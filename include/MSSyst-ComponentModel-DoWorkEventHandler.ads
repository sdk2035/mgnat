...
limited with MSSyst.ComponentModel.DoWorkEventArgs;
...
package MSSyst.ComponentModel.DoWorkEventHandler is
   ...
   function new_DoWorkEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.DoWorkEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DoWorkEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.DoWorkEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.DoWorkEventHandler,
