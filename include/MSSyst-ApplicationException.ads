...
package MSSyst.ApplicationException is
   ...
   function new_ApplicationException(
...
private
   ...
   pragma MSIL_Constructor(new_ApplicationException);
end MSSyst.ApplicationException;
pragma Import(MSIL,MSSyst.ApplicationException,
