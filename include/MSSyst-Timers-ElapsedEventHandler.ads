...
limited with MSSyst.Timers.ElapsedEventArgs;
limited with MSSyst.Type_k;
package MSSyst.Timers.ElapsedEventHandler is
   ...
   function new_ElapsedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Timers.ElapsedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ElapsedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Timers.ElapsedEventHandler;
pragma Import(MSIL,MSSyst.Timers.ElapsedEventHandler,
