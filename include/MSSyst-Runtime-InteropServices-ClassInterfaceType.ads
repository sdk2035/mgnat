...
package MSSyst.Runtime.InteropServices.ClassInterfaceType is
   type ValueType is (
      None,
      AutoDispatch,
      AutoDual);
...
end MSSyst.Runtime.InteropServices.ClassInterfaceType;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.ClassInterfaceType,
