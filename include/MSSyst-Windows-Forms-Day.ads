...
package MSSyst.Windows.Forms.Day is
   type ValueType is (
      Monday,
      Tuesday,
      Wednesday,
...
end MSSyst.Windows.Forms.Day;
pragma Import(MSIL,MSSyst.Windows.Forms.Day,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.Day");
