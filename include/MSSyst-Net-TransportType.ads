...
package MSSyst.Net.TransportType is
   type ValueType is (
      Udp,
      Connectionless,
      ConnectionOriented,
   ...
   Tcp : constant Valuetype := ConnectionOriented;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.Net.TransportType;
pragma Import(MSIL,MSSyst.Net.TransportType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.TransportType");
