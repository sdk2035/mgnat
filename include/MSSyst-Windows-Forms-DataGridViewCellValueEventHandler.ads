...
limited with MSSyst.Windows.Forms.DataGridViewCellValueEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellValueEventHandler is
   ...
   function new_DataGridViewCellValueEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellValueEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellValueEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellValueEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellValueEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellValueEventHandler");
