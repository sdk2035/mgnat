...
limited with MSSyst.Net.NetworkInformation.PingCompletedEventArgs;
...
package MSSyst.Net.NetworkInformation.PingCompletedEventHandler is
   ...
   function new_PingCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.NetworkInformation.PingCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_PingCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.NetworkInformation.PingCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.NetworkInformation.PingCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.NetworkInformation.PingCompletedEventHandler");
