...
package MSSyst.Threading.TimerCallback is
...
private
   ...
   pragma MSIL_Constructor(new_TimerCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.TimerCallback;
pragma Import(MSIL,MSSyst.Threading.TimerCallback,
