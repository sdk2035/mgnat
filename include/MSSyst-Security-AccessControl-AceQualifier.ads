...
package MSSyst.Security.AccessControl.AceQualifier is
   type ValueType is (
      AccessAllowed,
      AccessDenied,
      SystemAudit,
...
end MSSyst.Security.AccessControl.AceQualifier;
pragma Import(MSIL,MSSyst.Security.AccessControl.AceQualifier,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.AceQualifier");
