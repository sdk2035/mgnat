...
package MSSyst.Windows.Forms.DataGridViewCellBorderStyle is
   type ValueType is (
      Custom,
      Single,
      Raised,
...
end MSSyst.Windows.Forms.DataGridViewCellBorderStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellBorderStyle,
