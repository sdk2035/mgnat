...
package MSSyst.ComponentModel.UInt32Converter is
   ...
   function new_UInt32Converter(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_UInt32Converter);
end MSSyst.ComponentModel.UInt32Converter;
pragma Import(MSIL,MSSyst.ComponentModel.UInt32Converter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.UInt32Converter");
