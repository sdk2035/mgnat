...
package MSSyst.Security.Cryptography.X509Certificates.StoreName is
   type ValueType is (
      AddressBook,
      AuthRoot,
...
end MSSyst.Security.Cryptography.X509Certificates.StoreName;
pragma Import(MSIL,MSSyst.Security.Cryptography.X509Certificates.StoreName,
