...
package MSSyst.Windows.Forms.VisualStyles.HorizontalAlign is
   type ValueType is (
      Left,
      Center,
      Right);
...
end MSSyst.Windows.Forms.VisualStyles.HorizontalAlign;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.HorizontalAlign,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.HorizontalAlign");
