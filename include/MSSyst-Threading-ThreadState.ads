...
package MSSyst.Threading.ThreadState is
   type ValueType is (
      Running,
      StopRequested,
      SuspendRequested,
...
end MSSyst.Threading.ThreadState;
pragma Import(MSIL,MSSyst.Threading.ThreadState,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Threading.ThreadState");
