...
package MSSyst.STAThreadAttribute is
   ...
   function new_STAThreadAttribute(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_STAThreadAttribute);
end MSSyst.STAThreadAttribute;
pragma Import(MSIL,MSSyst.STAThreadAttribute,
