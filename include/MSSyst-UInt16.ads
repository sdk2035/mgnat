...
package MSSyst.UInt16 is
   ...
   function Equals(
      This : Valuetype;
      obj : MSIL_Types.unsigned_int16) return Standard.Boolean;
   function Equals(
      This : Valuetype;
   ...
   function Parse(
      ...
      style : MSSyst.Globalization.NumberStyles.Valuetype) return MSIL_Types.unsigned_int16;
   function Parse(
      s : access MSSyst.String.Typ'Class) return MSIL_Types.unsigned_int16;
   function Parse(
      s : access MSSyst.String.Typ'Class;
   ...
   function TryParse(
      ...
      result : MSIL_Types.unsigned_int16_addrof) return Standard.Boolean;
   function TryParse(
      s : access MSSyst.String.Typ'Class;
      result : MSIL_Types.unsigned_int16_addrof) return Standard.Boolean;
private
...
pragma Import(MSIL,MSSyst.UInt16,
