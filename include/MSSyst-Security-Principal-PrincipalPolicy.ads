...
package MSSyst.Security.Principal.PrincipalPolicy is
   type ValueType is (
...
end MSSyst.Security.Principal.PrincipalPolicy;
pragma Import(MSIL,MSSyst.Security.Principal.PrincipalPolicy,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Principal.PrincipalPolicy");
