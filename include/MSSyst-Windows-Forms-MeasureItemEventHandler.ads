...
limited with MSSyst.Windows.Forms.MeasureItemEventArgs;
package MSSyst.Windows.Forms.MeasureItemEventHandler is
   ...
   function new_MeasureItemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.MeasureItemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_MeasureItemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.MeasureItemEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.MeasureItemEventHandler,
