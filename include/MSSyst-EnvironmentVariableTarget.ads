...
package MSSyst.EnvironmentVariableTarget is
   type ValueType is (
      Process,
      User,
      Machine);
...
end MSSyst.EnvironmentVariableTarget;
pragma Import(MSIL,MSSyst.EnvironmentVariableTarget,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.EnvironmentVariableTarget");
