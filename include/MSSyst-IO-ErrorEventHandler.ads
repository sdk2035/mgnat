...
limited with MSSyst.IO.ErrorEventArgs;
...
package MSSyst.IO.ErrorEventHandler is
   ...
   function new_ErrorEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.IO.ErrorEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ErrorEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.IO.ErrorEventHandler;
pragma Import(MSIL,MSSyst.IO.ErrorEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.IO.ErrorEventHandler");
