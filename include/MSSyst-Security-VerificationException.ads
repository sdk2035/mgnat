...
package MSSyst.Security.VerificationException is
   ...
   function new_VerificationException(
...
private
   ...
   pragma MSIL_Constructor(new_VerificationException);
end MSSyst.Security.VerificationException;
pragma Import(MSIL,MSSyst.Security.VerificationException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.VerificationException");
