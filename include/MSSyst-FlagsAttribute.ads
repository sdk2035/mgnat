...
package MSSyst.FlagsAttribute is
   ...
   function new_FlagsAttribute(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_FlagsAttribute);
end MSSyst.FlagsAttribute;
pragma Import(MSIL,MSSyst.FlagsAttribute,
