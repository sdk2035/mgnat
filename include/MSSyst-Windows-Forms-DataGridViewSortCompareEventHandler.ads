...
limited with MSSyst.Windows.Forms.DataGridViewSortCompareEventArgs;
package MSSyst.Windows.Forms.DataGridViewSortCompareEventHandler is
   ...
   function new_DataGridViewSortCompareEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewSortCompareEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewSortCompareEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewSortCompareEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewSortCompareEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewSortCompareEventHandler");
