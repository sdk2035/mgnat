...
package MSSyst.Net.NetworkInformation.NetworkAddressChangedEventHandler is
   ...
   function new_NetworkAddressChangedEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_NetworkAddressChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.NetworkInformation.NetworkAddressChangedEventHandler;
pragma Import(MSIL,MSSyst.Net.NetworkInformation.NetworkAddressChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.NetworkInformation.NetworkAddressChangedEventHandler");
