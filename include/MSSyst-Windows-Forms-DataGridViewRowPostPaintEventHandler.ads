...
limited with MSSyst.Windows.Forms.DataGridViewRowPostPaintEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowPostPaintEventHandler is
   ...
   function new_DataGridViewRowPostPaintEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowPostPaintEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowPostPaintEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowPostPaintEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowPostPaintEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowPostPaintEventHandler");
