...
package MSSyst.Windows.Forms.DataGridLineStyle is
   type ValueType is (
      None,
      Solid);
...
end MSSyst.Windows.Forms.DataGridLineStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridLineStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridLineStyle");
