...
package MSSyst.Security.Permissions.HostProtectionResource is
   type ValueType is (
      None,
      Synchronization,
      SharedState,
...
end MSSyst.Security.Permissions.HostProtectionResource;
pragma Import(MSIL,MSSyst.Security.Permissions.HostProtectionResource,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.HostProtectionResource");
