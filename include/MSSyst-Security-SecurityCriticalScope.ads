...
package MSSyst.Security.SecurityCriticalScope is
   type ValueType is (
      Explicit,
      Everything);
...
end MSSyst.Security.SecurityCriticalScope;
pragma Import(MSIL,MSSyst.Security.SecurityCriticalScope,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.SecurityCriticalScope");
