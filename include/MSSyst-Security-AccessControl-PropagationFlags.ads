...
package MSSyst.Security.AccessControl.PropagationFlags is
   type ValueType is (
      None,
      NoPropagateInherit,
      InheritOnly);
...
end MSSyst.Security.AccessControl.PropagationFlags;
pragma Import(MSIL,MSSyst.Security.AccessControl.PropagationFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.PropagationFlags");
