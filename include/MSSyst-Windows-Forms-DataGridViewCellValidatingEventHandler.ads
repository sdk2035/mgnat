...
limited with MSSyst.Windows.Forms.DataGridViewCellValidatingEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellValidatingEventHandler is
   ...
   function new_DataGridViewCellValidatingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellValidatingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellValidatingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellValidatingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellValidatingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellValidatingEventHandler");
