...
limited with MSSyst.Windows.Forms.PropertyValueChangedEventArgs;
package MSSyst.Windows.Forms.PropertyValueChangedEventHandler is
   ...
   function new_PropertyValueChangedEventHandler(
      This : Ref := null;
      object : access MSSyst.Object.Typ'Class;
      method : MSIL_Types.native_int) return Ref;
   function BeginInvoke(
      This : access Typ;
      s : access MSSyst.Object.Typ'Class;
      e : access MSSyst.Windows.Forms.PropertyValueChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_PropertyValueChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.PropertyValueChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.PropertyValueChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.PropertyValueChangedEventHandler");
