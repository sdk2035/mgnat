...
package MSSyst.Security.Cryptography.KeyNumber is
   type ValueType is (
      Exchange,
      Signature);
...
end MSSyst.Security.Cryptography.KeyNumber;
pragma Import(MSIL,MSSyst.Security.Cryptography.KeyNumber,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Cryptography.KeyNumber");
