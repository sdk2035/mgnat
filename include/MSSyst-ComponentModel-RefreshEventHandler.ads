...
limited with MSSyst.ComponentModel.RefreshEventArgs;
...
package MSSyst.ComponentModel.RefreshEventHandler is
...
private
   ...
   pragma MSIL_Constructor(new_RefreshEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.RefreshEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.RefreshEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.RefreshEventHandler");
