...
package MSSyst.Windows.Forms.VisualStyles.MarginProperty is
   type ValueType is (
      SizingMargins,
      ContentMargins,
      CaptionMargins);
...
end MSSyst.Windows.Forms.VisualStyles.MarginProperty;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.MarginProperty,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.MarginProperty");
