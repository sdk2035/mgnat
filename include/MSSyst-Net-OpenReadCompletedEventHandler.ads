...
limited with MSSyst.Net.OpenReadCompletedEventArgs;
...
package MSSyst.Net.OpenReadCompletedEventHandler is
   ...
   function new_OpenReadCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.OpenReadCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_OpenReadCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.OpenReadCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.OpenReadCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.OpenReadCompletedEventHandler");
