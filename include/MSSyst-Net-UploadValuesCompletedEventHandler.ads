...
limited with MSSyst.Net.UploadValuesCompletedEventArgs;
...
package MSSyst.Net.UploadValuesCompletedEventHandler is
   ...
   function new_UploadValuesCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.UploadValuesCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UploadValuesCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.UploadValuesCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.UploadValuesCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.UploadValuesCompletedEventHandler");
