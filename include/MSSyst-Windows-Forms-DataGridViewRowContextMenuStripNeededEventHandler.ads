...
limited with MSSyst.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowContextMenuStripNeededEventHandler is
   ...
   function new_DataGridViewRowContextMenuStripNeededEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowContextMenuStripNeededEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowContextMenuStripNeededEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowContextMenuStripNeededEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowContextMenuStripNeededEventHandler");
