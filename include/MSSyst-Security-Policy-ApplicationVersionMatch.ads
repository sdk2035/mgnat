...
package MSSyst.Security.Policy.ApplicationVersionMatch is
   type ValueType is (
      MatchExactVersion,
      MatchAllVersions);
...
end MSSyst.Security.Policy.ApplicationVersionMatch;
pragma Import(MSIL,MSSyst.Security.Policy.ApplicationVersionMatch,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Policy.ApplicationVersionMatch");
