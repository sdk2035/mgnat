...
limited with MSSyst.Windows.Forms.SelectedGridItemChangedEventArgs;
package MSSyst.Windows.Forms.SelectedGridItemChangedEventHandler is
   ...
   function new_SelectedGridItemChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.SelectedGridItemChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SelectedGridItemChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.SelectedGridItemChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.SelectedGridItemChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.SelectedGridItemChangedEventHandler");
