...
package MSSyst.Windows.Forms.DragAction is
   type ValueType is (
      Continue,
      Drop,
      Cancel);
...
end MSSyst.Windows.Forms.DragAction;
pragma Import(MSIL,MSSyst.Windows.Forms.DragAction,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DragAction");
