...
package MSSyst.Security.Principal.TokenAccessLevels is
   type ValueType is (
      AssignPrimary,
      Duplicate,
      Impersonate,
...
end MSSyst.Security.Principal.TokenAccessLevels;
pragma Import(MSIL,MSSyst.Security.Principal.TokenAccessLevels,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Principal.TokenAccessLevels");
