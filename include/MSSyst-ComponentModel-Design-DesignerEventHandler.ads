...
limited with MSSyst.ComponentModel.Design.DesignerEventArgs;
...
package MSSyst.ComponentModel.Design.DesignerEventHandler is
   ...
   function new_DesignerEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.Design.DesignerEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DesignerEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.Design.DesignerEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.Design.DesignerEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.Design.DesignerEventHandler");
