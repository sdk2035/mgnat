...
limited with MSSyst.Windows.Forms.QueryAccessibilityHelpEventArgs;
package MSSyst.Windows.Forms.QueryAccessibilityHelpEventHandler is
   ...
   function new_QueryAccessibilityHelpEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.QueryAccessibilityHelpEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_QueryAccessibilityHelpEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.QueryAccessibilityHelpEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.QueryAccessibilityHelpEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.QueryAccessibilityHelpEventHandler");
