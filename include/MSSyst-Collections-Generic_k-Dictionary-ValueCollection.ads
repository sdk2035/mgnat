...
package MSSyst.Collections.Generic_k.Dictionary.ValueCollection is
...
end MSSyst.Collections.Generic_k.Dictionary.ValueCollection;
pragma Import(MSIL,MSSyst.Collections.Generic_k.Dictionary.ValueCollection,
