...
limited with MSSyst.Windows.Forms.DataGridViewColumnEventArgs;
package MSSyst.Windows.Forms.DataGridViewColumnEventHandler is
   ...
   function new_DataGridViewColumnEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewColumnEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewColumnEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewColumnEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewColumnEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewColumnEventHandler");
