...
limited with MSSyst.Windows.Forms.DataGridViewRowHeightInfoNeededEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowHeightInfoNeededEventHandler is
   ...
   function new_DataGridViewRowHeightInfoNeededEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowHeightInfoNeededEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowHeightInfoNeededEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowHeightInfoNeededEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowHeightInfoNeededEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowHeightInfoNeededEventHandler");
