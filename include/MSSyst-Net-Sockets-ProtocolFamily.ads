...
package MSSyst.Net.Sockets.ProtocolFamily is
   type ValueType is (
      Unknown,
      Unspecified,
      Unix,
   ...
   Ipx : constant Valuetype := NS;
   Iso : constant Valuetype := Osi;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.Net.Sockets.ProtocolFamily;
pragma Import(MSIL,MSSyst.Net.Sockets.ProtocolFamily,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.Sockets.ProtocolFamily");
