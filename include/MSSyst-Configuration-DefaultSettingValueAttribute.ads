...
package MSSyst.Configuration.DefaultSettingValueAttribute is
   ...
   function new_DefaultSettingValueAttribute(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_DefaultSettingValueAttribute);
   pragma Import(MSIL,get_Value,"get_Value");
end MSSyst.Configuration.DefaultSettingValueAttribute;
pragma Import(MSIL,MSSyst.Configuration.DefaultSettingValueAttribute,
