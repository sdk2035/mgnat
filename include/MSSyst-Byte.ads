...
package MSSyst.Byte is
   ...
   function Equals(
      This : Valuetype;
      obj : MSIL_Types.unsigned_int8) return Standard.Boolean;
   function Equals(
      This : Valuetype;
   ...
   function Parse(
      s : access MSSyst.String.Typ'Class;
      style : MSSyst.Globalization.NumberStyles.Valuetype) return MSIL_Types.unsigned_int8;
   function Parse(
      s : access MSSyst.String.Typ'Class) return MSIL_Types.unsigned_int8;
   function Parse(
      s : access MSSyst.String.Typ'Class;
      provider : access MSSyst.IFormatProvider.Typ'Class) return MSIL_Types.unsigned_int8;
   function ToString(
   ...
   function TryParse(
      s : access MSSyst.String.Typ'Class;
      result : MSIL_Types.unsigned_int8_addrof) return Standard.Boolean;
   function TryParse(
      s : access MSSyst.String.Typ'Class;
      style : MSSyst.Globalization.NumberStyles.Valuetype;
...
pragma Import(MSIL,MSSyst.Byte,
