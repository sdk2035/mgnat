...
package MSSyst.Security.Principal.WindowsBuiltInRole is
   type ValueType is (
      Administrator,
      User,
      Guest,
...
end MSSyst.Security.Principal.WindowsBuiltInRole;
pragma Import(MSIL,MSSyst.Security.Principal.WindowsBuiltInRole,
