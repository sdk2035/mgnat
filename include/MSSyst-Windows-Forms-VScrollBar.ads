...
package MSSyst.Windows.Forms.VScrollBar is
...
private
   ...
   pragma MSIL_Constructor(new_VScrollBar);
...
end MSSyst.Windows.Forms.VScrollBar;
pragma Import(MSIL,MSSyst.Windows.Forms.VScrollBar,
