...
package MSSyst.Security.Permissions.UIPermissionClipboard is
   type ValueType is (
      NoClipboard,
      OwnClipboard,
      AllClipboard);
...
end MSSyst.Security.Permissions.UIPermissionClipboard;
pragma Import(MSIL,MSSyst.Security.Permissions.UIPermissionClipboard,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.UIPermissionClipboard");
