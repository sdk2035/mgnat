...
package MSSyst.ArgumentException is
...
private
   ...
   pragma MSIL_Constructor(new_ArgumentException);
   pragma Import(MSIL,get_Message,"get_Message");
   pragma Import(MSIL,get_ParamName,"get_ParamName");
   pragma Import(MSIL,GetObjectData,"GetObjectData");
end MSSyst.ArgumentException;
pragma Import(MSIL,MSSyst.ArgumentException,
