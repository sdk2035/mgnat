...
limited with MSSyst.Security.AccessControl.EventWaitHandleAccessRule;
limited with MSSyst.Security.AccessControl.EventWaitHandleAuditRule;
...
package MSSyst.Security.AccessControl.EventWaitHandleSecurity is
   ...
   procedure AddAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.EventWaitHandleAccessRule.Typ'Class);
   procedure AddAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.EventWaitHandleAuditRule.Typ'Class);
   ...
   function RemoveAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.EventWaitHandleAccessRule.Typ'Class) return Standard.Boolean;
   ...
   function RemoveAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.EventWaitHandleAuditRule.Typ'Class) return Standard.Boolean;
