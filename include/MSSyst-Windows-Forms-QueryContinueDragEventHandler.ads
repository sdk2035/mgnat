...
limited with MSSyst.Windows.Forms.QueryContinueDragEventArgs;
package MSSyst.Windows.Forms.QueryContinueDragEventHandler is
   ...
   function new_QueryContinueDragEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.QueryContinueDragEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_QueryContinueDragEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.QueryContinueDragEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.QueryContinueDragEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.QueryContinueDragEventHandler");
