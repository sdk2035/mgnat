...
package MSSyst.Text.NormalizationForm is
   type ValueType is (
      FormC,
      FormD,
      FormKC,
...
end MSSyst.Text.NormalizationForm;
pragma Import(MSIL,MSSyst.Text.NormalizationForm,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Text.NormalizationForm");
