...
limited with MSSyst.Windows.Forms.DataGridViewCellContextMenuStripNeededEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellContextMenuStripNeededEventHandler is
   ...
   function new_DataGridViewCellContextMenuStripNeededEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellContextMenuStripNeededEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellContextMenuStripNeededEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellContextMenuStripNeededEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellContextMenuStripNeededEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellContextMenuStripNeededEventHandler");
