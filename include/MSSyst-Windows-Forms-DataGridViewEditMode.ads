...
package MSSyst.Windows.Forms.DataGridViewEditMode is
   type ValueType is (
      EditOnEnter,
      EditOnKeystroke,
      EditOnKeystrokeOrF2,
...
end MSSyst.Windows.Forms.DataGridViewEditMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewEditMode,
