...
limited with MSSyst.Windows.Forms.ConvertEventArgs;
package MSSyst.Windows.Forms.ConvertEventHandler is
   ...
   function new_ConvertEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ConvertEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ConvertEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ConvertEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ConvertEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ConvertEventHandler");
