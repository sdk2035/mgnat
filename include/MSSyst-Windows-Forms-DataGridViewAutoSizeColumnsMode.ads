...
package MSSyst.Windows.Forms.DataGridViewAutoSizeColumnsMode is
   type ValueType is (
      None,
      ColumnHeader,
...
end MSSyst.Windows.Forms.DataGridViewAutoSizeColumnsMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewAutoSizeColumnsMode,
