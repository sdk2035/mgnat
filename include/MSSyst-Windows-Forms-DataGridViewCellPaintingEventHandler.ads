...
limited with MSSyst.Windows.Forms.DataGridViewCellPaintingEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellPaintingEventHandler is
   ...
   function new_DataGridViewCellPaintingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellPaintingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellPaintingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellPaintingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellPaintingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellPaintingEventHandler");
