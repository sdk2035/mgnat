...
package MSSyst.Security.AccessControl.InheritanceFlags is
   type ValueType is (
      None,
      ContainerInherit,
      ObjectInherit);
...
end MSSyst.Security.AccessControl.InheritanceFlags;
pragma Import(MSIL,MSSyst.Security.AccessControl.InheritanceFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.InheritanceFlags");
