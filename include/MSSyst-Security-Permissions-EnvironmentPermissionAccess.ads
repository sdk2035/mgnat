...
package MSSyst.Security.Permissions.EnvironmentPermissionAccess is
   type ValueType is (
      NoAccess,
      Read,
      Write,
...
end MSSyst.Security.Permissions.EnvironmentPermissionAccess;
pragma Import(MSIL,MSSyst.Security.Permissions.EnvironmentPermissionAccess,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.EnvironmentPermissionAccess");
