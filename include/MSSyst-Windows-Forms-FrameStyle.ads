...
package MSSyst.Windows.Forms.FrameStyle is
   type ValueType is (
      Dashed,
      Thick);
...
end MSSyst.Windows.Forms.FrameStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.FrameStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.FrameStyle");
