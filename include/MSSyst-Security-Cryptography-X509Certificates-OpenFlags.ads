...
package MSSyst.Security.Cryptography.X509Certificates.OpenFlags is
   type ValueType is (
      ReadOnly,
      ReadWrite,
      MaxAllowed,
...
end MSSyst.Security.Cryptography.X509Certificates.OpenFlags;
pragma Import(MSIL,MSSyst.Security.Cryptography.X509Certificates.OpenFlags,
