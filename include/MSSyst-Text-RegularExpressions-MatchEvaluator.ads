...
package MSSyst.Text.RegularExpressions.MatchEvaluator is
   ...
   function EndInvoke(
      This : access Typ;
      result : access MSSyst.IAsyncResult.Typ'Class) return access MSSyst.String.Typ'Class;
   function Invoke(
      This : access Typ;
      match : access MSSyst.Text.RegularExpressions.Match.Typ'Class) return access MSSyst.String.Typ'Class;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_MatchEvaluator);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Text.RegularExpressions.MatchEvaluator;
pragma Import(MSIL,MSSyst.Text.RegularExpressions.MatchEvaluator,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Text.RegularExpressions.MatchEvaluator");
