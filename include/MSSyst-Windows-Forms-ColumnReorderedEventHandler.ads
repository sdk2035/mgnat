...
limited with MSSyst.Windows.Forms.ColumnReorderedEventArgs;
package MSSyst.Windows.Forms.ColumnReorderedEventHandler is
   ...
   function new_ColumnReorderedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ColumnReorderedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ColumnReorderedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ColumnReorderedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ColumnReorderedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ColumnReorderedEventHandler");
