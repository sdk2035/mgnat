...
package MSSyst.Windows.Forms.ToolStripGripStyle is
   type ValueType is (
      Hidden,
      Visible);
...
end MSSyst.Windows.Forms.ToolStripGripStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripGripStyle,
