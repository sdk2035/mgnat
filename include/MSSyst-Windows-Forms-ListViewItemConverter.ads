...
package MSSyst.Windows.Forms.ListViewItemConverter is
   ...
   function new_ListViewItemConverter(
...
private
   ...
   pragma MSIL_Constructor(new_ListViewItemConverter);
   pragma Import(MSIL,CanConvertTo,"CanConvertTo");
   pragma Import(MSIL,ConvertTo,"ConvertTo");
end MSSyst.Windows.Forms.ListViewItemConverter;
pragma Import(MSIL,MSSyst.Windows.Forms.ListViewItemConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ListViewItemConverter");
