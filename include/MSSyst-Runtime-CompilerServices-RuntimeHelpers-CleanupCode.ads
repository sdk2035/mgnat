...
with MSSyst.Runtime.CompilerServices.RuntimeHelpers;
...
package MSSyst.Runtime.CompilerServices.RuntimeHelpers.CleanupCode is
...
private
   ...
   pragma MSIL_Constructor(new_CleanupCode);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Runtime.CompilerServices.RuntimeHelpers.CleanupCode;
pragma Import(MSIL,MSSyst.Runtime.CompilerServices.RuntimeHelpers.CleanupCode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.CompilerServices.RuntimeHelpers/CleanupCode");
