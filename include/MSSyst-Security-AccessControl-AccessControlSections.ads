...
package MSSyst.Security.AccessControl.AccessControlSections is
   type ValueType is (
      None,
      Audit,
      Access_k,
...
end MSSyst.Security.AccessControl.AccessControlSections;
pragma Import(MSIL,MSSyst.Security.AccessControl.AccessControlSections,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.AccessControlSections");
