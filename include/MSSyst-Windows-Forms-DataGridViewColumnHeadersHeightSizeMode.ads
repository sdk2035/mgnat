...
package MSSyst.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode is
   type ValueType is (
      EnableResizing,
      DisableResizing,
      AutoSize);
...
end MSSyst.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode,
