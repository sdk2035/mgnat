...
package MSSyst.Security.Cryptography.OidEnumerator is
...
end MSSyst.Security.Cryptography.OidEnumerator;
pragma Import(MSIL,MSSyst.Security.Cryptography.OidEnumerator,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Cryptography.OidEnumerator");
