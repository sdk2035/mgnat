...
package MSSyst.Threading.WaitCallback is
...
private
   ...
   pragma MSIL_Constructor(new_WaitCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.WaitCallback;
pragma Import(MSIL,MSSyst.Threading.WaitCallback,
