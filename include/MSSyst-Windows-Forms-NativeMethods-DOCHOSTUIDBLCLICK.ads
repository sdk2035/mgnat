...
package MSSyst.Windows.Forms.NativeMethods.DOCHOSTUIDBLCLICK is
   type ValueType is (
      DEFAULT,
      SHOWPROPERTIES,
      SHOWCODE);
...
end MSSyst.Windows.Forms.NativeMethods.DOCHOSTUIDBLCLICK;
pragma Import(MSIL,MSSyst.Windows.Forms.NativeMethods.DOCHOSTUIDBLCLICK,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NativeMethods/DOCHOSTUIDBLCLICK");
