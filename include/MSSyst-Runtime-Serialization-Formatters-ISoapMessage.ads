...
package MSSyst.Runtime.Serialization.Formatters.ISoapMessage is
   ...
   function get_Headers(
      This : access Typ) return access MSSyst.Runtime.Remoting.Messaging.Header.Ref_arr is abstract;
   ...
   procedure set_Headers(
      This : access Typ;
      value : access MSSyst.Runtime.Remoting.Messaging.Header.Ref_arr) is abstract;
