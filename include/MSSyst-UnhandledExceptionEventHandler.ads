...
limited with MSSyst.UnhandledExceptionEventArgs;
package MSSyst.UnhandledExceptionEventHandler is
   ...
   function new_UnhandledExceptionEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.UnhandledExceptionEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UnhandledExceptionEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.UnhandledExceptionEventHandler;
pragma Import(MSIL,MSSyst.UnhandledExceptionEventHandler,
