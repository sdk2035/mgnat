...
package MSSyst.ComponentModel.UInt16Converter is
   ...
   function new_UInt16Converter(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_UInt16Converter);
end MSSyst.ComponentModel.UInt16Converter;
pragma Import(MSIL,MSSyst.ComponentModel.UInt16Converter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.UInt16Converter");
