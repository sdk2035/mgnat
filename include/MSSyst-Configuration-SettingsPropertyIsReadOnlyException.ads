...
package MSSyst.Configuration.SettingsPropertyIsReadOnlyException is
   ...
   function new_SettingsPropertyIsReadOnlyException(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_SettingsPropertyIsReadOnlyException);
end MSSyst.Configuration.SettingsPropertyIsReadOnlyException;
pragma Import(MSIL,MSSyst.Configuration.SettingsPropertyIsReadOnlyException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Configuration.SettingsPropertyIsReadOnlyException");
