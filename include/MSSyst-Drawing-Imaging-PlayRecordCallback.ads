...
package MSSyst.Drawing.Imaging.PlayRecordCallback is
   ...
   function new_PlayRecordCallback(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      flags : Integer;
      dataSize : Integer;
      recordData : MSIL_Types.native_int;
...
private
   ...
   pragma MSIL_Constructor(new_PlayRecordCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Drawing.Imaging.PlayRecordCallback;
pragma Import(MSIL,MSSyst.Drawing.Imaging.PlayRecordCallback,
   ".ver 2:0:0:0 .publickeytoken=( b0 3f 5f 7f 11 d5 0a 3a )",
   "[System.Drawing]System.Drawing.Imaging.PlayRecordCallback");
