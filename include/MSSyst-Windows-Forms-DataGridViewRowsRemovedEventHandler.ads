...
limited with MSSyst.Windows.Forms.DataGridViewRowsRemovedEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowsRemovedEventHandler is
   ...
   function new_DataGridViewRowsRemovedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowsRemovedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowsRemovedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowsRemovedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowsRemovedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowsRemovedEventHandler");
