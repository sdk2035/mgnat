...
with MSIL_Types;
use MSIL_Types;
with MSSyst.ActivationContext;
limited with MSSyst.IFormatProvider;
limited with MSSyst.String;
limited with MSSyst.TypeCode;
limited with MSSyst.Type_k;
package MSSyst.ActivationContext.ContextForm is
   type ValueType is (
      Loose,
      StoreBounded);
...
end MSSyst.ActivationContext.ContextForm;
pragma Import(MSIL,MSSyst.ActivationContext.ContextForm,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.ActivationContext/ContextForm");
