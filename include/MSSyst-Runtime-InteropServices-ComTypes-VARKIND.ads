...
package MSSyst.Runtime.InteropServices.ComTypes.VARKIND is
   type ValueType is (
      VAR_PERINSTANCE,
      VAR_STATIC,
      VAR_CONST,
...
end MSSyst.Runtime.InteropServices.ComTypes.VARKIND;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.ComTypes.VARKIND,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.InteropServices.ComTypes.VARKIND");
