...
package MSSyst.Windows.Forms.ItemActivation is
   type ValueType is (
      Standard_k,
      OneClick,
      TwoClick);
...
end MSSyst.Windows.Forms.ItemActivation;
pragma Import(MSIL,MSSyst.Windows.Forms.ItemActivation,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ItemActivation");
