...
limited with MSSyst.Windows.Forms.TabControlEventArgs;
package MSSyst.Windows.Forms.TabControlEventHandler is
   ...
   function new_TabControlEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.TabControlEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_TabControlEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.TabControlEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.TabControlEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TabControlEventHandler");
