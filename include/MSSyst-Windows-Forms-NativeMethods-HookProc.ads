...
package MSSyst.Windows.Forms.NativeMethods.HookProc is
   ...
   function Invoke(
      ...
      nCode : Integer;
      wParam : MSIL_Types.native_int;
      lParam : MSIL_Types.native_int) return MSIL_Types.native_int;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_HookProc);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.NativeMethods.HookProc;
pragma Import(MSIL,MSSyst.Windows.Forms.NativeMethods.HookProc,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NativeMethods/HookProc");
