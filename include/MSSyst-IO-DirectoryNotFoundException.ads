...
package MSSyst.IO.DirectoryNotFoundException is
   ...
   function new_DirectoryNotFoundException(
...
private
   ...
   pragma MSIL_Constructor(new_DirectoryNotFoundException);
end MSSyst.IO.DirectoryNotFoundException;
pragma Import(MSIL,MSSyst.IO.DirectoryNotFoundException,
