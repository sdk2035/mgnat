...
package MSSyst.Windows.Forms.TabDrawMode is
   type ValueType is (
      Normal,
      OwnerDrawFixed);
...
end MSSyst.Windows.Forms.TabDrawMode;
pragma Import(MSIL,MSSyst.Windows.Forms.TabDrawMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TabDrawMode");
