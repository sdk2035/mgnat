...
package MSSyst.Runtime.ConstrainedExecution.Cer is
   type ValueType is (
      None,
      MayFail,
      Success);
...
end MSSyst.Runtime.ConstrainedExecution.Cer;
pragma Import(MSIL,MSSyst.Runtime.ConstrainedExecution.Cer,
