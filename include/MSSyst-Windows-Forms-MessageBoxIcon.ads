...
package MSSyst.Windows.Forms.MessageBoxIcon is
   type ValueType is (
      None,
      Stop,
      Question,
   ...
   Error : constant Valuetype := Stop;
   Hand : constant Valuetype := Stop;
   Exclamation : constant Valuetype := Warning;
   Asterisk : constant Valuetype := Information;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.Windows.Forms.MessageBoxIcon;
pragma Import(MSIL,MSSyst.Windows.Forms.MessageBoxIcon,
