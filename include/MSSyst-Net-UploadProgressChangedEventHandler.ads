...
limited with MSSyst.Net.UploadProgressChangedEventArgs;
...
package MSSyst.Net.UploadProgressChangedEventHandler is
   ...
   function new_UploadProgressChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.UploadProgressChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UploadProgressChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.UploadProgressChangedEventHandler;
pragma Import(MSIL,MSSyst.Net.UploadProgressChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.UploadProgressChangedEventHandler");
