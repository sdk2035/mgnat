...
package MSSyst.Security.Cryptography.CipherMode is
   type ValueType is (
      CBC,
      ECB,
      OFB,
...
end MSSyst.Security.Cryptography.CipherMode;
pragma Import(MSIL,MSSyst.Security.Cryptography.CipherMode,
