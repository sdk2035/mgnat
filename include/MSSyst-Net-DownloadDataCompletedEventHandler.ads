...
limited with MSSyst.Net.DownloadDataCompletedEventArgs;
...
package MSSyst.Net.DownloadDataCompletedEventHandler is
   ...
   function new_DownloadDataCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.DownloadDataCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DownloadDataCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.DownloadDataCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.DownloadDataCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.DownloadDataCompletedEventHandler");
