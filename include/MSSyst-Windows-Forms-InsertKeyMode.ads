...
package MSSyst.Windows.Forms.InsertKeyMode is
   type ValueType is (
      Default,
      Insert,
      Overwrite);
...
end MSSyst.Windows.Forms.InsertKeyMode;
pragma Import(MSIL,MSSyst.Windows.Forms.InsertKeyMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.InsertKeyMode");
