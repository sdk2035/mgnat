...
package MSSyst.Windows.Forms.DataGridViewCellStyleConverter is
   ...
   function new_DataGridViewCellStyleConverter(
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellStyleConverter);
   pragma Import(MSIL,CanConvertTo,"CanConvertTo");
   pragma Import(MSIL,ConvertTo,"ConvertTo");
end MSSyst.Windows.Forms.DataGridViewCellStyleConverter;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellStyleConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellStyleConverter");
