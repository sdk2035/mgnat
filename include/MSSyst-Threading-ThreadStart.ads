...
package MSSyst.Threading.ThreadStart is
...
private
   ...
   pragma MSIL_Constructor(new_ThreadStart);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.ThreadStart;
pragma Import(MSIL,MSSyst.Threading.ThreadStart,
