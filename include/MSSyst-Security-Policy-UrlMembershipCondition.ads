...
package MSSyst.Security.Policy.UrlMembershipCondition is
   ...
   function new_UrlMembershipCondition(
      This : Ref := null;
      url : access MSSyst.String.Typ'Class) return Ref;
   function Check(
      This : access Typ;
...
private
   ...
   pragma MSIL_Constructor(new_UrlMembershipCondition);
...
end MSSyst.Security.Policy.UrlMembershipCondition;
pragma Import(MSIL,MSSyst.Security.Policy.UrlMembershipCondition,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Policy.UrlMembershipCondition");
