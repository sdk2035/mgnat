...
package MSSyst.Threading.IOCompletionCallback is
   ...
   function new_IOCompletionCallback(
      This : Ref := null;
      object : access MSSyst.Object.Typ'Class;
      method : MSIL_Types.native_int) return Ref;
   function BeginInvoke(
      This : access Typ;
      errorCode : MSIL_Types.Unsigned_Integer;
      numBytes : MSIL_Types.Unsigned_Integer;
      pOVERLAP : access MSSyst.Threading.NativeOverlapped.Valuetype;
...
private
   ...
   pragma MSIL_Constructor(new_IOCompletionCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.IOCompletionCallback;
pragma Import(MSIL,MSSyst.Threading.IOCompletionCallback,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Threading.IOCompletionCallback");
