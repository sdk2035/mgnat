...
package MSSyst.Windows.Forms.DockingBehavior is
   type ValueType is (
      Never,
      Ask,
      AutoDock);
...
end MSSyst.Windows.Forms.DockingBehavior;
pragma Import(MSIL,MSSyst.Windows.Forms.DockingBehavior,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DockingBehavior");
