...
package MSSyst.Windows.Forms.VisualStyles.SizingType is
   type ValueType is (
      FixedSize,
      Stretch,
      Tile);
...
end MSSyst.Windows.Forms.VisualStyles.SizingType;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.SizingType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.SizingType");
