...
limited with MSSyst.Windows.Forms.AxHost.State;
...
package MSSyst.Windows.Forms.AxHost is
   ...
   function get_ContainingControl(
   ...
   function get_ForeColor(
      This : access Typ) return MSSyst.Drawing.Color.Valuetype;
   function get_HasAboutBox(
      This : access Typ) return Standard.Boolean;
   function get_ImeMode(
      This : access Typ) return MSSyst.Windows.Forms.ImeMode.Valuetype;
   function get_OcxState(
      This : access Typ) return access MSSyst.Windows.Forms.AxHost.State.Typ'Class;
   ...
   procedure set_ContainingControl(
      This : access Typ;
   ...
   procedure set_OcxState(
      This : access Typ;
      value : access MSSyst.Windows.Forms.AxHost.State.Typ'Class);
...
private
   ...
   pragma Import(MSIL,get_ContainingControl,"get_ContainingControl");
   ...
   pragma Import(MSIL,get_HasAboutBox,"get_HasAboutBox");
   pragma Import(MSIL,get_ImeMode,"get_ImeMode");
   pragma Import(MSIL,get_OcxState,"get_OcxState");
   pragma Import(MSIL,get_RightToLeft,"get_RightToLeft");
   pragma Import(MSIL,get_Text,"get_Text");
   pragma Import(MSIL,GetOcx,"GetOcx");
   pragma Import(MSIL,HasPropertyPages,"HasPropertyPages");
   pragma Import(MSIL,InvokeEditMode,"InvokeEditMode");
   pragma Import(MSIL,MakeDirty,"MakeDirty");
   ...
   pragma Import(MSIL,set_ContainingControl,"set_ContainingControl");
   ...
   pragma Import(MSIL,set_OcxState,"set_OcxState");
   ...
   pragma Import(MSIL,ShowAboutBox,"ShowAboutBox");
   pragma Import(MSIL,ShowPropertyPages,"ShowPropertyPages");
end MSSyst.Windows.Forms.AxHost;
pragma Import(MSIL,MSSyst.Windows.Forms.AxHost,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.AxHost");
