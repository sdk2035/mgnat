...
limited with MSSyst.Windows.Forms.ScrollEventArgs;
package MSSyst.Windows.Forms.ScrollEventHandler is
   ...
   function new_ScrollEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ScrollEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ScrollEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ScrollEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ScrollEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ScrollEventHandler");
