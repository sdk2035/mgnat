...
with MSIL_Types;
use MSIL_Types;
with MSSyst.Collections.Generic_k.TreeSet;
limited with MSSyst.String;
limited with MSSyst.Type_k;
with MSSyst.ValueType;
generic
   type T is private;
package MSSyst.Collections.Generic_k.TreeSet.Enumerator is
...
end MSSyst.Collections.Generic_k.TreeSet.Enumerator;
pragma Import(MSIL,MSSyst.Collections.Generic_k.TreeSet.Enumerator,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Collections.Generic.TreeSet`1/Enumerator");
