...
package MSSyst.Windows.Forms.TickStyle is
   type ValueType is (
      None,
      TopLeft,
      BottomRight,
...
end MSSyst.Windows.Forms.TickStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.TickStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TickStyle");
