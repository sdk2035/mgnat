...
package MSSyst.IO.Ports.SerialPinChange is
   type ValueType is (
      CtsChanged,
      DsrChanged,
      CDChanged,
...
end MSSyst.IO.Ports.SerialPinChange;
pragma Import(MSIL,MSSyst.IO.Ports.SerialPinChange,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.IO.Ports.SerialPinChange");
