...
package MSSyst.Windows.Forms.DataGridViewContentAlignment is
   type ValueType is (
      NotSet,
      TopLeft,
      TopCenter,
...
end MSSyst.Windows.Forms.DataGridViewContentAlignment;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewContentAlignment,
