...
limited with MSSyst.Windows.Forms.DataGridViewAutoSizeModeEventArgs;
package MSSyst.Windows.Forms.DataGridViewAutoSizeModeEventHandler is
   ...
   function new_DataGridViewAutoSizeModeEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewAutoSizeModeEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewAutoSizeModeEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewAutoSizeModeEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewAutoSizeModeEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewAutoSizeModeEventHandler");
