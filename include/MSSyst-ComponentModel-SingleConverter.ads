...
package MSSyst.ComponentModel.SingleConverter is
   ...
   function new_SingleConverter(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_SingleConverter);
end MSSyst.ComponentModel.SingleConverter;
pragma Import(MSIL,MSSyst.ComponentModel.SingleConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.SingleConverter");
