...
limited with MSSyst.Windows.Forms.FormClosedEventArgs;
package MSSyst.Windows.Forms.FormClosedEventHandler is
   ...
   function new_FormClosedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.FormClosedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_FormClosedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.FormClosedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.FormClosedEventHandler,
