...
package MSSyst.Runtime.InteropServices.ObjectCreationDelegate is
   ...
   function EndInvoke(
      This : access Typ;
      result : access MSSyst.IAsyncResult.Typ'Class) return MSIL_Types.native_int;
   function Invoke(
      This : access Typ;
      aggregator : MSIL_Types.native_int) return MSIL_Types.native_int;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_ObjectCreationDelegate);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Runtime.InteropServices.ObjectCreationDelegate;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.ObjectCreationDelegate,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.InteropServices.ObjectCreationDelegate");
