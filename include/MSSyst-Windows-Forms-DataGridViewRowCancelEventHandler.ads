...
limited with MSSyst.Windows.Forms.DataGridViewRowCancelEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowCancelEventHandler is
   ...
   function new_DataGridViewRowCancelEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowCancelEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowCancelEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowCancelEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowCancelEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowCancelEventHandler");
