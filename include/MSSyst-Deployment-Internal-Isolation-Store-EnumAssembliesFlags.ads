...
package MSSyst.Deployment.Internal.Isolation.Store.EnumAssembliesFlags is
   type ValueType is (
      Nothing,
      VisibleOnly,
      MatchServicing,
      ForceLibrarySemantics);
...
end MSSyst.Deployment.Internal.Isolation.Store.EnumAssembliesFlags;
pragma Import(MSIL,MSSyst.Deployment.Internal.Isolation.Store.EnumAssembliesFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Deployment.Internal.Isolation.Store/EnumAssembliesFlags");
