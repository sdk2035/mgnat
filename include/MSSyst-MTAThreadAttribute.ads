...
package MSSyst.MTAThreadAttribute is
   ...
   function new_MTAThreadAttribute(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_MTAThreadAttribute);
end MSSyst.MTAThreadAttribute;
pragma Import(MSIL,MSSyst.MTAThreadAttribute,
