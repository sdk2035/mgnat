...
package MSSyst.Threading.SendOrPostCallback is
   ...
   function new_SendOrPostCallback(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_SendOrPostCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.SendOrPostCallback;
pragma Import(MSIL,MSSyst.Threading.SendOrPostCallback,
