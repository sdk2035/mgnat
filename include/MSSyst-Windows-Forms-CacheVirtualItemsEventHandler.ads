...
limited with MSSyst.Windows.Forms.CacheVirtualItemsEventArgs;
package MSSyst.Windows.Forms.CacheVirtualItemsEventHandler is
   ...
   function new_CacheVirtualItemsEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.CacheVirtualItemsEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_CacheVirtualItemsEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.CacheVirtualItemsEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.CacheVirtualItemsEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.CacheVirtualItemsEventHandler");
