...
limited with MSSyst.Windows.Forms.DrawTreeNodeEventArgs;
package MSSyst.Windows.Forms.DrawTreeNodeEventHandler is
   ...
   function new_DrawTreeNodeEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DrawTreeNodeEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DrawTreeNodeEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DrawTreeNodeEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DrawTreeNodeEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DrawTreeNodeEventHandler");
