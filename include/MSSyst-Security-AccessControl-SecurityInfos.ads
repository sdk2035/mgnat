...
package MSSyst.Security.AccessControl.SecurityInfos is
   type ValueType is (
      Owner,
      Group,
      DiscretionaryAcl,
...
end MSSyst.Security.AccessControl.SecurityInfos;
pragma Import(MSIL,MSSyst.Security.AccessControl.SecurityInfos,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.SecurityInfos");
