...
package MSSyst.Security.Policy.ApplicationTrustEnumerator is
...
end MSSyst.Security.Policy.ApplicationTrustEnumerator;
pragma Import(MSIL,MSSyst.Security.Policy.ApplicationTrustEnumerator,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Policy.ApplicationTrustEnumerator");
