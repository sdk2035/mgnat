...
package MSSyst.Windows.Forms.VisualStyles.GroupBoxState is
   type ValueType is (
      Normal,
      Disabled);
...
end MSSyst.Windows.Forms.VisualStyles.GroupBoxState;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.GroupBoxState,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.GroupBoxState");
