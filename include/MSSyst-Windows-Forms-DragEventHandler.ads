...
package MSSyst.Windows.Forms.DragEventHandler is
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DragEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DragEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DragEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DragEventHandler,
