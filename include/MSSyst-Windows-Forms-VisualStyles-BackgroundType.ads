...
package MSSyst.Windows.Forms.VisualStyles.BackgroundType is
   type ValueType is (
      ImageFile,
      BorderFill,
      None);
...
end MSSyst.Windows.Forms.VisualStyles.BackgroundType;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.BackgroundType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.BackgroundType");
