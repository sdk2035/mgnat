...
package MSSyst.Windows.Forms.ToolStripItemDisplayStyle is
   type ValueType is (
      None,
      Text,
      Image,
...
end MSSyst.Windows.Forms.ToolStripItemDisplayStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripItemDisplayStyle,
