...
use MSIL_Types;
with MSSyst.Guid;
package MSSyst.Runtime.InteropServices.uModule is
...
end MSSyst.Runtime.InteropServices.uModule;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.uModule,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.InteropServices._Module");
