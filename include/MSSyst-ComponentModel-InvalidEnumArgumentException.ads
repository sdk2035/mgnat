...
package MSSyst.ComponentModel.InvalidEnumArgumentException is
   ...
   function new_InvalidEnumArgumentException(
   ...
   function new_InvalidEnumArgumentException(
      This : Ref := null;
      argumentName : access MSSyst.String.Typ'Class;
      invalidValue : Integer;
      enumClass : access MSSyst.Type_k.Typ'Class) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_InvalidEnumArgumentException);
end MSSyst.ComponentModel.InvalidEnumArgumentException;
pragma Import(MSIL,MSSyst.ComponentModel.InvalidEnumArgumentException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.InvalidEnumArgumentException");
