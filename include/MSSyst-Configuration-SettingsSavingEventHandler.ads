...
package MSSyst.Configuration.SettingsSavingEventHandler is
   ...
   function new_SettingsSavingEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_SettingsSavingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Configuration.SettingsSavingEventHandler;
pragma Import(MSIL,MSSyst.Configuration.SettingsSavingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Configuration.SettingsSavingEventHandler");
