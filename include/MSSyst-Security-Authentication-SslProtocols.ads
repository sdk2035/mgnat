...
package MSSyst.Security.Authentication.SslProtocols is
   type ValueType is (
      None,
      Ssl2,
      Ssl3,
...
end MSSyst.Security.Authentication.SslProtocols;
pragma Import(MSIL,MSSyst.Security.Authentication.SslProtocols,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Authentication.SslProtocols");
