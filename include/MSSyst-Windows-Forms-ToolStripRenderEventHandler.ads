...
package MSSyst.Windows.Forms.ToolStripRenderEventHandler is
   ...
   function new_ToolStripRenderEventHandler(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_ToolStripRenderEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolStripRenderEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripRenderEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripRenderEventHandler");
