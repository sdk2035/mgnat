...
package MSSyst.ComponentModel.Design.DesignerVerbCollection is
   ...
   function new_DesignerVerbCollection(
      This : Ref := null;
      value : access MSSyst.ComponentModel.Design.DesignerVerb.Ref_arr) return Ref;
   function Add(
      This : access Typ;
      value : access MSSyst.ComponentModel.Design.DesignerVerb.Typ'Class) return Integer;
   procedure AddRange(
      This : access Typ;
      value : access MSSyst.ComponentModel.Design.DesignerVerb.Ref_arr);
   procedure AddRange(
      This : access Typ;
      value : access MSSyst.ComponentModel.Design.DesignerVerbCollection.Typ'Class);
   function Contains(
      This : access Typ;
      value : access MSSyst.ComponentModel.Design.DesignerVerb.Typ'Class) return Standard.Boolean;
   procedure CopyTo(
      This : access Typ;
      array_k : access MSSyst.ComponentModel.Design.DesignerVerb.Ref_arr;
      index : Integer);
   function get_Item(
      This : access Typ;
      index : Integer) return access MSSyst.ComponentModel.Design.DesignerVerb.Typ'Class;
   function IndexOf(
      This : access Typ;
      value : access MSSyst.ComponentModel.Design.DesignerVerb.Typ'Class) return Integer;
   procedure Insert(
      This : access Typ;
      index : Integer;
      value : access MSSyst.ComponentModel.Design.DesignerVerb.Typ'Class);
   procedure Remove(
      This : access Typ;
      value : access MSSyst.ComponentModel.Design.DesignerVerb.Typ'Class);
   procedure set_Item(
