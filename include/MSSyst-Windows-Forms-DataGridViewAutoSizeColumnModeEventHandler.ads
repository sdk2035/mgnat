...
limited with MSSyst.Windows.Forms.DataGridViewAutoSizeColumnModeEventArgs;
package MSSyst.Windows.Forms.DataGridViewAutoSizeColumnModeEventHandler is
   ...
   function new_DataGridViewAutoSizeColumnModeEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewAutoSizeColumnModeEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewAutoSizeColumnModeEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewAutoSizeColumnModeEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewAutoSizeColumnModeEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewAutoSizeColumnModeEventHandler");
