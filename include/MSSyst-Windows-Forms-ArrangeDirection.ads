...
package MSSyst.Windows.Forms.ArrangeDirection is
   type ValueType is (
      Right,
      Up);
   ...
   pragma Import (MSIL, "+", "+");
   Left : constant Valuetype := Right;
   Down : constant Valuetype := Up;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.Windows.Forms.ArrangeDirection;
pragma Import(MSIL,MSSyst.Windows.Forms.ArrangeDirection,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ArrangeDirection");
