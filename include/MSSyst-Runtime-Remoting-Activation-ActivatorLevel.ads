...
package MSSyst.Runtime.Remoting.Activation.ActivatorLevel is
   type ValueType is (
      Construction,
      Context,
      AppDomain,
...
end MSSyst.Runtime.Remoting.Activation.ActivatorLevel;
pragma Import(MSIL,MSSyst.Runtime.Remoting.Activation.ActivatorLevel,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Remoting.Activation.ActivatorLevel");
