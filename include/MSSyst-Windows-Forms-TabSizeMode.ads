...
package MSSyst.Windows.Forms.TabSizeMode is
   type ValueType is (
      Normal,
      FillToRight,
      Fixed);
...
end MSSyst.Windows.Forms.TabSizeMode;
pragma Import(MSIL,MSSyst.Windows.Forms.TabSizeMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TabSizeMode");
