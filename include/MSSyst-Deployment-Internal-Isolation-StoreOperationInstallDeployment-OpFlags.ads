...
package MSSyst.Deployment.Internal.Isolation.StoreOperationInstallDeployment.OpFlags is
   type ValueType is (
      Nothing,
      UninstallOthers);
...
end MSSyst.Deployment.Internal.Isolation.StoreOperationInstallDeployment.OpFlags;
pragma Import(MSIL,MSSyst.Deployment.Internal.Isolation.StoreOperationInstallDeployment.OpFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Deployment.Internal.Isolation.StoreOperationInstallDeployment/OpFlags");
