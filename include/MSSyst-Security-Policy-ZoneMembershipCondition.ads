...
package MSSyst.Security.Policy.ZoneMembershipCondition is
   ...
   function new_ZoneMembershipCondition(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_ZoneMembershipCondition);
...
end MSSyst.Security.Policy.ZoneMembershipCondition;
pragma Import(MSIL,MSSyst.Security.Policy.ZoneMembershipCondition,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Policy.ZoneMembershipCondition");
