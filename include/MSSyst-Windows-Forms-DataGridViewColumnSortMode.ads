...
package MSSyst.Windows.Forms.DataGridViewColumnSortMode is
   type ValueType is (
      NotSortable,
      Automatic,
      Programmatic);
...
end MSSyst.Windows.Forms.DataGridViewColumnSortMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewColumnSortMode,
