...
package MSSyst.Windows.Forms.CaptionButton is
   type ValueType is (
      Close,
      Minimize,
      Maximize,
...
end MSSyst.Windows.Forms.CaptionButton;
pragma Import(MSIL,MSSyst.Windows.Forms.CaptionButton,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.CaptionButton");
