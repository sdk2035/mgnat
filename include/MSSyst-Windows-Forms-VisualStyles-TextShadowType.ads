...
package MSSyst.Windows.Forms.VisualStyles.TextShadowType is
   type ValueType is (
      None,
      Single,
      Continuous);
...
end MSSyst.Windows.Forms.VisualStyles.TextShadowType;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.TextShadowType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.TextShadowType");
