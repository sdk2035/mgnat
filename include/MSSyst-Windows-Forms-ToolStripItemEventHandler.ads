...
limited with MSSyst.Windows.Forms.ToolStripItemEventArgs;
package MSSyst.Windows.Forms.ToolStripItemEventHandler is
   ...
   function new_ToolStripItemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ToolStripItemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ToolStripItemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolStripItemEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripItemEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripItemEventHandler");
