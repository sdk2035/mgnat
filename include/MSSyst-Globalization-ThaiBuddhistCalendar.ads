...
package MSSyst.Globalization.ThaiBuddhistCalendar is
   type Typ is new MSSyst.Globalization.Calendar.Typ
         and MSSyst.ICloneable.Typ
   with record
      null;
   end record;
   ThaiBuddhistEra : Integer;
   pragma Import(MSIL,ThaiBuddhistEra,"ThaiBuddhistEra");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_ThaiBuddhistCalendar(
...
private
   ...
   pragma MSIL_Constructor(new_ThaiBuddhistCalendar);
...
end MSSyst.Globalization.ThaiBuddhistCalendar;
pragma Import(MSIL,MSSyst.Globalization.ThaiBuddhistCalendar,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.ThaiBuddhistCalendar");
