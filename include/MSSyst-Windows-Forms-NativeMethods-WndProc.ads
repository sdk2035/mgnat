...
package MSSyst.Windows.Forms.NativeMethods.WndProc is
...
private
   ...
   pragma MSIL_Constructor(new_WndProc);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.NativeMethods.WndProc;
pragma Import(MSIL,MSSyst.Windows.Forms.NativeMethods.WndProc,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NativeMethods/WndProc");
