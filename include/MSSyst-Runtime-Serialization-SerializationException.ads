...
package MSSyst.Runtime.Serialization.SerializationException is
   ...
   function new_SerializationException(
...
private
   ...
   pragma MSIL_Constructor(new_SerializationException);
end MSSyst.Runtime.Serialization.SerializationException;
pragma Import(MSIL,MSSyst.Runtime.Serialization.SerializationException,
