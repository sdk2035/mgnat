...
package MSSyst.Security.Permissions.ZoneIdentityPermissionAttribute is
   ...
   function new_ZoneIdentityPermissionAttribute(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_ZoneIdentityPermissionAttribute);
...
end MSSyst.Security.Permissions.ZoneIdentityPermissionAttribute;
pragma Import(MSIL,MSSyst.Security.Permissions.ZoneIdentityPermissionAttribute,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.ZoneIdentityPermissionAttribute");
