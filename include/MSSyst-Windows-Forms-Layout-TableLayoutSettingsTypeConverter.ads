...
package MSSyst.Windows.Forms.Layout.TableLayoutSettingsTypeConverter is
   ...
   function new_TableLayoutSettingsTypeConverter(
...
private
   ...
   pragma MSIL_Constructor(new_TableLayoutSettingsTypeConverter);
...
end MSSyst.Windows.Forms.Layout.TableLayoutSettingsTypeConverter;
pragma Import(MSIL,MSSyst.Windows.Forms.Layout.TableLayoutSettingsTypeConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.Layout.TableLayoutSettingsTypeConverter");
