...
package MSSyst.Security.Cryptography.AsymmetricSignatureFormatter is
   ...
   function CreateSignature(
      This : access Typ;
      hash : access MSSyst.Security.Cryptography.HashAlgorithm.Typ'Class) return MSIL_Types.unsigned_int8_Array;
   function CreateSignature(
      This : access Typ;
...
end MSSyst.Security.Cryptography.AsymmetricSignatureFormatter;
pragma Import(MSIL,MSSyst.Security.Cryptography.AsymmetricSignatureFormatter,
