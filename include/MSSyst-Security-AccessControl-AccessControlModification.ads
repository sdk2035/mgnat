...
package MSSyst.Security.AccessControl.AccessControlModification is
   type ValueType is (
      Add,
      Set,
      Reset,
...
end MSSyst.Security.AccessControl.AccessControlModification;
pragma Import(MSIL,MSSyst.Security.AccessControl.AccessControlModification,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.AccessControlModification");
