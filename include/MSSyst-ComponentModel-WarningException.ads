...
package MSSyst.ComponentModel.WarningException is
   ...
   function new_WarningException(
      ...
      helpUrl : access MSSyst.String.Typ'Class) return Ref;
   function new_WarningException(
      This : Ref := null;
      message : access MSSyst.String.Typ'Class;
   ...
   function new_WarningException(
      ...
      helpTopic : access MSSyst.String.Typ'Class) return Ref;
   function get_HelpTopic(
      This : access Typ) return access MSSyst.String.Typ'Class;
   function get_HelpUrl(
      This : access Typ) return access MSSyst.String.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_WarningException);
   pragma Import(MSIL,get_HelpTopic,"get_HelpTopic");
   pragma Import(MSIL,get_HelpUrl,"get_HelpUrl");
   pragma Import(MSIL,GetObjectData,"GetObjectData");
end MSSyst.ComponentModel.WarningException;
pragma Import(MSIL,MSSyst.ComponentModel.WarningException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.WarningException");
