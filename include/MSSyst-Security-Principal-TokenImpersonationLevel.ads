...
package MSSyst.Security.Principal.TokenImpersonationLevel is
   type ValueType is (
      None,
      Anonymous,
      Identification,
...
end MSSyst.Security.Principal.TokenImpersonationLevel;
pragma Import(MSIL,MSSyst.Security.Principal.TokenImpersonationLevel,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Principal.TokenImpersonationLevel");
