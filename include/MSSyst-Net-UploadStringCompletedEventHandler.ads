...
limited with MSSyst.Net.UploadStringCompletedEventArgs;
...
package MSSyst.Net.UploadStringCompletedEventHandler is
   ...
   function new_UploadStringCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.UploadStringCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UploadStringCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.UploadStringCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.UploadStringCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.UploadStringCompletedEventHandler");
