...
package MSSyst.Windows.Forms.AxHost.ActiveXInvokeKind is
   type ValueType is (
      MethodInvoke,
      PropertyGet,
      PropertySet);
...
end MSSyst.Windows.Forms.AxHost.ActiveXInvokeKind;
pragma Import(MSIL,MSSyst.Windows.Forms.AxHost.ActiveXInvokeKind,
