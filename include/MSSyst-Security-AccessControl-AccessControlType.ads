...
package MSSyst.Security.AccessControl.AccessControlType is
   type ValueType is (
      Allow,
      Deny);
...
end MSSyst.Security.AccessControl.AccessControlType;
pragma Import(MSIL,MSSyst.Security.AccessControl.AccessControlType,
