...
limited with MSSyst.ComponentModel.ListChangedEventArgs;
...
package MSSyst.ComponentModel.ListChangedEventHandler is
   ...
   function new_ListChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.ListChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ListChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.ListChangedEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.ListChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.ListChangedEventHandler");
