...
package MSSyst.Security.AccessControl.SemaphoreRights is
   type ValueType is (
      Modify,
      Delete,
      ReadPermissions,
...
end MSSyst.Security.AccessControl.SemaphoreRights;
pragma Import(MSIL,MSSyst.Security.AccessControl.SemaphoreRights,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.AccessControl.SemaphoreRights");
