...
package MSSyst.Windows.Forms.UnhandledExceptionMode is
   type ValueType is (
      Automatic,
      ThrowException,
      CatchException);
...
end MSSyst.Windows.Forms.UnhandledExceptionMode;
pragma Import(MSIL,MSSyst.Windows.Forms.UnhandledExceptionMode,
