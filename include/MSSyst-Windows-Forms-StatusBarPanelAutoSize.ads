...
package MSSyst.Windows.Forms.StatusBarPanelAutoSize is
   type ValueType is (
      None,
      Spring,
      Contents);
...
end MSSyst.Windows.Forms.StatusBarPanelAutoSize;
pragma Import(MSIL,MSSyst.Windows.Forms.StatusBarPanelAutoSize,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.StatusBarPanelAutoSize");
