...
limited with MSSyst.IO.FileSystemEventArgs;
...
package MSSyst.IO.FileSystemEventHandler is
   ...
   function new_FileSystemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.IO.FileSystemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_FileSystemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.IO.FileSystemEventHandler;
pragma Import(MSIL,MSSyst.IO.FileSystemEventHandler,
