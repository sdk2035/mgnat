...
package MSSyst.Security.Cryptography.X509Certificates.X509IncludeOption is
   type ValueType is (
      None,
      ExcludeRoot,
      EndCertOnly,
...
end MSSyst.Security.Cryptography.X509Certificates.X509IncludeOption;
pragma Import(MSIL,MSSyst.Security.Cryptography.X509Certificates.X509IncludeOption,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Cryptography.X509Certificates.X509IncludeOption");
