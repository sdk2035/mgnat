...
limited with MSSyst.ComponentModel.Design.ComponentChangingEventArgs;
...
package MSSyst.ComponentModel.Design.ComponentChangingEventHandler is
   ...
   function new_ComponentChangingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.Design.ComponentChangingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ComponentChangingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.Design.ComponentChangingEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.Design.ComponentChangingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.Design.ComponentChangingEventHandler");
