...
package MSSyst.Windows.Forms.ToolStripItemImageScaling is
   type ValueType is (
      None,
      SizeToFit);
...
end MSSyst.Windows.Forms.ToolStripItemImageScaling;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripItemImageScaling,
