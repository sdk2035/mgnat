...
limited with MSSyst.Security.Cryptography.FromBase64TransformMode;
with MSSyst.Security.Cryptography.ICryptoTransform;
limited with MSSyst.String;
limited with MSSyst.Type_k;
package MSSyst.Security.Cryptography.FromBase64Transform is
   ...
   function new_FromBase64Transform(
      This : Ref := null) return Ref;
   function new_FromBase64Transform(
      This : Ref := null;
      whitespaces : MSSyst.Security.Cryptography.FromBase64TransformMode.Valuetype) return Ref;
   procedure Clear(
      This : access Typ);
...
private
   ...
   pragma MSIL_Constructor(new_FromBase64Transform);
...
end MSSyst.Security.Cryptography.FromBase64Transform;
pragma Import(MSIL,MSSyst.Security.Cryptography.FromBase64Transform,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Cryptography.FromBase64Transform");
