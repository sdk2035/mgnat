...
limited with MSSyst.Windows.Forms.DrawListViewItemEventArgs;
package MSSyst.Windows.Forms.DrawListViewItemEventHandler is
   ...
   function new_DrawListViewItemEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DrawListViewItemEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DrawListViewItemEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DrawListViewItemEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DrawListViewItemEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DrawListViewItemEventHandler");
