...
limited with MSSyst.IO.Ports.SerialErrorReceivedEventArgs;
...
package MSSyst.IO.Ports.SerialErrorReceivedEventHandler is
   ...
   function new_SerialErrorReceivedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.IO.Ports.SerialErrorReceivedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SerialErrorReceivedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.IO.Ports.SerialErrorReceivedEventHandler;
pragma Import(MSIL,MSSyst.IO.Ports.SerialErrorReceivedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.IO.Ports.SerialErrorReceivedEventHandler");
