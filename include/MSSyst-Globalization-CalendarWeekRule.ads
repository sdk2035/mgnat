...
package MSSyst.Globalization.CalendarWeekRule is
   type ValueType is (
      FirstDay,
      FirstFullWeek,
      FirstFourDayWeek);
...
end MSSyst.Globalization.CalendarWeekRule;
pragma Import(MSIL,MSSyst.Globalization.CalendarWeekRule,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.CalendarWeekRule");
