...
limited with MSSyst.Windows.Forms.DataGridViewCellFormattingEventArgs;
package MSSyst.Windows.Forms.DataGridViewCellFormattingEventHandler is
   ...
   function new_DataGridViewCellFormattingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewCellFormattingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewCellFormattingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewCellFormattingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewCellFormattingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewCellFormattingEventHandler");
