...
package MSSyst.Runtime.InteropServices.ComTypes.IDLFLAG is
   type ValueType is (
      IDLFLAG_NONE,
      IDLFLAG_FIN,
      IDLFLAG_FOUT,
   ...
   for ValueType use (
      ...
      IDLFLAG_FIN =>  65537,
      IDLFLAG_FOUT =>  131074,
      IDLFLAG_FLCID =>  262148,
      IDLFLAG_FRETVAL =>  524296);
...
end MSSyst.Runtime.InteropServices.ComTypes.IDLFLAG;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.ComTypes.IDLFLAG,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.InteropServices.ComTypes.IDLFLAG");
