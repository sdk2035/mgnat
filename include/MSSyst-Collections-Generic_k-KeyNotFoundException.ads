...
package MSSyst.Collections.Generic_k.KeyNotFoundException is
   ...
   function new_KeyNotFoundException(
...
private
   ...
   pragma MSIL_Constructor(new_KeyNotFoundException);
end MSSyst.Collections.Generic_k.KeyNotFoundException;
pragma Import(MSIL,MSSyst.Collections.Generic_k.KeyNotFoundException,
