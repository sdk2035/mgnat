...
limited with MSSyst.Windows.Forms.KeyPressEventArgs;
package MSSyst.Windows.Forms.KeyPressEventHandler is
   ...
   function new_KeyPressEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.KeyPressEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_KeyPressEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.KeyPressEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.KeyPressEventHandler,
