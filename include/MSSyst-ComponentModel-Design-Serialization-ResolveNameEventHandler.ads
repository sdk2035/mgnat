...
limited with MSSyst.ComponentModel.Design.Serialization.ResolveNameEventArgs;
...
package MSSyst.ComponentModel.Design.Serialization.ResolveNameEventHandler is
   ...
   function new_ResolveNameEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.Design.Serialization.ResolveNameEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ResolveNameEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.Design.Serialization.ResolveNameEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.Design.Serialization.ResolveNameEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.Design.Serialization.ResolveNameEventHandler");
