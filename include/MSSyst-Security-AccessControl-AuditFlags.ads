...
package MSSyst.Security.AccessControl.AuditFlags is
   type ValueType is (
      None,
      Success,
      Failure);
...
end MSSyst.Security.AccessControl.AuditFlags;
pragma Import(MSIL,MSSyst.Security.AccessControl.AuditFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.AuditFlags");
