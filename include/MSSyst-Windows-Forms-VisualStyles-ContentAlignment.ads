...
package MSSyst.Windows.Forms.VisualStyles.ContentAlignment is
   type ValueType is (
      Left,
      Center,
      Right);
...
end MSSyst.Windows.Forms.VisualStyles.ContentAlignment;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.ContentAlignment,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.ContentAlignment");
