...
package MSSyst.Windows.Forms.MessageBoxDefaultButton is
   type ValueType is (
      Button1,
      Button2,
      Button3);
...
end MSSyst.Windows.Forms.MessageBoxDefaultButton;
pragma Import(MSIL,MSSyst.Windows.Forms.MessageBoxDefaultButton,
