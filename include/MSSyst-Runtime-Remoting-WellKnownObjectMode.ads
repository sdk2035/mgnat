...
package MSSyst.Runtime.Remoting.WellKnownObjectMode is
   type ValueType is (
      Singleton,
      SingleCall);
...
end MSSyst.Runtime.Remoting.WellKnownObjectMode;
pragma Import(MSIL,MSSyst.Runtime.Remoting.WellKnownObjectMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Remoting.WellKnownObjectMode");
