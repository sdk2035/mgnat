...
package MSSyst.Text.UTF7Encoding is
   ...
   function new_UTF7Encoding(
      This : Ref := null) return Ref;
   function new_UTF7Encoding(
      This : Ref := null;
      allowOptionals : Standard.Boolean) return Ref;
   function Equals(
      This : access Typ;
...
private
   ...
   pragma MSIL_Constructor(new_UTF7Encoding);
...
end MSSyst.Text.UTF7Encoding;
pragma Import(MSIL,MSSyst.Text.UTF7Encoding,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Text.UTF7Encoding");
