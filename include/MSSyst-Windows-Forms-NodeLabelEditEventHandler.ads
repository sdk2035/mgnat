...
limited with MSSyst.Windows.Forms.NodeLabelEditEventArgs;
package MSSyst.Windows.Forms.NodeLabelEditEventHandler is
   ...
   function new_NodeLabelEditEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.NodeLabelEditEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_NodeLabelEditEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.NodeLabelEditEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.NodeLabelEditEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NodeLabelEditEventHandler");
