...
package MSSyst.Runtime.Serialization.Formatters.TypeFilterLevel is
   type ValueType is (
      Low,
      Full);
...
end MSSyst.Runtime.Serialization.Formatters.TypeFilterLevel;
pragma Import(MSIL,MSSyst.Runtime.Serialization.Formatters.TypeFilterLevel,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Serialization.Formatters.TypeFilterLevel");
