...
package MSSyst.Runtime.Remoting.Messaging.HeaderHandler is
   ...
   function Invoke(
      This : access Typ;
      headers : access MSSyst.Runtime.Remoting.Messaging.Header.Ref_arr) return access MSSyst.Object.Typ'Class;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_HeaderHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Runtime.Remoting.Messaging.HeaderHandler;
pragma Import(MSIL,MSSyst.Runtime.Remoting.Messaging.HeaderHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Remoting.Messaging.HeaderHandler");
