...
package MSSyst.Security.Permissions.FileDialogPermissionAccess is
   type ValueType is (
      None,
      Open,
      Save,
...
end MSSyst.Security.Permissions.FileDialogPermissionAccess;
pragma Import(MSIL,MSSyst.Security.Permissions.FileDialogPermissionAccess,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.FileDialogPermissionAccess");
