...
package MSSyst.Windows.Forms.ToolStripItemAlignment is
   type ValueType is (
      Left,
      Right);
...
end MSSyst.Windows.Forms.ToolStripItemAlignment;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripItemAlignment,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripItemAlignment");
