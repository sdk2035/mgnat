...
with MSIL_Types;
use MSIL_Types;
with MSSyst.Collections.Generic_k.Stack;
limited with MSSyst.String;
limited with MSSyst.Type_k;
with MSSyst.ValueType;
generic
   type T is private;
package MSSyst.Collections.Generic_k.Stack.Enumerator is
...
end MSSyst.Collections.Generic_k.Stack.Enumerator;
pragma Import(MSIL,MSSyst.Collections.Generic_k.Stack.Enumerator,
