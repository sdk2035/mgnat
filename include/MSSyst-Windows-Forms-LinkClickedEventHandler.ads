...
limited with MSSyst.Windows.Forms.LinkClickedEventArgs;
package MSSyst.Windows.Forms.LinkClickedEventHandler is
   ...
   function new_LinkClickedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.LinkClickedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_LinkClickedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.LinkClickedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.LinkClickedEventHandler,
