...
package MSSyst.Runtime.Remoting.RemotingException is
   ...
   function new_RemotingException(
...
private
   ...
   pragma MSIL_Constructor(new_RemotingException);
end MSSyst.Runtime.Remoting.RemotingException;
pragma Import(MSIL,MSSyst.Runtime.Remoting.RemotingException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Remoting.RemotingException");
