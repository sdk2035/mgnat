...
package MSSyst.Windows.Forms.VisualStyles.HitTestOptions is
   type ValueType is (
      BackgroundSegment,
      FixedBorder,
      Caption,
...
end MSSyst.Windows.Forms.VisualStyles.HitTestOptions;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.HitTestOptions,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.HitTestOptions");
