...
package MSSyst.Runtime.InteropServices.uFieldInfo is
   ...
   function GetValue(
      This : access Typ;
      obj : access MSSyst.Object.Typ'Class) return access MSSyst.Object.Typ'Class is abstract;
   function GetValueDirect(
      This : access Typ;
      obj : MSSyst.TypedReference.Valuetype) return access MSSyst.Object.Typ'Class is abstract;
   procedure Invoke(
      This : access Typ;
