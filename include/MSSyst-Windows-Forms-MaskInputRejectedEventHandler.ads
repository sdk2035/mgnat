...
limited with MSSyst.Windows.Forms.MaskInputRejectedEventArgs;
package MSSyst.Windows.Forms.MaskInputRejectedEventHandler is
   ...
   function new_MaskInputRejectedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.MaskInputRejectedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_MaskInputRejectedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.MaskInputRejectedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.MaskInputRejectedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.MaskInputRejectedEventHandler");
