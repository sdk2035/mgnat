...
package MSSyst.Windows.Forms.ToolBarTextAlign is
   type ValueType is (
      Underneath,
      Right);
...
end MSSyst.Windows.Forms.ToolBarTextAlign;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolBarTextAlign,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolBarTextAlign");
