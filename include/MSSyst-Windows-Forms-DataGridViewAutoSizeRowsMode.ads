...
package MSSyst.Windows.Forms.DataGridViewAutoSizeRowsMode is
   type ValueType is (
      None,
      AllHeaders,
...
end MSSyst.Windows.Forms.DataGridViewAutoSizeRowsMode;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewAutoSizeRowsMode,
