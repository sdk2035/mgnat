...
limited with MSSyst.Windows.Forms.HelpEventArgs;
package MSSyst.Windows.Forms.HelpEventHandler is
   ...
   function BeginInvoke(
      ...
      hlpevent : access MSSyst.Windows.Forms.HelpEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_HelpEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.HelpEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.HelpEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.HelpEventHandler");
