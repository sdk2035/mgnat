...
with MSSyst.Runtime.InteropServices.uEnumBuilder;
...
with MSSyst.Type_k;
package MSSyst.Reflection.Emit.EnumBuilder is
   type Typ is new MSSyst.Type_k.Typ
         ...
         and MSSyst.Runtime.InteropServices.uEnumBuilder.Typ
   with record
      null;
   end record;
   ...
   function DefineLiteral(
      This : access Typ;
      literalName : access MSSyst.String.Typ'Class;
      literalValue : access MSSyst.Object.Typ'Class) return access MSSyst.Reflection.Emit.FieldBuilder.Typ'Class;
   ...
   function get_UnderlyingField(
      This : access Typ) return access MSSyst.Reflection.Emit.FieldBuilder.Typ'Class;
...
private
   ...
   pragma Import(MSIL,DefineLiteral,"DefineLiteral");
   ...
   pragma Import(MSIL,get_UnderlyingField,"get_UnderlyingField");
...
end MSSyst.Reflection.Emit.EnumBuilder;
pragma Import(MSIL,MSSyst.Reflection.Emit.EnumBuilder,
