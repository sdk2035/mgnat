...
package MSSyst.Runtime.Remoting.Channels.ServerProcessing is
   type ValueType is (
      Complete,
      OneWay,
      Async);
...
end MSSyst.Runtime.Remoting.Channels.ServerProcessing;
pragma Import(MSIL,MSSyst.Runtime.Remoting.Channels.ServerProcessing,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Remoting.Channels.ServerProcessing");
