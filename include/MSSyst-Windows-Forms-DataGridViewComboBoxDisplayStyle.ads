...
package MSSyst.Windows.Forms.DataGridViewComboBoxDisplayStyle is
   type ValueType is (
      ComboBox,
      DropDownButton,
      Nothing);
...
end MSSyst.Windows.Forms.DataGridViewComboBoxDisplayStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewComboBoxDisplayStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewComboBoxDisplayStyle");
