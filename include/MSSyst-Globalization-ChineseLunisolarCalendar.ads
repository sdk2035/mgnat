...
package MSSyst.Globalization.ChineseLunisolarCalendar is
   ...
   ChineseEra : Integer;
   pragma Import(MSIL,ChineseEra,"ChineseEra");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_ChineseLunisolarCalendar(
...
private
   ...
   pragma MSIL_Constructor(new_ChineseLunisolarCalendar);
...
end MSSyst.Globalization.ChineseLunisolarCalendar;
pragma Import(MSIL,MSSyst.Globalization.ChineseLunisolarCalendar,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.ChineseLunisolarCalendar");
