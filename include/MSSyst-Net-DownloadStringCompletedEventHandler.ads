...
limited with MSSyst.Net.DownloadStringCompletedEventArgs;
...
package MSSyst.Net.DownloadStringCompletedEventHandler is
   ...
   function new_DownloadStringCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.DownloadStringCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DownloadStringCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.DownloadStringCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.DownloadStringCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.DownloadStringCompletedEventHandler");
