...
package MSSyst.Windows.Forms.UnsafeNativeMethods.DHTMLMarqueeElementEvents2 is
...
private
   ...
   pragma Import(MSIL,onbounce,"onbounce");
   ...
   pragma Import(MSIL,onfinish,"onfinish");
   ...
   pragma Import(MSIL,onstart,"onstart");
end MSSyst.Windows.Forms.UnsafeNativeMethods.DHTMLMarqueeElementEvents2;
pragma Import(MSIL,MSSyst.Windows.Forms.UnsafeNativeMethods.DHTMLMarqueeElementEvents2,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.UnsafeNativeMethods/DHTMLMarqueeElementEvents2");
