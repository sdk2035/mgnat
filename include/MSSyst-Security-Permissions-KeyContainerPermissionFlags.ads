...
package MSSyst.Security.Permissions.KeyContainerPermissionFlags is
   type ValueType is (
      NoFlags,
      Create,
      Open,
...
end MSSyst.Security.Permissions.KeyContainerPermissionFlags;
pragma Import(MSIL,MSSyst.Security.Permissions.KeyContainerPermissionFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Permissions.KeyContainerPermissionFlags");
