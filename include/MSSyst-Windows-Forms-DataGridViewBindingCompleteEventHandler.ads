...
limited with MSSyst.Windows.Forms.DataGridViewBindingCompleteEventArgs;
package MSSyst.Windows.Forms.DataGridViewBindingCompleteEventHandler is
   ...
   function new_DataGridViewBindingCompleteEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewBindingCompleteEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewBindingCompleteEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewBindingCompleteEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewBindingCompleteEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewBindingCompleteEventHandler");
