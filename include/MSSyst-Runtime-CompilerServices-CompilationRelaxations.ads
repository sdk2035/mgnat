...
package MSSyst.Runtime.CompilerServices.CompilationRelaxations is
   type ValueType is (
      NoStringInterning);
...
end MSSyst.Runtime.CompilerServices.CompilationRelaxations;
pragma Import(MSIL,MSSyst.Runtime.CompilerServices.CompilationRelaxations,
