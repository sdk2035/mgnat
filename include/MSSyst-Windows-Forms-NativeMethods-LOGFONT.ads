...
package MSSyst.Windows.Forms.NativeMethods.LOGFONT is
   ...
   function new_LOGFONT(
      This : Ref := null;
      lf : access MSSyst.Windows.Forms.NativeMethods.LOGFONT.Typ'Class) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_LOGFONT);
end MSSyst.Windows.Forms.NativeMethods.LOGFONT;
pragma Import(MSIL,MSSyst.Windows.Forms.NativeMethods.LOGFONT,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.NativeMethods/LOGFONT");
