...
package MSSyst.Net.ProtocolViolationException is
   ...
   function new_ProtocolViolationException(
...
private
   ...
   pragma MSIL_Constructor(new_ProtocolViolationException);
   pragma Import(MSIL,GetObjectData,"GetObjectData");
end MSSyst.Net.ProtocolViolationException;
pragma Import(MSIL,MSSyst.Net.ProtocolViolationException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.ProtocolViolationException");
