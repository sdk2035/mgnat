...
limited with MSSyst.Windows.Forms.ItemCheckEventArgs;
package MSSyst.Windows.Forms.ItemCheckEventHandler is
   ...
   function new_ItemCheckEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ItemCheckEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ItemCheckEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ItemCheckEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ItemCheckEventHandler,
