...
limited with MSSyst.Windows.Forms.StatusBarPanelClickEventArgs;
package MSSyst.Windows.Forms.StatusBarPanelClickEventHandler is
   ...
   function new_StatusBarPanelClickEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.StatusBarPanelClickEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_StatusBarPanelClickEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.StatusBarPanelClickEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.StatusBarPanelClickEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.StatusBarPanelClickEventHandler");
