...
limited with MSSyst.Windows.Forms.DateRangeEventArgs;
package MSSyst.Windows.Forms.DateRangeEventHandler is
   ...
   function new_DateRangeEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DateRangeEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DateRangeEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DateRangeEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DateRangeEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DateRangeEventHandler");
