...
package MSSyst.Security.Permissions.FileIOPermissionAccess is
   type ValueType is (
      NoAccess,
      Read,
      Write,
...
end MSSyst.Security.Permissions.FileIOPermissionAccess;
pragma Import(MSIL,MSSyst.Security.Permissions.FileIOPermissionAccess,
