...
package MSSyst.Windows.Forms.ToolStripItemOverflow is
   type ValueType is (
      Never,
      Always,
      AsNeeded);
...
end MSSyst.Windows.Forms.ToolStripItemOverflow;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripItemOverflow,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripItemOverflow");
