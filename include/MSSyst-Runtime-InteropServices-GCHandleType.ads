...
package MSSyst.Runtime.InteropServices.GCHandleType is
   type ValueType is (
      Weak,
...
end MSSyst.Runtime.InteropServices.GCHandleType;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.GCHandleType,
