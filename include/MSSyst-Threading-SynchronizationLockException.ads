...
package MSSyst.Threading.SynchronizationLockException is
   ...
   function new_SynchronizationLockException(
...
private
   ...
   pragma MSIL_Constructor(new_SynchronizationLockException);
end MSSyst.Threading.SynchronizationLockException;
pragma Import(MSIL,MSSyst.Threading.SynchronizationLockException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Threading.SynchronizationLockException");
