...
package MSSyst.IO.IOException is
...
private
   ...
   pragma MSIL_Constructor(new_IOException);
end MSSyst.IO.IOException;
pragma Import(MSIL,MSSyst.IO.IOException,
