...
package MSSyst.IO.InvalidDataException is
   ...
   function new_InvalidDataException(
...
private
   ...
   pragma MSIL_Constructor(new_InvalidDataException);
end MSSyst.IO.InvalidDataException;
pragma Import(MSIL,MSSyst.IO.InvalidDataException,
