...
package MSSyst.Drawing.Printing.PrinterSettings.StringCollection is
   ...
   function new_StringCollection(
      This : Ref := null;
      array_k : access MSSyst.String.Ref_arr) return Ref;
   function Add(
      This : access Typ;
      value : access MSSyst.String.Typ'Class) return Integer;
   procedure CopyTo(
      This : access Typ;
      strings : access MSSyst.String.Ref_arr;
      index : Integer);
   function get_Count(
...
end MSSyst.Drawing.Printing.PrinterSettings.StringCollection;
pragma Import(MSIL,MSSyst.Drawing.Printing.PrinterSettings.StringCollection,
   ".ver 2:0:0:0 .publickeytoken=( b0 3f 5f 7f 11 d5 0a 3a )",
   "[System.Drawing]System.Drawing.Printing.PrinterSettings/StringCollection");
