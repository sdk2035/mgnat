...
package MSSyst.IndexOutOfRangeException is
   ...
   function new_IndexOutOfRangeException(
...
private
   ...
   pragma MSIL_Constructor(new_IndexOutOfRangeException);
end MSSyst.IndexOutOfRangeException;
pragma Import(MSIL,MSSyst.IndexOutOfRangeException,
