...
package MSSyst.Security.AccessControl.DirectorySecurity is
   ...
   function new_DirectorySecurity(
...
private
   ...
   pragma MSIL_Constructor(new_DirectorySecurity);
end MSSyst.Security.AccessControl.DirectorySecurity;
pragma Import(MSIL,MSSyst.Security.AccessControl.DirectorySecurity,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.DirectorySecurity");
