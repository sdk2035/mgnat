...
package MSSyst.Threading.ThreadInterruptedException is
   ...
   function new_ThreadInterruptedException(
...
private
   ...
   pragma MSIL_Constructor(new_ThreadInterruptedException);
end MSSyst.Threading.ThreadInterruptedException;
pragma Import(MSIL,MSSyst.Threading.ThreadInterruptedException,
