...
package MSSyst.ComponentModel.DescriptionAttribute is
   type Typ is new MSSyst.Attribute.Typ
         and MSSyst.Runtime.InteropServices.uAttribute.Typ
   with record
      null;
   end record;
   Default : access MSSyst.ComponentModel.DescriptionAttribute.Typ'Class;
   ...
   function new_DescriptionAttribute(
...
private
   ...
   pragma MSIL_Constructor(new_DescriptionAttribute);
   pragma Import(MSIL,Equals,"Equals");
   pragma Import(MSIL,get_Description,"get_Description");
   pragma Import(MSIL,GetHashCode,"GetHashCode");
   pragma Import(MSIL,IsDefaultAttribute,"IsDefaultAttribute");
end MSSyst.ComponentModel.DescriptionAttribute;
pragma Import(MSIL,MSSyst.ComponentModel.DescriptionAttribute,
