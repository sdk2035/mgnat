...
package MSSyst.Windows.Forms.UICues is
   type ValueType is (
      None,
      ShowFocus,
      ShowKeyboard,
...
end MSSyst.Windows.Forms.UICues;
pragma Import(MSIL,MSSyst.Windows.Forms.UICues,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.UICues");
