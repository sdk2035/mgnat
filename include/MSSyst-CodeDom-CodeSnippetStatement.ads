...
package MSSyst.CodeDom.CodeSnippetStatement is
   ...
   function new_CodeSnippetStatement(
...
private
   ...
   pragma MSIL_Constructor(new_CodeSnippetStatement);
   pragma Import(MSIL,get_Value,"get_Value");
   pragma Import(MSIL,set_Value,"set_Value");
end MSSyst.CodeDom.CodeSnippetStatement;
pragma Import(MSIL,MSSyst.CodeDom.CodeSnippetStatement,
