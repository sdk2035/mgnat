...
package MSSyst.Windows.Forms.VisualStyles.ImageOrientation is
   type ValueType is (
      Vertical,
      Horizontal);
...
end MSSyst.Windows.Forms.VisualStyles.ImageOrientation;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.ImageOrientation,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.ImageOrientation");
