...
package MSSyst.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs is
   ...
   function new_DataGridViewRowContextMenuStripNeededEventArgs(
      This : Ref := null;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowContextMenuStripNeededEventArgs);
...
end MSSyst.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowContextMenuStripNeededEventArgs");
