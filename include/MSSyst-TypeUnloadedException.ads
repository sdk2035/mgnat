...
package MSSyst.TypeUnloadedException is
   ...
   function new_TypeUnloadedException(
...
private
   ...
   pragma MSIL_Constructor(new_TypeUnloadedException);
end MSSyst.TypeUnloadedException;
pragma Import(MSIL,MSSyst.TypeUnloadedException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.TypeUnloadedException");
