...
package MSSyst.Windows.Forms.ControlUpdateMode is
   type ValueType is (
      OnPropertyChanged,
      Never);
...
end MSSyst.Windows.Forms.ControlUpdateMode;
pragma Import(MSIL,MSSyst.Windows.Forms.ControlUpdateMode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ControlUpdateMode");
