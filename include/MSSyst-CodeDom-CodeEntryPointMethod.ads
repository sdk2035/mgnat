...
package MSSyst.CodeDom.CodeEntryPointMethod is
   ...
   function new_CodeEntryPointMethod(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_CodeEntryPointMethod);
end MSSyst.CodeDom.CodeEntryPointMethod;
pragma Import(MSIL,MSSyst.CodeDom.CodeEntryPointMethod,
