...
limited with MSSyst.Windows.Forms.InvalidateEventArgs;
package MSSyst.Windows.Forms.InvalidateEventHandler is
   ...
   function new_InvalidateEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.InvalidateEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_InvalidateEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.InvalidateEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.InvalidateEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.InvalidateEventHandler");
