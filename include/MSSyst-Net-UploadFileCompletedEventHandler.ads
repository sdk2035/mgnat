...
limited with MSSyst.Net.UploadFileCompletedEventArgs;
...
package MSSyst.Net.UploadFileCompletedEventHandler is
   ...
   function new_UploadFileCompletedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Net.UploadFileCompletedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UploadFileCompletedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Net.UploadFileCompletedEventHandler;
pragma Import(MSIL,MSSyst.Net.UploadFileCompletedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Net.UploadFileCompletedEventHandler");
