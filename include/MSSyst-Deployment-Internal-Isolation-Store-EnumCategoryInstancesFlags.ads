...
package MSSyst.Deployment.Internal.Isolation.Store.EnumCategoryInstancesFlags is
   type ValueType is (
      Nothing);
...
end MSSyst.Deployment.Internal.Isolation.Store.EnumCategoryInstancesFlags;
pragma Import(MSIL,MSSyst.Deployment.Internal.Isolation.Store.EnumCategoryInstancesFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Deployment.Internal.Isolation.Store/EnumCategoryInstancesFlags");
