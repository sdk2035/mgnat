...
package MSSyst.AccessViolationException is
   ...
   function new_AccessViolationException(
...
private
   ...
   pragma MSIL_Constructor(new_AccessViolationException);
end MSSyst.AccessViolationException;
pragma Import(MSIL,MSSyst.AccessViolationException,
