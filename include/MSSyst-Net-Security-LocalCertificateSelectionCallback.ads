...
package MSSyst.Net.Security.LocalCertificateSelectionCallback is
   ...
   function BeginInvoke(
      ...
      localCertificates : access MSSyst.Security.Cryptography.X509Certificates.X509CertificateCollection.Typ'Class;
      remoteCertificate : access MSSyst.Security.Cryptography.X509Certificates.X509Certificate.Typ'Class;
      acceptableIssuers : access MSSyst.String.Ref_arr;
   ...
   function EndInvoke(
      This : access Typ;
      result : access MSSyst.IAsyncResult.Typ'Class) return access MSSyst.Security.Cryptography.X509Certificates.X509Certificate.Typ'Class;
   function Invoke(
      This : access Typ;
      sender : access MSSyst.Object.Typ'Class;
      targetHost : access MSSyst.String.Typ'Class;
      localCertificates : access MSSyst.Security.Cryptography.X509Certificates.X509CertificateCollection.Typ'Class;
      remoteCertificate : access MSSyst.Security.Cryptography.X509Certificates.X509Certificate.Typ'Class;
      acceptableIssuers : access MSSyst.String.Ref_arr) return access MSSyst.Security.Cryptography.X509Certificates.X509Certificate.Typ'Class;
private
