...
limited with MSSyst.ComponentModel.Design.DesignerTransactionCloseEventArgs;
...
package MSSyst.ComponentModel.Design.DesignerTransactionCloseEventHandler is
   ...
   function new_DesignerTransactionCloseEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.Design.DesignerTransactionCloseEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DesignerTransactionCloseEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.Design.DesignerTransactionCloseEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.Design.DesignerTransactionCloseEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.Design.DesignerTransactionCloseEventHandler");
