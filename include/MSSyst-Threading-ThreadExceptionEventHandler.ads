...
limited with MSSyst.Threading.ThreadExceptionEventArgs;
limited with MSSyst.Type_k;
package MSSyst.Threading.ThreadExceptionEventHandler is
   ...
   function new_ThreadExceptionEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Threading.ThreadExceptionEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ThreadExceptionEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Threading.ThreadExceptionEventHandler;
pragma Import(MSIL,MSSyst.Threading.ThreadExceptionEventHandler,
