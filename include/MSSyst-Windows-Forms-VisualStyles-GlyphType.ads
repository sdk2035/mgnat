...
package MSSyst.Windows.Forms.VisualStyles.GlyphType is
   type ValueType is (
      None,
      ImageGlyph,
      FontGlyph);
...
end MSSyst.Windows.Forms.VisualStyles.GlyphType;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.GlyphType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.GlyphType");
