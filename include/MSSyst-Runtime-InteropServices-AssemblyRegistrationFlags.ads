...
package MSSyst.Runtime.InteropServices.AssemblyRegistrationFlags is
   type ValueType is (
      None,
      SetCodeBase);
...
end MSSyst.Runtime.InteropServices.AssemblyRegistrationFlags;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.AssemblyRegistrationFlags,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.InteropServices.AssemblyRegistrationFlags");
