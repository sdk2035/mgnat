...
limited with MSSyst.Diagnostics.EntryWrittenEventArgs;
...
package MSSyst.Diagnostics.EntryWrittenEventHandler is
   ...
   function new_EntryWrittenEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Diagnostics.EntryWrittenEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_EntryWrittenEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Diagnostics.EntryWrittenEventHandler;
pragma Import(MSIL,MSSyst.Diagnostics.EntryWrittenEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Diagnostics.EntryWrittenEventHandler");
