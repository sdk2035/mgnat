...
limited with MSSyst.Text.RegularExpressions.Regex;
...
package MSSyst.Net.WebPermission is
   ...
   function new_WebPermission(
      ...
      uriRegex : access MSSyst.Text.RegularExpressions.Regex.Typ'Class) return Ref;
   function new_WebPermission(
      This : Ref := null;
      access_k : MSSyst.Net.NetworkAccess.Valuetype;
   ...
   procedure AddPermission(
      This : access Typ;
      access_k : MSSyst.Net.NetworkAccess.Valuetype;
      uriRegex : access MSSyst.Text.RegularExpressions.Regex.Typ'Class);
   function Copy(
