...
package MSSyst.Windows.Forms.VisualStyles.HitTestCode is
   type ValueType is (
      Nowhere,
      Client,
      Left,
...
end MSSyst.Windows.Forms.VisualStyles.HitTestCode;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.HitTestCode,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.HitTestCode");
