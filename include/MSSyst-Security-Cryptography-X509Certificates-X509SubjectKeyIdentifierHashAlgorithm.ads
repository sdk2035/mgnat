...
package MSSyst.Security.Cryptography.X509Certificates.X509SubjectKeyIdentifierHashAlgorithm is
   type ValueType is (
      Sha1,
      ShortSha1,
      CapiSha1);
...
end MSSyst.Security.Cryptography.X509Certificates.X509SubjectKeyIdentifierHashAlgorithm;
pragma Import(MSIL,MSSyst.Security.Cryptography.X509Certificates.X509SubjectKeyIdentifierHashAlgorithm,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Cryptography.X509Certificates.X509SubjectKeyIdentifierHashAlgorithm");
