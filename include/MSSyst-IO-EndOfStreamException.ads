...
package MSSyst.IO.EndOfStreamException is
   ...
   function new_EndOfStreamException(
...
private
   ...
   pragma MSIL_Constructor(new_EndOfStreamException);
end MSSyst.IO.EndOfStreamException;
pragma Import(MSIL,MSSyst.IO.EndOfStreamException,
