...
package MSSyst.InvalidOperationException is
...
private
   ...
   pragma MSIL_Constructor(new_InvalidOperationException);
end MSSyst.InvalidOperationException;
pragma Import(MSIL,MSSyst.InvalidOperationException,
