...
limited with MSSyst.Security.AccessControl.SemaphoreAccessRule;
limited with MSSyst.Security.AccessControl.SemaphoreAuditRule;
limited with MSSyst.Security.Principal.IdentityReference;
limited with MSSyst.String;
limited with MSSyst.Type_k;
package MSSyst.Security.AccessControl.SemaphoreSecurity is
   ...
   function new_SemaphoreSecurity(
   ...
   procedure AddAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.SemaphoreAccessRule.Typ'Class);
   procedure AddAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.SemaphoreAuditRule.Typ'Class);
   ...
   function RemoveAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.SemaphoreAccessRule.Typ'Class) return Standard.Boolean;
   ...
   function RemoveAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.SemaphoreAuditRule.Typ'Class) return Standard.Boolean;
...
private
   ...
   pragma MSIL_Constructor(new_SemaphoreSecurity);
...
end MSSyst.Security.AccessControl.SemaphoreSecurity;
pragma Import(MSIL,MSSyst.Security.AccessControl.SemaphoreSecurity,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.AccessControl.SemaphoreSecurity");
