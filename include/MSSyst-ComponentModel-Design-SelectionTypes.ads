...
package MSSyst.ComponentModel.Design.SelectionTypes is
   type ValueType is (
      Auto,
      Normal,
      Replace,
   ...
   pragma Import (MSIL, "+", "+");
   Click : constant Valuetype := Primary;
   function CompareTo(
      This : Valuetype;
...
end MSSyst.ComponentModel.Design.SelectionTypes;
pragma Import(MSIL,MSSyst.ComponentModel.Design.SelectionTypes,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.Design.SelectionTypes");
