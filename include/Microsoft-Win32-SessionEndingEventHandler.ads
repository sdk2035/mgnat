...
with MSIL_Types;
use MSIL_Types;
limited with Microsoft.Win32.SessionEndingEventArgs;
...
package Microsoft.Win32.SessionEndingEventHandler is
   ...
   function new_SessionEndingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access Microsoft.Win32.SessionEndingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SessionEndingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end Microsoft.Win32.SessionEndingEventHandler;
pragma Import(MSIL,Microsoft.Win32.SessionEndingEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]Microsoft.Win32.SessionEndingEventHandler");
