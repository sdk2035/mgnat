...
package MSSyst.Windows.Forms.PowerLineStatus is
   type ValueType is (
      Offline,
      Online,
      Unknown);
...
end MSSyst.Windows.Forms.PowerLineStatus;
pragma Import(MSIL,MSSyst.Windows.Forms.PowerLineStatus,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.PowerLineStatus");
