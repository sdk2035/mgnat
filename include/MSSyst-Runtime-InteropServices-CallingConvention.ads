...
package MSSyst.Runtime.InteropServices.CallingConvention is
   type ValueType is (
      Winapi,
      Cdecl,
      StdCall,
...
end MSSyst.Runtime.InteropServices.CallingConvention;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.CallingConvention,
