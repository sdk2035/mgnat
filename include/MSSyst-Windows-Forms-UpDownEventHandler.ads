...
limited with MSSyst.Windows.Forms.UpDownEventArgs;
package MSSyst.Windows.Forms.UpDownEventHandler is
   ...
   function new_UpDownEventHandler(
      This : Ref := null;
      object : access MSSyst.Object.Typ'Class;
      method : MSIL_Types.native_int) return Ref;
   function BeginInvoke(
      This : access Typ;
      source : access MSSyst.Object.Typ'Class;
      e : access MSSyst.Windows.Forms.UpDownEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_UpDownEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.UpDownEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.UpDownEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.UpDownEventHandler");
