...
package MSSyst.Security.Authentication.HashAlgorithmType is
   type ValueType is (
      None,
      Md5,
      Sha1);
...
end MSSyst.Security.Authentication.HashAlgorithmType;
pragma Import(MSIL,MSSyst.Security.Authentication.HashAlgorithmType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Authentication.HashAlgorithmType");
