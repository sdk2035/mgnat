...
package MSSyst.Windows.Forms.RichTextBoxSelectionAttribute is
   type ValueType is (
      Mixed,
      None,
      All_k);
...
end MSSyst.Windows.Forms.RichTextBoxSelectionAttribute;
pragma Import(MSIL,MSSyst.Windows.Forms.RichTextBoxSelectionAttribute,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.RichTextBoxSelectionAttribute");
