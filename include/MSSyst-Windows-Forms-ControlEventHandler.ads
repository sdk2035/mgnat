...
limited with MSSyst.Windows.Forms.ControlEventArgs;
package MSSyst.Windows.Forms.ControlEventHandler is
   ...
   function new_ControlEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ControlEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ControlEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ControlEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ControlEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ControlEventHandler");
