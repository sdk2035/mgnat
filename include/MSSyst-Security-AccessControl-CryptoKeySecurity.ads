...
limited with MSSyst.Security.AccessControl.CommonSecurityDescriptor;
limited with MSSyst.Security.AccessControl.CryptoKeyAccessRule;
limited with MSSyst.Security.AccessControl.CryptoKeyAuditRule;
...
package MSSyst.Security.AccessControl.CryptoKeySecurity is
   ...
   function new_CryptoKeySecurity(
      This : Ref := null) return Ref;
   function new_CryptoKeySecurity(
      This : Ref := null;
      securityDescriptor : access MSSyst.Security.AccessControl.CommonSecurityDescriptor.Typ'Class) return Ref;
   ...
   procedure AddAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.CryptoKeyAccessRule.Typ'Class);
   procedure AddAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.CryptoKeyAuditRule.Typ'Class);
   ...
   function RemoveAccessRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.CryptoKeyAccessRule.Typ'Class) return Standard.Boolean;
   ...
   function RemoveAuditRule(
      This : access Typ;
      rule : access MSSyst.Security.AccessControl.CryptoKeyAuditRule.Typ'Class) return Standard.Boolean;
...
private
   ...
   pragma MSIL_Constructor(new_CryptoKeySecurity);
...
end MSSyst.Security.AccessControl.CryptoKeySecurity;
pragma Import(MSIL,MSSyst.Security.AccessControl.CryptoKeySecurity,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.AccessControl.CryptoKeySecurity");
