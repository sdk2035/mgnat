...
package MSSyst.Drawing.Design.ToolboxItemCreatorCallback is
   ...
   function new_ToolboxItemCreatorCallback(
      This : Ref := null;
   ...
   function EndInvoke(
      This : access Typ;
      result : access MSSyst.IAsyncResult.Typ'Class) return access MSSyst.Drawing.Design.ToolboxItem.Typ'Class;
   function Invoke(
      This : access Typ;
      serializedObject : access MSSyst.Object.Typ'Class;
      format : access MSSyst.String.Typ'Class) return access MSSyst.Drawing.Design.ToolboxItem.Typ'Class;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_ToolboxItemCreatorCallback);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Drawing.Design.ToolboxItemCreatorCallback;
pragma Import(MSIL,MSSyst.Drawing.Design.ToolboxItemCreatorCallback,
   ".ver 2:0:0:0 .publickeytoken=( b0 3f 5f 7f 11 d5 0a 3a )",
   "[System.Drawing]System.Drawing.Design.ToolboxItemCreatorCallback");
