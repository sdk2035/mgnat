...
limited with MSSyst.Diagnostics.DataReceivedEventArgs;
...
package MSSyst.Diagnostics.DataReceivedEventHandler is
   ...
   function new_DataReceivedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Diagnostics.DataReceivedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataReceivedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Diagnostics.DataReceivedEventHandler;
pragma Import(MSIL,MSSyst.Diagnostics.DataReceivedEventHandler,
