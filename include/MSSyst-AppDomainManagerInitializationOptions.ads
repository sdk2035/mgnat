...
package MSSyst.AppDomainManagerInitializationOptions is
   type ValueType is (
      None,
      RegisterWithHost);
...
end MSSyst.AppDomainManagerInitializationOptions;
pragma Import(MSIL,MSSyst.AppDomainManagerInitializationOptions,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.AppDomainManagerInitializationOptions");
