...
package MSSyst.Runtime.Versioning.ResourceScope is
   type ValueType is (
      None,
      Machine,
      Process,
...
end MSSyst.Runtime.Versioning.ResourceScope;
pragma Import(MSIL,MSSyst.Runtime.Versioning.ResourceScope,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.Versioning.ResourceScope");
