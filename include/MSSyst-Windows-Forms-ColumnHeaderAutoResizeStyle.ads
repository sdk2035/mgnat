...
package MSSyst.Windows.Forms.ColumnHeaderAutoResizeStyle is
   type ValueType is (
      None,
      HeaderSize,
      ColumnContent);
...
end MSSyst.Windows.Forms.ColumnHeaderAutoResizeStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.ColumnHeaderAutoResizeStyle,
