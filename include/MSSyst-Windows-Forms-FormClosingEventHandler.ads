...
limited with MSSyst.Windows.Forms.FormClosingEventArgs;
package MSSyst.Windows.Forms.FormClosingEventHandler is
   ...
   function new_FormClosingEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.FormClosingEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_FormClosingEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.FormClosingEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.FormClosingEventHandler,
