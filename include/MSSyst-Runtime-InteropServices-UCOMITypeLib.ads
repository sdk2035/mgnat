...
package MSSyst.Runtime.InteropServices.UCOMITypeLib is
   ...
   procedure FindName(
      ...
      lHashVal : Integer;
      ppTInfo : access MSSyst.Runtime.InteropServices.UCOMITypeInfo.Ref_arr;
   ...
   procedure GetTypeInfoOfGuid(
      ...
      ppTInfo : access MSSyst.Runtime.InteropServices.UCOMITypeInfo.Ref) is abstract;
   procedure GetTypeInfoType(
      This : access Typ;
      index : Integer;
      pTKind : access MSSyst.Runtime.InteropServices.TYPEKIND.Valuetype) is abstract;
   function IsName(
      This : access Typ;
      szNameBuf : access MSSyst.String.Typ'Class;
