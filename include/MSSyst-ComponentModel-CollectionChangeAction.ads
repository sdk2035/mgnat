...
package MSSyst.ComponentModel.CollectionChangeAction is
   type ValueType is (
      Add,
      Remove,
      Refresh);
...
end MSSyst.ComponentModel.CollectionChangeAction;
pragma Import(MSIL,MSSyst.ComponentModel.CollectionChangeAction,
