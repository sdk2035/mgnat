...
package MSSyst.Security.AccessControl.MutexRights is
   type ValueType is (
      Modify,
      Delete,
      ReadPermissions,
...
end MSSyst.Security.AccessControl.MutexRights;
pragma Import(MSIL,MSSyst.Security.AccessControl.MutexRights,
