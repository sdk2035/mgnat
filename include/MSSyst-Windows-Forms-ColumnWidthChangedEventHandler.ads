...
limited with MSSyst.Windows.Forms.ColumnWidthChangedEventArgs;
package MSSyst.Windows.Forms.ColumnWidthChangedEventHandler is
   ...
   function new_ColumnWidthChangedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ColumnWidthChangedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ColumnWidthChangedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ColumnWidthChangedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ColumnWidthChangedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ColumnWidthChangedEventHandler");
