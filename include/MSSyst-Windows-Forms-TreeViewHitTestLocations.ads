...
package MSSyst.Windows.Forms.TreeViewHitTestLocations is
   type ValueType is (
      None,
      Image,
      Label,
...
end MSSyst.Windows.Forms.TreeViewHitTestLocations;
pragma Import(MSIL,MSSyst.Windows.Forms.TreeViewHitTestLocations,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.TreeViewHitTestLocations");
