...
package MSSyst.Runtime.CompilerServices.MethodImplOptions is
   type ValueType is (
      Unmanaged,
      NoInlining,
      ForwardRef,
...
end MSSyst.Runtime.CompilerServices.MethodImplOptions;
pragma Import(MSIL,MSSyst.Runtime.CompilerServices.MethodImplOptions,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.CompilerServices.MethodImplOptions");
