...
limited with MSSyst.Windows.Forms.LinkLabelLinkClickedEventArgs;
package MSSyst.Windows.Forms.LinkLabelLinkClickedEventHandler is
   ...
   function new_LinkLabelLinkClickedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.LinkLabelLinkClickedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_LinkLabelLinkClickedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.LinkLabelLinkClickedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.LinkLabelLinkClickedEventHandler,
