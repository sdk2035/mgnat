...
limited with MSSyst.ComponentModel.AddingNewEventArgs;
...
package MSSyst.ComponentModel.AddingNewEventHandler is
   ...
   function new_AddingNewEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ComponentModel.AddingNewEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_AddingNewEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ComponentModel.AddingNewEventHandler;
pragma Import(MSIL,MSSyst.ComponentModel.AddingNewEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.AddingNewEventHandler");
