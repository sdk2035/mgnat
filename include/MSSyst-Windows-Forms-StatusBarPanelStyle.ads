...
package MSSyst.Windows.Forms.StatusBarPanelStyle is
   type ValueType is (
      Text,
      OwnerDraw);
...
end MSSyst.Windows.Forms.StatusBarPanelStyle;
pragma Import(MSIL,MSSyst.Windows.Forms.StatusBarPanelStyle,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.StatusBarPanelStyle");
