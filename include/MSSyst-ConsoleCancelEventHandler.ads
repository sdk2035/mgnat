...
limited with MSSyst.ConsoleCancelEventArgs;
...
package MSSyst.ConsoleCancelEventHandler is
   ...
   function new_ConsoleCancelEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ConsoleCancelEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ConsoleCancelEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.ConsoleCancelEventHandler;
pragma Import(MSIL,MSSyst.ConsoleCancelEventHandler,
