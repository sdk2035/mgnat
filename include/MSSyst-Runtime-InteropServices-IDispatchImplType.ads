...
package MSSyst.Runtime.InteropServices.IDispatchImplType is
   type ValueType is (
      SystemDefinedImpl,
      InternalImpl,
      CompatibleImpl);
...
end MSSyst.Runtime.InteropServices.IDispatchImplType;
pragma Import(MSIL,MSSyst.Runtime.InteropServices.IDispatchImplType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Runtime.InteropServices.IDispatchImplType");
