...
package MSSyst.Security.Authentication.ExchangeAlgorithmType is
   type ValueType is (
      None,
      RsaSign,
      RsaKeyX,
...
end MSSyst.Security.Authentication.ExchangeAlgorithmType;
pragma Import(MSIL,MSSyst.Security.Authentication.ExchangeAlgorithmType,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Security.Authentication.ExchangeAlgorithmType");
