...
limited with MSSyst.Windows.Forms.ToolStripDropDownClosedEventArgs;
package MSSyst.Windows.Forms.ToolStripDropDownClosedEventHandler is
   ...
   function new_ToolStripDropDownClosedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ToolStripDropDownClosedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ToolStripDropDownClosedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ToolStripDropDownClosedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ToolStripDropDownClosedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ToolStripDropDownClosedEventHandler");
