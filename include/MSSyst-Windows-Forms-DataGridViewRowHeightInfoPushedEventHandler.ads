...
limited with MSSyst.Windows.Forms.DataGridViewRowHeightInfoPushedEventArgs;
package MSSyst.Windows.Forms.DataGridViewRowHeightInfoPushedEventHandler is
   ...
   function new_DataGridViewRowHeightInfoPushedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.DataGridViewRowHeightInfoPushedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_DataGridViewRowHeightInfoPushedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.DataGridViewRowHeightInfoPushedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewRowHeightInfoPushedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.DataGridViewRowHeightInfoPushedEventHandler");
