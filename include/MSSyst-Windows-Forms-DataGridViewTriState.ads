...
package MSSyst.Windows.Forms.DataGridViewTriState is
   type ValueType is (
      NotSet,
      True,
      False);
...
end MSSyst.Windows.Forms.DataGridViewTriState;
pragma Import(MSIL,MSSyst.Windows.Forms.DataGridViewTriState,
