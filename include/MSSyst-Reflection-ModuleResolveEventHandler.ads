...
package MSSyst.Reflection.ModuleResolveEventHandler is
   ...
   function new_ModuleResolveEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.ResolveEventArgs.Typ'Class;
   ...
   function EndInvoke(
      This : access Typ;
      result : access MSSyst.IAsyncResult.Typ'Class) return access MSSyst.Reflection.Module.Typ'Class;
   function Invoke(
      This : access Typ;
      sender : access MSSyst.Object.Typ'Class;
      e : access MSSyst.ResolveEventArgs.Typ'Class) return access MSSyst.Reflection.Module.Typ'Class;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_ModuleResolveEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Reflection.ModuleResolveEventHandler;
pragma Import(MSIL,MSSyst.Reflection.ModuleResolveEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Reflection.ModuleResolveEventHandler");
