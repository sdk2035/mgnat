...
package MSSyst.Windows.Forms.PowerState is
   type ValueType is (
      Suspend,
      Hibernate);
...
end MSSyst.Windows.Forms.PowerState;
pragma Import(MSIL,MSSyst.Windows.Forms.PowerState,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.PowerState");
