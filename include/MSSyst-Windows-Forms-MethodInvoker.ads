...
package MSSyst.Windows.Forms.MethodInvoker is
...
private
   ...
   pragma MSIL_Constructor(new_MethodInvoker);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.MethodInvoker;
pragma Import(MSIL,MSSyst.Windows.Forms.MethodInvoker,
