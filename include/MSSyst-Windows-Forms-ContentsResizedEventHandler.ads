...
limited with MSSyst.Windows.Forms.ContentsResizedEventArgs;
package MSSyst.Windows.Forms.ContentsResizedEventHandler is
   ...
   function new_ContentsResizedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Windows.Forms.ContentsResizedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_ContentsResizedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Windows.Forms.ContentsResizedEventHandler;
pragma Import(MSIL,MSSyst.Windows.Forms.ContentsResizedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.ContentsResizedEventHandler");
