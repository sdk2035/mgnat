...
limited with MSSyst.Configuration.SettingsLoadedEventArgs;
...
package MSSyst.Configuration.SettingsLoadedEventHandler is
   ...
   function new_SettingsLoadedEventHandler(
      This : Ref := null;
   ...
   function BeginInvoke(
      ...
      e : access MSSyst.Configuration.SettingsLoadedEventArgs.Typ'Class;
...
private
   ...
   pragma MSIL_Constructor(new_SettingsLoadedEventHandler);
   pragma Import(MSIL,BeginInvoke,"BeginInvoke");
   pragma Import(MSIL,EndInvoke,"EndInvoke");
   pragma Import(MSIL,Invoke,"Invoke");
end MSSyst.Configuration.SettingsLoadedEventHandler;
pragma Import(MSIL,MSSyst.Configuration.SettingsLoadedEventHandler,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.Configuration.SettingsLoadedEventHandler");
