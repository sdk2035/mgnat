...
package MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.Button.PushButton is
   ...
   function get_Default return access MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.Typ'Class;
...
end MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.Button.PushButton;
pragma Import(MSIL,MSSyst.Windows.Forms.VisualStyles.VisualStyleElement.Button.PushButton,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System.Windows.Forms]System.Windows.Forms.VisualStyles.VisualStyleElement/Button/PushButton");
