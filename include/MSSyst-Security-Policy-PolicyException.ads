...
package MSSyst.Security.Policy.PolicyException is
...
private
   ...
   pragma MSIL_Constructor(new_PolicyException);
end MSSyst.Security.Policy.PolicyException;
pragma Import(MSIL,MSSyst.Security.Policy.PolicyException,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Security.Policy.PolicyException");
