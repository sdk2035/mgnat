...
package MSSyst.ComponentModel.SByteConverter is
   ...
   function new_SByteConverter(
      This : Ref := null) return Ref;
private
   pragma Convention(MSIL,Typ);
   pragma MSIL_Constructor(new_SByteConverter);
end MSSyst.ComponentModel.SByteConverter;
pragma Import(MSIL,MSSyst.ComponentModel.SByteConverter,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[System]System.ComponentModel.SByteConverter");
