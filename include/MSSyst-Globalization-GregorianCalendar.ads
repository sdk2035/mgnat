...
limited with MSSyst.Globalization.GregorianCalendarTypes;
with MSSyst.ICloneable;
limited with MSSyst.String;
limited with MSSyst.Type_k;
package MSSyst.Globalization.GregorianCalendar is
   ...
   ADEra : Integer;
   pragma Import(MSIL,ADEra,"ADEra");
   type Ref is access all Typ'Class;
   type Ref_addrof is access all Ref;
   type Ref_Arr is array(Natural range <>) of Ref;
   type Ref_Array is access all Ref_Arr;
   type Ref_Array_addrof is access all Ref_Array;
   function new_GregorianCalendar(
      This : Ref := null) return Ref;
   function new_GregorianCalendar(
      This : Ref := null;
      type_k : MSSyst.Globalization.GregorianCalendarTypes.Valuetype) return Ref;
   function AddMonths(
      This : access Typ;
   ...
   function get_CalendarType(
      This : access Typ) return MSSyst.Globalization.GregorianCalendarTypes.Valuetype;
   function get_Eras(
   ...
   function IsLeapYear(
      ...
      year : Integer;
      era : Integer) return Standard.Boolean;
   procedure set_CalendarType(
      This : access Typ;
      value : MSSyst.Globalization.GregorianCalendarTypes.Valuetype);
...
private
   ...
   pragma MSIL_Constructor(new_GregorianCalendar);
   ...
   pragma Import(MSIL,get_CalendarType,"get_CalendarType");
   ...
   pragma Import(MSIL,set_CalendarType,"set_CalendarType");
...
end MSSyst.Globalization.GregorianCalendar;
pragma Import(MSIL,MSSyst.Globalization.GregorianCalendar,
   ".ver 2:0:0:0 .publickeytoken=( b7 7a 5c 56 19 34 e0 89 )",
   "[mscorlib]System.Globalization.GregorianCalendar");
