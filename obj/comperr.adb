...
package body Comperr is
   ...
   begin
      ...
      --  Otherwise give message with details of the abort
         ...
         Write_Str ("| ");
         Write_Str (Gnat_Static_Version_String);
         Write_Str (" (");
         ...
         begin
            ...
            --  Otherwise we use the standard fixed text
               ...
               Write_Str
                 ("| Include the exact mgnat or gnatmake command " &
                  "that you entered.");
               End_Line;
               ...
               if Is_Public_Version then
                  ...
                  Write_Str
                    ("| See the MGNAT readme for full info on procedure " &
                     "for submitting bugs.");
                  End_Line;
               end if;
            end if;
