...
with type MSSyst.Runtime.InteropServices.uType.Ref is access;
with type MSSyst.Reflection.IReflect.Ref is access;
...
package MSSyst.Type_k is
   ...
   type Typ(
         ...
         I_uType : MSSyst.Runtime.InteropServices.uType.Ref;
         I_IReflect : MSSyst.Reflection.IReflect.Ref
      ) is new MSSyst.Reflection.MemberInfo.Typ(
         I_uMemberInfo => I_uMemberInfo,
         I_ICustomAttributeProvider => I_ICustomAttributeProvider
      ) with record
      null;
   end record;
